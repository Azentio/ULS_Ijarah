...
public class AutoLoanAppdataEntryContactDetails {
	...
	WebDriver driver = BaseClass.driver; // ALoanAppdataEntryContactDetails
	JSPaths ALoanAppdataEntryContactDetails = new JSPaths(excelPath, "ALoanAppdataEntryContactDetails", "FieldName",
			"JSPath");
	JSPaths IjADataEntryIdentifiDetails = new JSPaths(excelPath, "IjADataEntryIdentifiDetails", "FieldName", "JSPath");
	// ALoanAppdataEntryContactDetails
	ExcelData ALoanAppdataEntryContactDetailsexelData = new ExcelData(excelTestDataPath,
			"ALoanAppdataEntryContactDetails", "Data Set ID");
...
//	Map<String, String> TestData = new HashMap<>();
	...
	public void user_607_get_the_test_data_for_the_test_case_id_AT_AL_APD_CD_01() throws Throwable {
		...
		System.out.println("Data Set ID "+testData.get("record_reference_number"));
	}
	...
	public void user_607_search_the_ref_id_under_inbox_auto_loan_appdata_entry_contact_details() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(ALoanAppdataEntryContactDetails.getElement("searchInInbox"))
						.sendKeys(testData.get("record_reference_number"), Keys.ENTER);
				break;
			} catch (Exception e) {
				if (i == 699) {
		...
		for (int i = 0; i <= 1000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						ALoanAppdataEntryContactDetails.getElement("additional_customer_info_tab")).click();
				break;
			} catch (Exception e) {
				if (i == 1000) {
					Assert.fail(e.getMessage());
	...
	public void user_click_on_additional_customer_info_tab_in_ijarah_app_data_entry_identification_details() {
		for (int i = 0; i <= 1000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						IjADataEntryIdentifiDetails.getElement("Additional_CustomerInformation")).click();
				break;
			} catch (Exception e) {
				if (i == 1000) {
					Assert.fail(e.getMessage());
	...
	public void user_click_on_save_button_after_update_the_contact_details_in_new_app_stage() throws Throwable {
		...
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(ALoanAppdataEntryContactDetails.getElement("save_button"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 300) {
	...
	public void user_verify_system_should_show_the_update_successful_popup_while_update_the_contact_details_record_in_new_app_stage()
		...
		for (int i = 0; i <= 300; i++) {
			try {
				savePopup = javascriptHelper
						.executeScript(
								"return " + ALoanAppdataEntryContactDetails.getElement("toast_container_message"))
						.toString();
		...
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper
						.executeScriptWithWebElement(
								ALoanAppdataEntryContactDetails.getElement("toast_container_message_close_button"))
						.click();
		...
		for (int i = 0; i <= 300; i++) {
			try {
				mandatoryValidation = javascriptHelper
						.executeScript("return " + ALoanAppdataEntryContactDetails.getElement("toast_message"))
						.toString();
	...
	public void user_607_enter_the_negative_input_in_phone_number_field_in_contact_details_screen_in_new_app_stage()
		...
		for (int i = 0; i <= 300; i++) {
			try {
				...
				javascriptHelper
						.executeScriptWithWebElement(ALoanAppdataEntryContactDetails.getElement("phone_number_input"))
						.sendKeys(testData.get("invalid mobile number"));
				break;
			} catch (Exception e) {
				if (i == 300) {
					Assert.fail(e.getMessage());
			...
			try {
				fieldValidation = javascriptHelper
						.executeScript("return "
								+ ALoanAppdataEntryContactDetails.getElement("phone_number_field_validation2"))
						.toString();
				if ((!fieldValidation.isBlank())) {
					break;
				}
	...
	public void user_607_verify_email_id_field_should_show_the_validation_for_invalid_mail_id_input_in_new_app_stage()
		...
		for (int i = 0; i <= 300; i++) {
			try {
				fieldValidation = javascriptHelper
						.executeScript(
								"return " + ALoanAppdataEntryContactDetails.getElement("email_id_field_validation"))
						.toString();
				if ((!fieldValidation.isBlank())) {
					break;
				}
	...
	public void user_607_verify_contact_details_screen_should_get_open_with_save_buttton_and_back_button()
		...
		for (int i = 0; i <= 200; i++) {
			backButtonVerification = javascriptHelper
					.executeScriptWithWebElement(ALoanAppdataEntryContactDetails.getElement("back_button"))
					.isDisplayed();
		...
		for (int i = 0; i <= 200; i++) {
			saveButtonVerification = javascriptHelper
					.executeScriptWithWebElement(ALoanAppdataEntryContactDetails.getElement("save_button"))
					.isDisplayed();
	...
	public void user_click_on_toggle_button_and_capture_the_status_of_cutact_details_record_at_new_app_stage()
		...
		for (int i = 0; i <= 300; i++) {
			try {
				tempRecordStatus = javascriptHelper
						.executeScript(
								"return " + ALoanAppdataEntryContactDetails.getElement("contact_details_toggle_status"))
						.toString();
		...
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						ALoanAppdataEntryContactDetails.getElement("contact_details_toggle")).click();
				break;
			} catch (Exception e) {
				if (i == 300) {
					Assert.fail(e.getMessage());
	...
	public void user_607_click_on_pdf_options_in_contact_details_export_option_at_new_app_stage() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(ALoanAppdataEntryContactDetails.getElement("pdf_download"))
						.click();
				break;
	...
	public void user_607_click_on_xlsx_options_in_contact_details_export_option_at_new_app_stage() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(ALoanAppdataEntryContactDetails.getElement("xls_download"))
						.click();
				break;
	...
	public void user_607_click_on_back_button_in_contact_details_screen_at_new_app_stage() throws Throwable {
		...
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(ALoanAppdataEntryContactDetails.getElement("back_button"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 300) {
