...
//	Map<String, String> TestData = new HashMap<>();
	...
	public void user_search_in_the_search_field_auto_loan_app_data_entry_document_details() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(ALAppDataEntryDocumentDetails.getElement("searchInInbox")).sendKeys(ALAppdataEntryDocumentsDetails.get("Search Record"));
				break;
			} catch (Exception e) {
				if (i==699) {
