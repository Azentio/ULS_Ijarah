...
public class AutoLoanAppdataentryIncomedetails {
	...
	JSPaths ALAppDataEntryIncomeDetails = new JSPaths(excelPath, "ALAppDataEntryIncomeDetails", "FieldName", "JSPath");
...
//	Map<String, String> TestData = new HashMap<>();
	...
	public void user_607_update_testdata_from_AT_TW_AD_INC_01() {
		testData = ALAppDataEntryIncomeDetailsexelData.getTestdata("DS_AT_TW_AD_INC_01");
	}
...
//				customerFinancialsTab.click();
	...
	public void user_607_check_employment_type_field() throws Throwable {
		Thread.sleep(7000);
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Employment Type")).isDisplayed()) {
	...
	public void user_607_check_save_button() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("saveButton")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_lumpsum_amount_field() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Lumpsum Amount")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_financial_year() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Financial Year")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_filing_date() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Filing Date")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_income_field() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Income")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_frequency_field() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Frequency")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_amount_field() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Amount")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_defined_field() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Defined")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_adjusted_field() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Adjusted")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_amount_considered_field() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Amount Considered")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_action_field() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Action")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_total_income_field() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Total Income")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_total_income_considered_field() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Total Income Considered")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_salary_credited_to_bank_field() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Salary Credited To Bank")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_deduction_field() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Deduction")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_deduction_amt_field() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Deduction Amt")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_deduction_def_field() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Deduction Def")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_deduction_adj_field() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Deduction Adj")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_deduction_considered_field() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Deduction Considered")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_total_deduction_field() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Total Deduction")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_total_deduction_considered_field() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Total Deduction Considered")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_currency_field() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Currency")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_record_save_successfully() {
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("SucessSavePopup")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_go_to_previous_page() throws Throwable {
		Thread.sleep(5000);
		if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("AddButtonInIncome")).isDisplayed()) {
			Assert.fail();
		}
	}
	...
	public void user_607_check_value_auto_populated() {
		String text = javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("Employment Type")).getText();
	...
	public void user_607_check_clicking_on_back_button_system_should_navigate_to_the_previous_screen() {
	    if (!javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("selectRecord")).isDisplayed()) {
	    	Assert.fail();
		}
	}
...
//	Murabaha -- App Data Entry -- Income Details screen
    ...
    public void get_the_test_data_for_test_case_AT_TW_AD_INC_01() throws Throwable {
		...
		testData = ALAppDataEntryIncomeDetailsexelData.getTestdata(executionData.get("dataSet_ID"));
    }
...
//	    Allow to user enter the numeric value
	...
	public void user_607_verify_amount_considered_field_should_be_auto_populated_in_post_entering_adjusted_value() throws Throwable {
		...
		String definedValue = javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("defined%_Input")).getAttribute("ng-reflect-model");
		String adjustedValue = javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("adjusted%_Input")).getAttribute("ng-reflect-model");
		String amountConsideredValue = javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("amountConsideredInput")).getAttribute("ng-reflect-model");
...
//	    Allow to user enter the numeric value
	...
	public void user_607_verify_deduction_considered_field_should_be_auto_populated_in_post_entering_deduction_adj_value() throws Throwable {
		String deductionAmt = javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("deductionAmtInput")).getAttribute("ng-reflect-model");
		String definedValue = javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("deductionDef%_Input")).getAttribute("ng-reflect-model");
		String adjustedValue = javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("deductionAdj%_Input")).getAttribute("ng-reflect-model");
		String amountConsideredValue = javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("deductionConsideredInput")).getAttribute("ng-reflect-model");
	...
	public void user_607_verify_deduction_considered_value_should_get_auto_populate_post_entering_the_value_in_deduction_adj_field() throws Throwable {
		String deductionConsidered = javascriptHelper.executeScriptWithWebElement(ALAppDataEntryIncomeDetails.getElement("deductionConsideredInput")).getAttribute("ng-reflect-model");
