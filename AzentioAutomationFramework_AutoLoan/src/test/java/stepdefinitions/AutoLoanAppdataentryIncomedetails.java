...
//	Map<String, String> TestData = new HashMap<>();
    ...
    public void get_the_test_data_for_test_case_AT_AL_INC_02() throws Throwable {
		AutoLoanExecution = AutoLoanExecutionExcel.getTestdata("AT_AL_INC_02");
		testData = AutoLoanAppDataEntryIncomeDetailsexelData.getTestdata(AutoLoanExecution.get("dataSet_ID"));
    }
    ...
    public void get_the_test_data_for_test_case_AT_AL_INC_03() throws Throwable {
		AutoLoanExecution = AutoLoanExecutionExcel.getTestdata("AT_AL_INC_03");
		testData = AutoLoanAppDataEntryIncomeDetailsexelData.getTestdata(AutoLoanExecution.get("dataSet_ID"));
    }
    ...
    public void get_the_test_data_for_test_case_AT_AL_INC_04() throws Throwable {
		AutoLoanExecution = AutoLoanExecutionExcel.getTestdata("AT_AL_INC_04");
		testData = AutoLoanAppDataEntryIncomeDetailsexelData.getTestdata(AutoLoanExecution.get("dataSet_ID"));
    }
    ...
    public void get_the_test_data_for_test_case_AT_AL_INC_05() throws Throwable {
		AutoLoanExecution = AutoLoanExecutionExcel.getTestdata("AT_AL_INC_05");
		testData = AutoLoanAppDataEntryIncomeDetailsexelData.getTestdata(AutoLoanExecution.get("dataSet_ID"));
    }
    ...
    public void get_the_test_data_for_test_case_AT_AL_INC_06() throws Throwable {
		AutoLoanExecution = AutoLoanExecutionExcel.getTestdata("AT_AL_INC_06");
		testData = AutoLoanAppDataEntryIncomeDetailsexelData.getTestdata(AutoLoanExecution.get("dataSet_ID"));
    }
    ...
    public void get_the_test_data_for_test_case_AT_AL_INC_07() throws Throwable {
		AutoLoanExecution = AutoLoanExecutionExcel.getTestdata("AT_AL_INC_07");
		testData = AutoLoanAppDataEntryIncomeDetailsexelData.getTestdata(AutoLoanExecution.get("dataSet_ID"));
    }
    ...
    public void get_the_test_data_for_test_case_AT_AL_INC_08() throws Throwable {
		AutoLoanExecution = AutoLoanExecutionExcel.getTestdata("AT_AL_INC_08");
		testData = AutoLoanAppDataEntryIncomeDetailsexelData.getTestdata(AutoLoanExecution.get("dataSet_ID"));
    }
	...
	@Given("User_607 Search record in the search Field for Ijarah AppData Entry Income Details")
	public void user_607_607_Search_record_in_the_search_Field_for_Ijarah_AppData_Entry_Income_Details() {
		for (int i = 0; i < 700; i++) {
			try {
