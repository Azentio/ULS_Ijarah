...
public class Ijara_Steps_610 {
	...
	JSPaths jsPaths2 = new JSPaths(excelPath, "IAD_DocumentDetails", "Ijara_LoginFieldName", "JSPath");
	...
	ExcelData aL_ADE_CustomerDetails_610 = new ExcelData(path, "AL_ADE_CustomerDetails_610", "DataSet ID");
	ExcelData aL_Off_facilityDetails_610 = new ExcelData(path, "AL_Off_facilityDetails_610", "DataSet ID");
	...
	public void login_with_valid_credentials18() throws Throwable {
		...
		ijarahLogin.loginWithIjaraApplication("userType17");
	}
	...
	public void get_the_test_data_set_id_for_DS_AT_Al_CD_01() {
		AutoLoanExecution = AutoLoanExecutionExcel.getTestdata("AT_Al_CD_01");
		System.out.println("Data set ID " + AutoLoanExecution.get("dataSet_ID"));
		testData = aL_ADE_CustomerDetails_610.getTestdata(AutoLoanExecution.get("dataSet_ID"));
	...
	public void user_610_select_the_module_name_to_los() throws Throwable {
	...
	public void user_610_click_search_button() throws Throwable {
	...
	@And("^User_610 enter the value in search button in offering stage at autoloan$")
	public void user_610_enter_the_value_in_search_button_in_offering_stage_at_autoloan() throws Throwable {
		...
		// javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("enter_theName_InSearchBtn_610")).sendKeys(testData.get("Search
		// Button Value"));

		for (int i = 0; i < 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("enter_theName_InSearchBtn_610"))
						.sendKeys(configFileReader.getAutoLoanOfferingReferedReferenceNumber());
				break;
			} catch (Exception e) {
				if (i == 299) {
					Assert.fail(e.getMessage());
	...
	public void user_610_enter_the_value_in_search_button() throws Throwable {
		...
		for (int i = 0; i < 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("enter_theName_InSearchBtn_610"))
						.sendKeys(configFileReader.getAutoLoanDataEntryRecordReferenceNumber());
				break;
			} catch (Exception e) {
				if (i == 299) {
					Assert.fail(e.getMessage());
	...
	public void user_610_click_edit_button_under_inbox_screen02() throws Throwable {
...
//		javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("editBtnIndex2_610")).click();
	...
	public void user_610_click_document_details() throws Throwable {
	...
	public void user_610_click_add_button_under_document_details() throws Throwable {
...
//				.executeScriptWithWebElement(jsPaths2.getElement("clickAddBtn_UnderDocumentDetails_610")));
	...
	public void user_610_validate_customer_name_field_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_610_validate_document_name_field_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_610_validate_required_at_stage_field_enabled_or_not_under_document_details() throws Throwable {
//		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
...
//						.isDisplayed());
	...
	public void user_610_validate_document_status_field_enabled_or_not_under_document_details() throws Throwable {
//		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
...
//						.isDisplayed());
	...
	public void user_610_validate_manitory_option_field_enabled_or_not_under_document_details() throws Throwable {
//		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
...
//						.isDisplayed());
	...
	public void user_610_validate_document_category_field_enabled_or_not_under_document_details() throws Throwable {
//		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
...
//				.executeScriptWithWebElement(jsPaths2.getElement("uploadDate_UnderDocumentDetails_610")).isDisplayed());
	...
	public void user_610_validate_expected_recepited_date_field_enabled_or_not_under_document_details()
			throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_610_validate_deferral_stage_field_enabled_or_not_under_document_details() throws Throwable {
//		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
...
//						.isDisplayed());
	...
	public void user_610_validate_def_approvel_by_field_enabled_or_not_under_document_details() throws Throwable {
//		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
...
//						.isDisplayed());
	...
	public void user_610_validate_document_quality_field_enabled_or_not_under_document_details() throws Throwable {
//		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
...
//						.isDisplayed());
	...
	public void user_610_document_refercence_number_field_enabled_or_not_under_document_details() throws Throwable {
//		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
...
//						.isDisplayed());
	...
	public void user_610_validate_document_received_by_enabled_or_not_under_document_details() throws Throwable {
//		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
...
//						.isDisplayed());
	...
	public void user_610_validate_location_where_received_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
...
//				.executeScriptWithWebElement(jsPaths2.getElement("rankNo_UnderDocumentDetails_610")).isDisplayed());
		...
		for (int m = 0; m < 500; m++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("rankNo_UnderDocumentDetails_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
...
//				.executeScriptWithWebElement(jsPaths2.getElement("sheIfNo_UnderDocumentDetails_610")).isDisplayed());
		...
		for (int m = 0; m < 500; m++) {
			try {
				if (javascriptHelper
						.executeScriptWithWebElement(jsPaths2.getElement("sheIfNo_UnderDocumentDetails_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
...
//				.executeScriptWithWebElement(jsPaths2.getElement("boxNo_UnderDocumentDetails_610")).isDisplayed());
		...
		for (int m = 0; m < 500; m++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("boxNo_UnderDocumentDetails_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_validate_date_of_expiry_field_enabled_or_not_under_document_details() throws Throwable {
//		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
...
//						.isDisplayed());
	...
	public void user_610_validate_lodgement_amount_field_enabled_or_not_under_document_details() throws Throwable {
...
//				.executeScriptWithWebElement(jsPaths2.getElement("remarks_UnderDocumentDetails_610")).isDisplayed());
		...
		for (int m = 0; m < 500; m++) {
			try {
				if (javascriptHelper
						.executeScriptWithWebElement(jsPaths2.getElement("remarks_UnderDocumentDetails_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_click_save_and_verify() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_610_select_manitory_option_field_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("manitoryOption_UnderDocumentDetails_610")));
	...
	public void user_610_select_deferral_stage_field_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("deferralStage_UnderDocumentDetails_610")));
	...
	public void user_610_select_document_quality_field_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("documentQuality_UnderDocumentDetails_610")));
	...
	public void user_610_select_document_name_field_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("documentName_UnderDocumentDetails_610")));
	...
	public void user_610_select_document_status_field_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("documentStatus_UnderDocumentDetails_610")));
	...
	public void user_610_select_document_category_field_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("documentCategory_UnderDocumentDetails_610")));
	...
	public void user_610_select_remarks_field_enabled_or_not_under_document_details() throws Throwable {
		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("remarks_UnderDocumentDetails_610")));
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("remarks_UnderDocumentDetails_610")));
	...
	public void user_610_click_the_customer_follow_details() throws Throwable {
//		waitHelper.waitForElementwithFluentwait(driver,javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("click_nxtBtn_610")));
	...
	public void user_610_validate_add_button_field_enabled_or_not_under_customer_follow_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_610_click_add_button_under_customer_follow_details() throws Throwable {
	...
	public void user_610_validate_called_when_field_enabled_or_not_under_customer_follow_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_610_validate_customer_resbonce_field_enabled_or_not_under_customer_follow_details()
			throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_610_validate_follow_up_data_field_enabled_or_not_under_customer_follow_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_610_validate_single_status_field_enabled_or_not_under_customer_follow_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_610_validate_remark_category_field_enabled_or_not_under_customer_follow_details()
			throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
	...
	public void user_610_validate_back_button_field_enabled_or_not_under_customer_follow_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_610_validate_save_button_field_enabled_or_not_under_customer_follow_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("click_SaveButton_UnderFollowUp_610")));
		if (!javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("click_SaveButton_UnderFollowUp_610"))
				.isDisplayed()) {
			softAssert.fail();
		}
		...
		for (int b = 0; b < 300; b++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						jsPaths2.getElement("selectTodayDateIn_FollowUPDate_UnderFollowUp_610")).click();
				break;
			} catch (Exception e) {
				if (b == 299) {
					Assert.fail(e.getMessage());
	...
	public void validate_the_customer_resbonce_field_should_be_look_up_mandatory_and_editable() throws Throwable {
		...
		for (int a = 0; a < 300; a++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						jsPaths2.getElement("click_customerResponceSelect_UnderFollowUp_610")).click();
				break;
			} catch (Exception e) {
				if (a == 299) {
					Assert.fail(e.getMessage());
		...
		for (int j = 0; j <= premitiveDropdownLength; j++) {
			...
			if ((dropdownString.trim()).equalsIgnoreCase((testData.get("CustomerResponce")).trim())) {
				for (int k = 0; k <= 300; k++) {
					try {
...
// ----------dropdown-------
		...
		for (int j = 0; j <= premitiveDropdownLength; j++) {
			...
			if ((dropdownString.trim()).equalsIgnoreCase((testData.get("Sign Status")).trim())) {
				for (int k = 0; k <= 300; k++) {
					try {
						clicksAndActionsHelper.moveToElement(javascriptHelper.executeScriptWithWebElement(
								"document.querySelectorAll('ion-radio-group ion-radio')[" + j + "]"));
...
//		String remarkFormat1 = (String) javascriptHelper.executeScript("return "+remarkFormat);
		...
		for (int a = 0; a < 300; a++) {
			try {
				javascriptHelper
						.executeScriptWithWebElement(jsPaths2.getElement("click_remarkInputBox_UnderFollowUp_610"))
						.sendKeys("text");
				break;
			} catch (Exception e) {
				if (a == 299) {
	...
	public void user_610_validate_the_conformation_message_after_save_button() {

		for (int i = 0; i <= 500; i++) {
			try {
				if (!javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("successMsg_610"))
						.isDisplayed()) {
					softAssert.fail();
				}
				break;
		...
		for (int i = 0; i <= 500; i++) {
			try {
				if (!javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("toastMsgCloseBtn_610"))
						.isDisplayed()) {
					softAssert.fail();
				}
				break;
	...
	public void user_610_vaildate_the_message_for_blank_field_is_which_mandatory() {
		for (int i = 0; i <= 500; i++) {
			try {
	...
	public void user_610_validate_edit_button_field_enabled_or_not_under_customer_follow_details() {
		for (int i = 0; i <= 500; i++) {
			try {
				if (!javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("editBtn_UnderFollowUp_610"))
						.isDisplayed()) {
					softAssert.fail();
				}
				break;
	...
	public void user_610_validate_search_for_the_record_field_enabled_or_not_under_customer_follow_details() {
		for (int i = 0; i <= 500; i++) {
			try {
				if (!javascriptHelper
						.executeScriptWithWebElement(jsPaths2.getElement("searchForTheRecord_UnderFollowUp_610"))
						.isDisplayed()) {
					softAssert.fail();
				}
				break;
	...
	public void user_610_validate_export_to_pdf_and_excel_field_enabled_or_not_under_customer_follow_details() {

		for (int a = 0; a < 300; a++) {
			try {
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("click_ExportBtn_UnderFollowUp_610"))
						.click();
				;
				break;
			} catch (Exception e) {
		...
		for (int i = 0; i <= 500; i++) {
			try {
				if (!javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("exportToPDF_UnderFollowUp_610"))
						.isDisplayed()) {
					softAssert.fail();
				}
				break;
		...
		for (int i = 0; i <= 500; i++) {
			try {
				if (!javascriptHelper
						.executeScriptWithWebElement(jsPaths2.getElement("exportToEXCEL_UnderFollowUp_610"))
						.isDisplayed()) {
					softAssert.fail();
				}
				break;
	...
	public void user_610_validate_follow_up_details_field_enabled_or_not_under_customer_follow_details() {
	...
	public void user_610_to_verify_the_values_in_list_view_should_be_not_editable() throws Throwable {

		for (int i = 0; i < 200; i++) {
			try {
				javascriptHelper
						.executeScriptWithWebElement(jsPaths2.getElement("clickActiveBtn_Status_underListView_610"))
						.sendKeys("test");
				break;
			} catch (Exception e) {
				// TODO: handle exception
	...
	public void user_610_to_verify_the_functionality_of_add_button_should_allow_create_new_record() throws Throwable {

		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("followUpDetailsScreen_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
		...
		for (int k = 0; k < 200; k++) {
			try {
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("BackBtn_underFollowUpList_610"))
						.click();
				break;
			} catch (Exception e) {
				// TODO: handle exception
	...
	public void user_610_to_verify_the_functionality_of_edit_button_should_redirct_the_edit_page() throws Throwable {
	...
	public void user_610_to_verify_the_functionality_of_search_box_with_matching_data_should_be_show_matching_data()
			throws Throwable {

		for (int k = 0; k < 200; k++) {
			try {
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("searchBtn_underFollowUpList_610"))
						.click();
				javascriptHelper
						.executeScriptWithWebElement(jsPaths2.getElement("inputBox_searchBtn_underFollowUpDetails_610"))
						.sendKeys("22");
				break;
			} catch (Exception e) {
				// TODO: handle exception
		...
		for (int j = 0; j < 200; j++) {
			try {
				if (!javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("validate_theMatchingData_610"))
						.isDisplayed()) {
					softAssert.fail();
				}
			} catch (Exception e) {
	...
	public void user_610_to_verfiy_the_functionality_of_search_box_with_not_matching_data_should_not_be_show_no_data()
			throws Throwable {
		...
		for (int j = 0; j < 200; j++) {
			try {
				if (!javascriptHelper
						.executeScriptWithWebElement(jsPaths2.getElement("vaildate_theMisMatchingData_610"))
						.isDisplayed()) {
					softAssert.fail();
				}
			} catch (Exception e) {
	...
	public void user_610_to_verify_the_functionality_of_export_to_pdf_button_should_download_pdf_file() {

	}

	@And("User_610 to verify the functionality of export to EXCEL button should download EXCEL file")
	public void user_610_to_verify_the_functionality_of_export_to_excel_button_should_download_excel_file() {
	...
	public void user_610_verify_the_field_save_button_under_identification_details() {
		for (int i = 0; i < 200; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("click_SaveButton_UnderFollowUp_610"))
						.click();
	...
	public void user_610_verify_the_field_back_button_under_identification_details() {
		for (int i = 0; i < 200; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("backBtn_UnderCustomerDetails_610"))
						.click();
				break;
			} catch (Exception e) {
				// TODO: handle exception
	...
	public void user_610_click_additional_customer_info() throws Throwable {
		for (int i = 0; i < 200; i++) {
			try {
	...
	public void user_610_click_edit_button_under_additional_customer_info() throws Throwable {
		for (int i = 0; i < 200; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("editBtn_UnderFollowUp_610")).click();
				break;
	...
	public void user_610_click_add_button_in_customer_identification() throws Throwable {
	...
	public void user_610_click_view_button_in_customer_identification() throws Throwable {
	...
	public void user_610_click_eye_button_in_customer_identification() throws Throwable {
	...
	public void user_610_verify_the_field_id_type_under_identification_details() {
		for (int j = 0; j < 200; j++) {
			try {
				if (!javascriptHelper.executeScriptWithWebElement(
						jsPaths2.getElement("Id_Type_UnderCustomerIdentificationDetails_610")).isDisplayed()) {
					softAssert.fail();
					break;
				}
			} catch (Exception e) {
	...
	public void user_610_verify_the_field_id_number_under_identification_details() {
		for (int j = 0; j < 200; j++) {
			try {
				if (!javascriptHelper
						.executeScriptWithWebElement(
								jsPaths2.getElement("Id_Number_UnderCustomerIdentificationDetails_610"))
						.isDisplayed()) {
					softAssert.fail();
					break;
				}
	...
	public void user_610_verify_the_field_id_issue_date_under_identification_details() {
		for (int j = 0; j < 200; j++) {
			try {
				if (!javascriptHelper
						.executeScriptWithWebElement(
								jsPaths2.getElement("Issue_Date_UnderCustomerIdentificationDetails_610"))
						.isDisplayed()) {
					softAssert.fail();
					break;
				}
	...
	public void user_610_verify_the_field_id_expiry_identification_details() {
		for (int j = 0; j < 200; j++) {
			try {
				if (!javascriptHelper
						.executeScriptWithWebElement(
								jsPaths2.getElement("Expiry_Date_UnderCustomerIdentificationDetails_610"))
						.isDisplayed()) {
					softAssert.fail();
					break;
				}
	...
	public void user_610_verify_the_field_issuing_authority_under_identification_details() {
		for (int j = 0; j < 200; j++) {
			try {
				if (!javascriptHelper
						.executeScriptWithWebElement(
								jsPaths2.getElement("IssuingAuthority_UnderCustomerIdentificationDetails_610"))
						.isDisplayed()) {
					softAssert.fail();
					break;
				}
	...
	public void user_610_verify_the_field_control_of_issue_under_identification_details() {
		for (int j = 0; j < 200; j++) {
			try {
				if (!javascriptHelper
						.executeScriptWithWebElement(
								jsPaths2.getElement("CountryOfIssue_UnderCustomerIdentificationDetails_610"))
						.isDisplayed()) {
					softAssert.fail();
					break;
				}
	...
	public void user_610_verify_the_data_display_in_id_type_under_identification_details() {
		String IDVerify = javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("Id_Type_UnderCustomerIdentificationDetails_610"))
	...
	public void user_610_verify_the_data_display_in_id_number_under_identification_details() {
		String IDNumber = javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("Id_Number_UnderCustomerIdentificationDetails_610"))
	...
	public void user_610_verify_the_data_display_in_id_issue_date_under_identification_details() {
		String IDIssueData1 = javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("Issue_Date_UnderCustomerIdentificationDetails_610"))
	...
	public void user_610_verify_the_data_display_in_id_expiry_identification_details() {
		String IDExpiryData1 = javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("Expiry_Date_UnderCustomerIdentificationDetails_610"))
				.getAttribute("ng-reflect-model");
	...
	public void user_610_verify_the_data_display_in_issuing_authority_under_identification_details() {
		String IssuingAuthority1 = javascriptHelper
				.executeScriptWithWebElement(
						jsPaths2.getElement("IssuingAuthority_UnderCustomerIdentificationDetails_610"))
				.getAttribute("aria-label");
	...
	public void user_610_verify_the_data_display_in_control_of_issue_under_identification_details() {
		String ControlOfIssue1 = javascriptHelper
				.executeScriptWithWebElement(
						jsPaths2.getElement("CountryOfIssue_UnderCustomerIdentificationDetails_610"))
				.getAttribute("aria-label");
	...
	public void user_610_verify_id_type_field_should_be_non_mandatory_display_and_calender() throws Throwable {
		...
		String IssueDateFormat = javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("getAtribute_InIssueDate_610")).getTagName();
	...
	public void user_610_verify_expiry_date_field_should_be_mandatory_display_and_text_box() throws Throwable {
		...
		String ExpiryDateFormat = javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("getAtribute_InExpiryeDate_610")).getTagName();
...
//							}
	...
	public void user_610_verify_country_of_issue_field_should_be_non_mandatory_display_and_calender() {
...
//							}
	...
	public void user_610_click_facility_info_screen() {
		for (int i = 0; i < 200; i++) {
			try {
	...
	public void user_610_verify_the_scheme_field() {
	...
	public void user_610_verify_the_product_field() {
	...
	public void user_610_verify_the_request_amount_field() {

		// ---------------------display

		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("RequestAmount_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_loan_tenure_field() {
	...
	public void user_610_verify_the_data_under_scheme_field() throws Throwable {
		Thread.sleep(500);
		String scheme1 = javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("Scheme_610"))
				.getAttribute("aria-label");
	...
	public void user_610_verify_the_data_under_product_field() {
	...
	public void user_610_verify_the_data_under_loan_tenure_field() {
	...
	public void user_610_verify_the_product_field_should_be_mandatory_display_and_field_should_text() throws Throwable {
		...
		String productSelectFormat = javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("getAttribute_InProduct_610"))
	...
	public void user_610_verify_the_request_type_field_should_be_mandatory_display_and_field_should_text() {

		// ---------------------display

		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("facilityType_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
		...
		String facilityTypeSelectFormat = javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("getAttribute_InFacilityType_610"))
				.getAttribute("ng-reflect-placeholder");
	...
	public void user_610_verify_the_scheme_field_should_be_mandatory_display_and_field_should_text() {
		...
		String schemeSelectFormat = javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("getAttribute_InFacilityType_610"))
				.getAttribute("ng-reflect-placeholder");
	...
	public void user_610_verify_the_request_amount_field_should_be_non_mandatory_display_and_field_should_text() {
		...
		for (int i = 0; i < 2000; i++) {
			try {
				...
				String requestAmountMandtoryName = (String) javascriptHelper
						.executeScript("return " + requestAmountMandtory);
		...
		String requestAmtNumericFormat = javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("RequestAmount_610")).getAttribute("mode");
	...
	public void user_610_verify_the_tenure_months_field_should_be_mandatory_display_and_field_should_text()
		...
		for (int i = 0; i < 2000; i++) {
			try {
				...
				String tenureMonthMandtoryName = (String) javascriptHelper
						.executeScript("return " + tenureMonthMandtory);
		...
		String requestAmtNumericFormat = javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("getAttribute_InTenure_610")).getAttribute("type");
	...
	public void user_610_verify_the_customer_decline_button_field_available_on_offer_details_screen() {
		// ---------------------display

		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("getAttribute_InTenure_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_print_button_field_available_on_offer_details_screen() {
	...
	public void user_610_verify_the_back_button_field_available_on_offer_details_screen() {
		...
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper
						.executeScriptWithWebElement(jsPaths2.getElement("backBtn_UnderCustomerDetails_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_accept_offer_field_available_on_offer_details_screen() {

		// ---------------------display

		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("AcceptOffer_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_offer_details_section_field_available_on_offer_details_screen() {

		// ---------------------display

		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("OfferDetailsSection_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_finance_details_section_field_available_on_offer_details_screen() {

		// ---------------------display

		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FinanceDetailsSection_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_credit_risk_factor_sectioin_field_available_on_offer_details_screen() {

		// ---------------------display

		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("CreditRiskFactor_610")));
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("CreditRiskFactor_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_credit_score_details_section_field_available_on_offer_details_screen() {

		// ---------------------display
		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("CreditScoreDetails_610")));
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("CreditScoreDetails_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_eligibility_details_screen_field_available_on_offer_details_screen() {

		// ---------------------display
		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("EligibilityDetails_610")));
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("EligibilityDetails_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_interest_rate_structure_section_field_available_on_offer_details_screen() {

		// ---------------------display
		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("InterestRateStructure_610")));

		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("InterestRateStructure_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_installments_section_field_available_on_offer_details_screen() {

		// ---------------------display
		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("InstallmentsSection_610")));

		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("InstallmentsSection_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_appeal_request_section_field_available_on_offer_details_screen() {
		// ---------------------display
		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("AppealRequestsection_610")));

		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("AppealRequestsection_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_product_data_should_be_read_only() {
		String offProduct = javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("getAttribute_product_610"))
	...
	public void user_610_verify_sub_product_data_should_be_read_only() {
		String offSubProduct = javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("getAttribute_SubProduct_610"))
				.getAttribute("ng-reflect-readonly");
	...
	public void user_610_verify_scheme_data_should_be_read_only() {
		String offScheme = javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("getAttribute_Scheme_610"))
				.getAttribute("ng-reflect-readonly");
	...
	public void user_610_verify_princing_indicator_data_should_be_read_only() {
		String offPrincingIndicator = javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("getAttribute_PrincingIndicator_610"))
				.getAttribute("ng-reflect-readonly");
	...
	public void user_610_verify_the_back_button_field() throws Throwable {
...
//		}
		...
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("BackBtn_NavigativeFacilityScreen_610")));
		Assert.assertEquals(true,
				javascriptHelper
						.executeScriptWithWebElement(jsPaths2.getElement("BackBtn_NavigativeFacilityScreen_610"))
						.isDisplayed());
	...
	public void user_610_verify_the_product_field_available_in_offer_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("OflProduct_610")));
		Assert.assertEquals(true,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("OflProduct_610")).isDisplayed());
	...
	public void user_610_verify_the_sub_product_field_available_in_offer_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("OflSubProduct_610")));
		Assert.assertEquals(true,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("OflSubProduct_610")).isDisplayed());
	...
	public void user_610_verify_the_scheme_field_available_in_offer_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("OflScheme_610")));
		Assert.assertEquals(true,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("OflScheme_610")).isDisplayed());
		// ------------read only
	...
	public void user_610_verify_the_pricing_indicator_field_available_in_offer_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("OflPrincingIndicator_610")));
		Assert.assertEquals(true, javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("OflPrincingIndicator_610")).isDisplayed());
	...
	public void user_610_verify_the_product_offer_amount_available_in_offer_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("OflOfferdAmount_610")));
		Assert.assertEquals(true,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("OflOfferdAmount_610")).isDisplayed());

		// -------read only

		String offProductOfferAmount = javascriptHelper
	...
	public void user_610_verify_the_tenure_field_available_in_offer_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("OflTenure_610")));
		Assert.assertEquals(true,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("OflTenure_610")).isDisplayed());

		// -------read only

		String offTenure = javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("OflTenure_610"))
				.getAttribute("ng-reflect-readonly");
	...
	public void user_610_verify_the_nature_of_finance_field_available_in_offer_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("OflNaturalOfFinance_610")));
		Assert.assertEquals(true, javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("OflNaturalOfFinance_610")).isDisplayed());

		// ------------read only

		String offNatureOfFinance = javascriptHelper
	...
	public void user_610_verify_the_currency_field_available_in_offer_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("OflCurrency_610")));
		Assert.assertEquals(true,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("OflCurrency_610")).isDisplayed());

		// ------------read only

		String offCurrency = javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("OflCurrency_610"))
				.getAttribute("ng-reflect-readonly");
	...
	public void user_610_verify_the_amount_request_field_available_in_finance_details_screen() throws Throwable {
		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdAmountRequested_610")));
...
//		Assert.assertEquals(true,javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdAmountRequested_610")).isDisplayed());
		...
		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdAmountRequested_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
				}
				break;
	...
	public void user_610_verify_the_down_payment_amount_field_available_in_finance_details_screen() throws Throwable {
		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdDownPaymentAmount_610")));
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdDownPaymentAmount_610")));
		Assert.assertEquals(true, javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("FdDownPaymentAmount_610")).isDisplayed());

	}

	@And("User_610 verify the Total Down Payment Amount field available in Finance details screen")
	public void user_610_verify_the_total_down_payment_amount_field_available_in_finance_details_screen()
			throws Throwable {
		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdTotalDownPaymentAmount_610")));
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdTotalDownPaymentAmount_610")));
		Assert.assertEquals(true, javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("FdTotalDownPaymentAmount_610")).isDisplayed());

	}

	@And("User_610 verify the Total Profit Amount field available in Finance details screen")
	public void user_610_verify_the_total_profit_amount_field_available_in_finance_details_screen() throws Throwable {
		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdProfitAmount_610")));
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdProfitAmount_610")));
		Assert.assertEquals(true,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdProfitAmount_610")).isDisplayed());

	}

	@And("User_610 verify the Total Contract Value field available in Finance details screen")
	public void user_610_verify_the_total_contract_value_field_available_in_finance_details_screen() throws Throwable {
		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdTotalContractAmount_610")));
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdTotalContractAmount_610")));
		Assert.assertEquals(true, javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("FdTotalContractAmount_610")).isDisplayed());

	}

	@And("User_610 verify the Total Income field available in Finance details screen")
	public void user_610_verify_the_total_income_field_available_in_finance_details_screen() throws Throwable {
		javascriptHelper
				.scrollIntoView(javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdTotalIncome_610")));
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdTotalIncome_610")));
		Assert.assertEquals(true,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdTotalIncome_610")).isDisplayed());

	}

	@And("User_610 verify the Total Net Income field available in Finance details screen")
	public void user_610_verify_the_total_net_income_field_available_in_finance_details_screen() throws Throwable {
		javascriptHelper
				.scrollIntoView(javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdTotalNetIncome")));
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdTotalNetIncome")));
		Assert.assertEquals(true,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdTotalNetIncome")).isDisplayed());

	}

	@And("User_610 verify the Installment Fraquency field available in Finance details screen")
	public void user_610_verify_the_installment_fraquency_field_available_in_finance_details_screen() throws Throwable {
		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdInstallmentFrequence_610")));
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdInstallmentFrequence_610")));
		Assert.assertEquals(true, javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("FdInstallmentFrequence_610")).isDisplayed());

	}

	@And("User_610 verify the IRR field available in Finance details screen")
	public void user_610_verify_the_irr_field_available_in_finance_details_screen() throws Throwable {
		javascriptHelper.scrollIntoView(javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdIRR_610")));
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdIRR_610")));
		Assert.assertEquals(true,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdIRR_610")).isDisplayed());

	}

	@And("User_610 verify the Tenure field available in Finance details screen")
	public void user_610_verify_the_tenure_field_available_in_finance_details_screen() throws Throwable {
		javascriptHelper
				.scrollIntoView(javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdTenure_610")));
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdTenure_610")));
		Assert.assertEquals(true,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdTenure_610")).isDisplayed());

	}

	@And("User_610 verify the Additional Down Payment field available in Finance details screen")
	public void user_610_verify_the_additional_down_payment_field_available_in_finance_details_screen()
			throws Throwable {
		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdAdditionalDownPayment_610")));
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdAdditionalDownPayment_610")));
		Assert.assertEquals(true, javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("FdAdditionalDownPayment_610")).isDisplayed());

	}

	@And("User_610 verify the Down Payment Percentage field available in Finance details screen")
	public void user_610_verify_the_down_payment_percentage_field_available_in_finance_details_screen()
			throws Throwable {
		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdDownPaymentPercentage_610")));
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdDownPaymentPercentage_610")));
		Assert.assertEquals(true, javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("FdDownPaymentPercentage_610")).isDisplayed());

	}

	@And("User_610 verify the Total Fees field available in Finance details screen")
	public void user_610_verify_the_total_fees_field_available_in_finance_details_screen() throws Throwable {
		javascriptHelper
				.scrollIntoView(javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdTotalFees_610")));
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdTotalFees_610")));
		Assert.assertEquals(true,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdTotalFees_610")).isDisplayed());

	}

	@And("User_610 verify the Total Obligations field available in Finance details screen")
	public void user_610_verify_the_total_obligations_field_available_in_finance_details_screen() throws Throwable {
		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdTotalObligation_610")));
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdTotalObligation_610")));
		Assert.assertEquals(true, javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("FdTotalObligation_610")).isDisplayed());

	}

	@And("User_610 verify the No Of Installment field available in Finance details screen")
	public void user_610_verify_the_no_of_installment_field_available_in_finance_details_screen() throws Throwable {
		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdNoOfInstallment_610")));
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdNoOfInstallment_610")));
		Assert.assertEquals(true, javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("FdNoOfInstallment_610")).isDisplayed());

	}

	@And("User_610 verify the Last Installment Amount field available in Finance details screen")
	public void user_610_verify_the_last_installment_amount_field_available_in_finance_details_screen()
			throws Throwable {
		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdLastInstallmentAmount_610")));
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdLastInstallmentAmount_610")));
		Assert.assertEquals(true, javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("FdLastInstallmentAmount_610")).isDisplayed());

	}

	@And("User_610 verify the APR field available in Finance details screen")
	public void user_610_verify_the_apr_field_available_in_finance_details_screen() throws Throwable {
		javascriptHelper.scrollIntoView(javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdAPR_610")));
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdAPR_610")));
		Assert.assertEquals(true,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdAPR_610")).isDisplayed());
	...
	public void user_610_verify_the_offer_details_section_screen_under_all_field_should_read_only() {
	...
	public void user_610_verify_the_total_down_payment_amount_field_read_only() {
		String OffTotalDownPaymentAmount = javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("FdTotalDownPaymentAmount_610"))
				.getAttribute("ng-reflect-readonly");
	...
	public void user_610_verify_the_profit_amount_field_read_only() {
		String OffProfitAmount = javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdProfitAmount_610"))
				.getAttribute("ng-reflect-readonly");
	...
	public void user_610_verify_the_total_contract_value_field_read_only() {
		String OffTotalContractValue = javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("FdTotalContractAmount_610"))
				.getAttribute("ng-reflect-readonly");
	...
	public void user_610_verify_the_additional_down_payment_field_read_only() {
		String OffAdditionalDownPayment = javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("FdAdditionalDownPayment_610"))
				.getAttribute("ng-reflect-readonly");
	...
	public void user_610_verify_the_down_payment_percentage_field_read_only() {
		String OffTotalDownPaymentPercentage = javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("FdDownPaymentPercentage_610"))
				.getAttribute("ng-reflect-readonly");
	...
	public void user_610_verify_the_total_score_field_under_credit_rise_factor() {
		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("CreditRiskFactor_610")));
		javascriptHelper
				.scrollIntoView(javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("TotalScore_610")));
		for (int i = 0; i < 300; i++) {
			try {
	...
	public void user_610_verify_the_rise_level_field_under_credit_rise_factor() {

		javascriptHelper
				.scrollIntoView(javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("RiseLevel_610")));
		for (int i = 0; i < 300; i++) {
			try {
	...
	public void user_610_verify_the_sr_no_field_under_credit_score_details() {

		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("CreditScoreDetails_610")));
		javascriptHelper
				.scrollIntoView(javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("CSD_SrNo_610")));
		for (int i = 0; i < 300; i++) {
			try {
	...
	public void user_610_verify_the_customer_name_field_under_credit_score_details() {

		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("CSD_CustomerName_610")));
		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("CSD_CustomerName_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
				}
				break;
	...
	public void user_610_verify_the_credit_bureau_score_field_under_credit_score_details() {

		javascriptHelper.scrollIntoView(
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("CSD_CreditBureuaScore_610")));
		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("CSD_CreditBureuaScore_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
				}
				break;
	...
	public void user_610_click_addition_customer_info_under_new_application() {
	...
	public void user_610_click_edit_button_info_under_new_application() {
	...
	public void user_610_click_add_button_info_in_reference_list_view_under_new_application() {
	...
	public void user_610_verify_the_add_and_save_button_field_in_reference_list_view_under_new_application() {
	...
	public void user_610_verify_the_relationship_type_field_in_reference_list_view_under_new_application() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("relationshipType_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_salutation_field_in_reference_list_view_under_new_application() {
	...
	public void user_610_verify_the_first_name_field_in_reference_list_view_under_new_application() {
	...
	public void user_610_verify_the_middle_name_field_in_reference_list_view_under_new_application() {
	...
	public void user_610_verify_the_last_name_field_in_reference_list_view_under_new_application() {
	...
	public void user_610_verify_the_customer_full_name_field_in_reference_list_view_under_new_application() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("customerFullName_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_identification_type_field_in_reference_list_view_under_new_application() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("identificationType_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_identification_number_field_in_reference_list_view_under_new_application() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("IidentificationNumber_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_residence_address_field_in_reference_list_view_under_new_application() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("residenceAddress_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_office_address_field_in_reference_list_view_under_new_application() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("officeAddress_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_contact_number_field_in_reference_list_view_under_new_application() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("contactNumber_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_office_phone_number_field_in_reference_list_view_under_new_application() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("officePhoneNumber_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_primary_mobile_number_number_field_in_reference_list_view_under_new_application() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("primaryMobileNumber_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_alternative_mobile_field_in_reference_list_view_under_new_application() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("alternativeMobileNumber_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_email_id_field_in_reference_list_view_under_new_application() {
	...
	public void user_610_verify_the_no_of_year_known_field_in_reference_list_view_under_new_application() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("NoOfYearKnow_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_cif_n_umber_field_in_reference_list_view_under_new_application() {
	...
	public void user_610_verify_the_any_mandatory_field_blank_and_save_system_should_not_allow_user_to_save_the_record()
			throws Throwable {
	...
	public void user_610_verify_enter_numeric_value_in_character_field_system_should_not_allow_user_to_save_the_record() {

	}

	@And("User_610 verfiy enter character value in numeric field system should not allow user to save the record")
	public void user_610_verfiy_enter_character_value_in_numeric_field_system_should_not_allow_user_to_save_the_record() {

	}

	@And("User_610 verify enters only special characters value in any field system should not allow user to save the record")
	public void user_610_verify_enters_only_special_characters_value_in_any_field_system_should_not_allow_user_to_save_the_record() {
		...
		for (int i = 0; i < 3000; i++) {
			try {
				if (javascriptHelper
						.executeScriptWithWebElement(jsPaths2.getElement("onlyAlphaNumericCharterPopup_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_click_document_details_in_tawarrqu() {
		...
		for (int i = 0; i < 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("Tawarrqu_DocumentsDetailsScreen_610"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 299) {
	...
	public void user_610_click_document_details_in_murabha() {
		...
		for (int i = 0; i < 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("Murabha_DocumentsDetailsScreen_610"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 299) {
	...
	public void user_610_verify_the_required_at_stage_field_is_displayed_in_document_details_screen() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("RequiredAtStage_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_documents_status_field_is_displayed_in_document_details_screen() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("DocumentStatus_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_mandatory_optional_field_is_displayed_in_document_details_screen() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("Mandatory_Optional_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_document_categeroy_field_is_displayed_in_document_details_screen() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("DocumentCategeroy_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_defferral_stage_field_is_displayed_in_document_details_screen() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("DefferralStage_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_def_approved_by_field_is_displayed_in_document_details_screen() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("DefApprovedBy_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_change_in_natural_by_field_is_displayed_in_document_details_screen() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("ChangeInNaturalBy_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_documents_form_field_is_displayed_in_document_details_screen() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("DocumentsFrom_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_documents_quality_field_is_displayed_in_document_details_screen() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("DocumentQuality_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_documents_recevied_by_field_is_displayed_in_document_details_screen() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("DocumentRecivedBy"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_upload_by_field_is_displayed_in_document_details_screen() {
	...
	public void user_610_verify_the_expected_recepited_date_field_is_displayed_in_document_details_screen() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("ExpectedRecepitedDate_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_data_of_expiry_field_is_displayed_in_document_details_screen() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("DataOfExpiry_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_documents_reference_number_field_is_displayed_in_document_details_screen() {

		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("DocumentReferenceNumber_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_rack_no_field_is_displayed_in_document_details_screen() {
	...
	public void user_610_verify_the_shall_no_field_is_displayed_in_document_details_screen() {
	...
	public void user_610_verify_the_box_no_field_is_displayed_in_document_details_screen() {
	...
	public void user_610_select_the_optional_in_mandatory_optional_field() throws Throwable {
		...
		for (int j = 0; j <= premitiveDropdownLength; j++) {
			...
			if ((dropdownString.trim()).equalsIgnoreCase("Optional")) {
	...
	public void user_610_select_the_pan_card_in_document_name() throws Throwable {
	...
	public void user_610_select_the_not_received_in_documents_status() throws Throwable {
		...
		for (int j = 0; j <= premitiveDropdownLength; j++) {
			...
			if ((dropdownString.trim()).equalsIgnoreCase("Not Received")) {
	...
	public void user_610_select_the_kyc_document_in_document_categery() throws Throwable {
		...
		for (int j = 0; j <= premitiveDropdownLength; j++) {
			...
			if ((dropdownString.trim()).equalsIgnoreCase("KYC Document")) {
	...
	public void user_610_select_the_optional_in_document_quality() throws Throwable {
		...
		for (int j = 0; j <= premitiveDropdownLength; j++) {
			...
			if ((dropdownString.trim()).equalsIgnoreCase("Not Clear")) {
	...
	public void user_610_enter_the_value_in_remarks() throws Throwable {

		javascriptHelper
				.scrollIntoView(javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("Remarks_610")));
	...
	public void user_610_click_save_button() {
	...
	public void user_610_save_button_and_verify_the_success_meassage() {

		javascriptHelper
				.scrollIntoView(javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("ApplicationID_610")));
	...
	public void user_610_verify_the_documents_name_field_should_be_mandatory() {
	...
	public void user_610_verify_the_status_field_should_be_mandator_editable_dropdown() {
	...
	public void user_610_verify_the_quality_field_should_be_mandatory_editable_drpodown() {
	...
	public void user_610_verify_the_date_field_should_be_non_mandatory_and_date() {
		...
		String UpLoadFormat = javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("UploadDate_610"))
	...
	public void user_610_verify_the_location_field_should_non_be_mandatory_Select() {
	...
	public void user_610_verify_the_rack_no_field_should_be_non_mandator_text_box() {
		...
		String RackNoFormat = javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("RackNo_610"))
	...
	public void user_610_verify_the_self_no_field_should_be_non_mandatory_text_box() {
		...
		String SelfNoFormat = javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("ShelfN0_610"))
				.getAttribute("ng-reflect-type");
	...
	public void user_610_verify_the_box_no_field_should_be_non_mandatory_text_box() {
		...
		String BoxNoFormat = javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("BoxNo_610"))
				.getAttribute("ng-reflect-type");
	...
	public void user_610_verify_the_documents_category_field_should_be_mandatory_select() {
	...
	public void user_610_verify_the_document_from_field_should_be_non_mandator_select() {
		...
		String DocumentFrom = javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("DocumentsFrom_610"))
				.getAttribute("ng-reflect-placeholder");
	...
	public void user_610_verify_the_expected_date_of_receipt_field_should_be_non_mandatory_date() {
		...
		for (int i = 0; i < 200; i++) {
			try {
				...
				String ExpectedDateOfReceiptName = (String) javascriptHelper
						.executeScript("return " + ExpectedDateOfReceipt);
	...
	public void user_610_verify_the_waiver_defferral_approved_by_field_should_be_non_mandatory_text_box() {
	...
	public void user_610_verify_the_change_in_nature_of_document_approved_by_field_should_be_non_mandatory_text_box() {
		...
		for (int i = 0; i < 200; i++) {
			try {
				...
				String ChangeNatureOfDocumentAppName = (String) javascriptHelper
						.executeScript("return " + ChangeNatureOfDocumentApp);
	...
	public void user_610_verify_the_documents_reference_number_field_should_be_non_mandatory_text() {
		...
		for (int i = 0; i < 200; i++) {
			try {
				...
				String DocumentReferceNumberName = (String) javascriptHelper
						.executeScript("return " + DocumentReferceNumber);
	...
	public void user_610_verify_the_remarks_field_should_be_mandator_text() {
		...
		String RemarkFormat = javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("Remarks_Format_610"))
	...
	public void user_610_verify_the_upload_document() {

		for (int i = 0; i < 200; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("UploadDocument_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
				}
				break;
	...
	public void user_610_click_edit_button_under_documents_details() throws Throwable {
	...
	// -------------------------@AT_MU_DOC_08 ---------------- Screen should get
	// open with already filled data

	@And("User_610 verify the Document Name Screen should get open with already filled data")
	public void user_610_verify_the_document_name_screen_should_get_open_with_already_filled_data() throws Throwable {

		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("DocumentNamePancard_610")));

		// -------------------validate Screen should get open with already filled data

		String DocumentNamealreadyData = javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("DocumentNamePancard_610")).getAttribute("aria-label");
	...
	public void user_610_verify_the_document_category_screen_should_get_open_with_already_filled_data()
			throws Throwable {

		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("DocumentCategoryDigitialKYC_610")));
	...
	public void user_610_veriy_the_add_back_and_search_button_or_not_editable() {
	...
	public void user_610_verify_the_functionality_of_add_button() {
		...
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("DocumentDetailsScreen_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_matching_and_mismatching_data_of_search() throws Throwable {
		...
		for (int k = 0; k < 200; k++) {
			try {
				...
				javascriptHelper
						.executeScriptWithWebElement(
								jsPaths2.getElement("inputBox_searchBtn_murabhaDocumentDetails_610"))
						.sendKeys("pan card");
				break;
			} catch (Exception e) {
				if (k == 199) {
		...
		for (int l = 0; l < 200; l++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						jsPaths2.getElement("inputBox_searchBtn_murabhaDocumentDetails_610")).clear();
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("searchBtn_underFollowUpList_610"))
						.click();
				javascriptHelper.executeScriptWithWebElement(
						jsPaths2.getElement("inputBox_searchBtn_murabhaDocumentDetails_610")).sendKeys("ccard");
				break;
			} catch (Exception e) {
				if (l == 199) {
					Assert.fail(e.getMessage());
		...
		for (int m = 0; m < 200; m++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("vaildate_theMisMatchingData_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_functionality_of_back_button() {
		...
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("DocumentDetailsFirstScreen_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_click_the_customer_follow_details_in_morabha() throws Throwable {
	...
	public void user_610_verify_the_add_buttton() throws Throwable {
//		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
//				.executeScriptWithWebElement(jsPaths2.getElement("clickAddBtn_UnderDocumentDetails_610")));
	...
	public void user_610_validate_called_when_field_enabled_or_not_under_murabha_customer_follow_details()
			throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
	...
	public void user_610_validate_follow_up_data_field_enabled_or_not_under_murabha_customer_follow_details()
			throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("followUpDate_610")));
	...
	public void user_610_validate_the_called_when_field_should_be_date_mandatory_and_editable_in_murabha()
			throws Throwable {
...
//		WebElement attribute = javascriptHelper.executeScriptWithWebElement(calledPath);
		...
		for (int i = 0; i < 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("CalledWhen_610")).click();
				break;
			} catch (Exception e) {
				if (i == 299) {
					Assert.fail(e.getMessage());
	...
	public void user_610_validate_the_customer_responce_field_should_be_look_up_mandatory_and_editable_in_murabha()
			throws Throwable {
		...
		for (int i = 0; i < 200; i++) {
			try {
				...
				String customerResponceMurabhaName = (String) javascriptHelper
						.executeScript("return " + customerResponceMurabha);
		...
		for (int j = 0; j <= premitiveDropdownLength; j++) {
			...
			System.out.println("String " + dropdownString.trim());
			// System.out.println("Map " + testData.get("CustomerResponce").trim());
			if ((dropdownString.trim()).equalsIgnoreCase((" REA02 ").trim())) {
				for (int k = 0; k <= 300; k++) {
					try {
						clicksAndActionsHelper.moveToElement(javascriptHelper.executeScriptWithWebElement(
								"document.querySelectorAll('ion-radio-group ion-radio')[" + j + "]"));
	...
	public void user_610_validate_the_follow_up_date_field_should_be_date_mandatory_and_editable_in_murabha() {
	...
	public void user_610_validate_the_sign_status_field_should_be_dropdown_mandatory_and_editable_in_murabha() {
	...
	public void user_610_validate_the_remarks_field_should_be_textbox_mandatory_and_editable_in_murabha() {
	...
	public void user_610_validate_the_save_button_under_customer_follow_details_in_murabha() {
	...
	public void user_610_to_verify_the_functionality_of_search_box_with_matching_data_should_be_show_matching_data_in_murabha()
			throws Throwable {
		Thread.sleep(1000);
...
//				searchBtnString.click();
				javascriptHelper.executeScriptWithWebElement(jsPaths3.getElement("searchBtnFollowUpDetails_610"))
						.click();
				javascriptHelper
						.executeScriptWithWebElement(jsPaths3.getElement("inputBox_searchBtn_underFollowUpDetails_610"))
...
//		}
	...
	public void user_610_to_verfiy_the_functionality_of_search_box_with_not_matching_data_should_not_be_show_no_data_in_murabha()
			throws Throwable {
		...
		for (int k = 0; k < 200; k++) {
			try {
				javascriptHelper
						.executeScriptWithWebElement(jsPaths3.getElement("inputBox_searchBtn_underFollowUpDetails_610"))
						.clear();
				javascriptHelper.executeScriptWithWebElement(jsPaths3.getElement("searchBtn_underFollowUpList_610"))
						.click();
				javascriptHelper
						.executeScriptWithWebElement(jsPaths3.getElement("inputBox_searchBtn_underFollowUpDetails_610"))
						.sendKeys("22222");
		...
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths3.getElement("vaildate_theMisMatchingData_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_click_insurance_info_screen() {
	...
	public void user_610_click_view_button() {
	...
	public void user_610_verify_the_insurance_info_screen_get_open() {

		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("BackBtn_underFollowUpList_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_field_insurance_year() {

		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("insuranceYear_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_field_depreciation() {

		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("depreciation_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_field_assert_price() {

		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("assertPrice_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_rate_per_price() {

		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("ratePerAssert_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_minium_insurance_premium() {

		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("miniumInsurancePremium_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_base_insurance_premium() {

		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("baseInsurancePremium_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_vat_premium() {
	...
	public void user_610_verify_the_net_premium() {
	...
	public void user_610_verify_the_back_button() {
	...
	public void user_610_click_facility_details_screen() {
	...
	public void user_610_click_facility_details_screen_al() {
		...
		for (int b = 0; b < 300; b++) {
			try {
				javascriptHelper.executeScriptWithWebElement(FacilityDetails.getElement("Facility_info_Tab_AL"))
						.click();
				break;
			} catch (Exception e) {
				if (b == 299) {
	...
	public void user_610_click_add_button() {
		for (int b = 0; b < 300; b++) {
			try {
				javascriptHelper.executeScriptWithWebElement(FacilityDetails.getElement("AddButton_under_FacilityInfo"))
						.click();
				break;
			} catch (Exception e) {
				if (b == 299) {
	...
	public void user_610_verify_the_classification_field_under_facility_details() throws Throwable {
		Thread.sleep(3000);
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(FacilityDetails.getElement("Classification"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_product_field_under_facility_details() {
		for (int j = 0; j < 200; j++) {
			try {
	...
	public void user_610_verify_the_scheme_field_under_facility_details() {
		for (int j = 0; j < 200; j++) {
			try {
	...
	public void user_610_verify_the_program_code_field_under_facility_details() {
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(FacilityDetails.getElement("ProgrameCode"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_facility_type_field_under_facility_details() {
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(FacilityDetails.getElement("FacilityType"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_pricing_indicator_field_under_facility_details() {
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(FacilityDetails.getElement("PricingIndicator"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_requested_amount_field_under_facility_details() {
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(FacilityDetails.getElement("RequestedAmount"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_declared_property_value_amount_field_under_facility_details() {
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(FacilityDetails.getElement("DeclaredPropertyValue"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_declared_down_payment_amolunt_field_under_facility_details() {
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper
	...
	public void user_610_verify_the_currency_field_under_facility_details() {
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(FacilityDetails.getElement("Currency"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_loan_tenure_field_under_facility_details() {
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(FacilityDetails.getElement("LoanTenure"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_servicing_branch_field_under_facility_details() {
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(FacilityDetails.getElement("ServicingBranch"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_back_button_field_under_facility_details() {
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(FacilityDetails.getElement("BackButton"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_save_button_field_under_facility_details() {
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(FacilityDetails.getElement("SaveButton"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_product_field_mandatory_editable_select() {
		for (int i = 0; i < 2000; i++) {
			try {
	...
	public void user_610_verify_the_scheme_field_mandatory_editable_select() {
		for (int i = 0; i < 2000; i++) {
			try {
	...
	public void user_610_verify_the_program_code_field_mandatory_editable_select() {
		for (int i = 0; i < 2000; i++) {
			try {
	...
	public void user_610_verify_the_servicing_branch_field_mandatory_editable_select() {
		for (int i = 0; i < 2000; i++) {
			try {
	...
	public void user_610_verify_the_pricing_indicator_field_mandatory_editable_select() {
		for (int i = 0; i < 2000; i++) {
			try {
	...
	public void user_610_verify_the_requested_amount_field_mandatory_editable_numberic() {
		for (int i = 0; i < 2000; i++) {
			try {
	...
	public void user_610_verify_the_declared_downpayment_amount_field_mandatory_editable_numberic() {
		for (int i = 0; i < 2000; i++) {
			try {
	...
	public void user_610_verify_the_currency_field_mandatory_editable_select() {
		for (int i = 0; i < 2000; i++) {
			try {
	...
	public void user_610_verify_the_loan_tenure_field_mandatory_editable_numberic() {
		for (int i = 0; i < 2000; i++) {
			try {
	...
	public void user_610_verify_the_classification_field_in_list_view() {
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(FacilityDetails.getElement("Classification"))
						.isDisplayed()) {
	...
	public void user_610_verify_the_product_field_in_list_view() {
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(FacilityDetails.getElement("Product")).isDisplayed()) {
					Assert.assertTrue(true);
	...
	public void user_610_verify_the_tenure_field_in_list_view() {
		for (int j = 0; j < 200; j++) {
			try {
	...
	public void user_610_verify_the_requested_amount_field_in_list_view() {
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(FacilityDetails.getElement("RequestAmount"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_status_field_in_list_view() {
		for (int j = 0; j < 200; j++) {
			try {
	...
	public void user_610_verify_the_add_button_field_in_list_view() {
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper
						.executeScriptWithWebElement(FacilityDetails.getElement("AddButton_under_FacilityInfo"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_the_export_pdf_button_field_in_list_view() {
	...
	public void user_610_verify_the_export_xslbutton_field_in_list_view() {
		for (int j = 0; j < 200; j++) {
			try {
	...
	public void user_610_verify_the_search_button_field_in_list_view() {
		for (int j = 0; j < 200; j++) {
			try {
	...
	public void user_610_verify_post_entering_any_matching_value_system_should_display() {
		for (int b = 0; b < 300; b++) {
			try {
		...
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(FacilityDetails.getElement("matchingData"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_610_verify_post_entering_any_mis_matching_value_system_should_display() {
		for (int b = 0; b < 300; b++) {
			try {
	...
	public void user_610_click_export_button() throws Throwable {
		for (int b = 0; b < 300; b++) {
			try {
				javascriptHelper.executeScriptWithWebElement(FacilityDetails.getElement("ExportDropDown")).click();
				break;
	...
	public void user_610_verify_the_pdf_button_should_download_the_pdf_file_of_that_records() throws Throwable {
...
//		IncomeFormDataFile
	...
	public void user_610_verify_the_excel_button_should_download_the_pdf_file_of_that_records() throws Throwable {
		for (int b = 0; b < 300; b++) {
			try {
	...
	public void user_610_verify_the_back_button_fd() {
		...
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(FacilityDetails.getElement("ExportDropDown"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
