	...
	public void user_608_verify_save_button_is_available_under_customer_information_screen() throws Throwable {
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(customerDetailsSaveBtn.isDisplayed(), 
						"Save button should be Displayed in Customer Information screen");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
	...
	public void user_608_verfiy_save_button_is_available_under_contact_details_screen() throws Throwable {
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(contactDetailsSaveBtn.isDisplayed(),
...
//	@AT_TW_CD_02
	...
	public void user_608_verify_mandatory_blank_field_validation_message_in_customer_information_screen() throws Throwable {		
		for (int i = 0; i <= 150; i++) {
			try {
				WebElement blankFieldError = javascriptHelper.executeScriptWithWebElement(
						appDataCustomerDetailsJsPaths.getElement("blankFieldError"));
...
//	AT_TW_AD_06
	...
	public void user_608_verify_client_name_field_available_in_list_view_under_application_details_screen() throws Throwable {
		for (int i = 0; i <= 150; i++) {
			try {
				WebElement listview_ClientName = javascriptHelper.executeScriptWithWebElement(
						appDataAppDetailsJsPaths.getElement("listview_ClientName"));
		...
		for (int i = 0; i <= 300; i++) {
			try {
				...
				softAssert.assertTrue(Integer.parseInt(text)>0, 
						"All possible Matching records are showing under Application Details screen");
				break;
			} catch (Exception e) {
				if (i == 300) {
					Assert.fail(e.getMessage());
	...
	public void user_608_verify_the_system_is_should_not_displayed_any_records_under_application_details_screen() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				...
				System.out.println("Result value: "+text);
				softAssert.assertTrue(Integer.parseInt(text)==0, 
						"System is should not displayed any records under Application Details screen");
				break;
			} catch (Exception e) {
				if (i == 300) {
					Assert.fail(e.getMessage());
			...
			for (int i = 0; i < 300; i++) {
				try {
					for (int j = 0; j < Integer.parseInt(length); j++) {
						String title = "return document.querySelectorAll('ion-radio-group ion-label')[" + j + "].textContent";
						String titlename = javascriptHelper.executeScript(title).toString();
						if (titlename.trim().contains(testData.get("Decision_Value"))) {
							String jspath = "document.querySelectorAll('ion-radio-group ion-radio')[" + j + "]";
							WebElement btn = javascriptHelper.executeScriptWithWebElement(jspath);
							actions.moveToElement(btn).click().build().perform();
							break;
...
//		AT_TW_UNW_04
		...
		public void user_608_select_the_note_code_value_in_recommendationsanction_hyperlink_screen() throws Throwable {
			for (int i = 0; i <= 300; i++) {
				try {
		...
		public void user_608_enter_sequence_number_in_recommendationsanction_hyperlink_screen() throws Throwable {
		...
		public void user_608_select_note_sub_code_value_in_recommendationsanction_hyperlink_screen() throws Throwable {
			for (int i = 0; i <= 300; i++) {
				try {
		...
		public void user_608_enter_condition_value_in_recommendationsanction_hyperlink_screen() throws Throwable {
		...
		public void user_608_enter_remarks_in_recommendationsanction_hyperlink_screen() throws Throwable {
...
//		AT_TW_UNW_05
		...
		public void user_608_select_the_decision_value_under_decision_section_in_offer_decision_tab()
				throws Throwable {
			for (int i = 0; i <= 300; i++) {
				try {
					javascriptHelper.executeScriptWithWebElement(
			...
			for (int i = 0; i < 300; i++) {
				try {
					for (int j = 0; j < Integer.parseInt(length); j++) {
						...
						String titlename = javascriptHelper.executeScript(title).toString();
						System.out.println("Option: "+titlename);				
						if (titlename.trim().equalsIgnoreCase(testData.get("Decision_Value1"))) {
							String jspath = "document.querySelectorAll('ion-radio-group ion-radio')[" + j + "]";
							WebElement btn = javascriptHelper.executeScriptWithWebElement(jspath);
							actions.moveToElement(btn).click().build().perform();
							break;
...
//		AT_TW_UNW_06
		...
		public void user_608_enter_the_invalid_deviation_amount_under_finance_configuration_section_in_offer_decision_tab()
				throws Throwable {
			for (int i = 0; i <= 300; i++) {
				try {
		...
		public void user_608_to_verify_validation_message_offered_amount_is_greater_than_requested_amount_in_offer_decision_tab()
				throws Throwable {
			for (int i = 0; i <= 300; i++) {
				try {
					WebElement alertPopup = javascriptHelper
							.executeScriptWithWebElement(underWriterJsPaths.getElement("alertPopup"));
					javascriptHelper.backgroundBorder(alertPopup);
					softAssert.assertTrue(alertPopup.isDisplayed(),
							"Deviation amount cannot be greater than requested amount message should be displayed");
					break;
				} catch (Exception e) {
					if (i == 300) {
						Assert.fail(e.getMessage());
		...
		public void user_608_enter_deviation_amount_under_finance_configuration_section_in_offer_decision_tab()
				throws Throwable {
			for (int i = 0; i <= 300; i++) {
				try {
					WebElement Finance_DeviationAmountInput = javascriptHelper
		...
		public void user_608_enter_deviation_tenure_under_finance_configuration_section_in_offer_decision_tab()
				throws Throwable {
			for (int i = 0; i <= 300; i++) {
				try {
