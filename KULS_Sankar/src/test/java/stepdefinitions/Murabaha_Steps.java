...
//	AT_MCUD_08
	...
	public void user_608_search_matching_value_system_should_display_all_the_possible_matching_records_under_financial_commitments_section()
			throws Throwable {
		for (int i = 0; i <= 500; i++) {
			try {
				javascriptHelper
...
//	AT_MU_AD_05
	...
	public void user_608_verify_sourcing_type_field_as_mandatory_non_editable_and_dropdown_under_referral_sourcing_details_section()
			throws Throwable {
//		Validate Mandatory		
		for (int i = 0; i <150; i++) {
          try {
...
//	AT_MU_INC_07
	...
	public void user_608_verify_the_functionality_of_search_box_with_matching_data_in_income_section() throws Throwable {
		for (int i = 0; i <= 150; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						appData_IncomeJsPaths.getElement("incomeSectionSearchbox"))
