...
//document.querySelectorAll('ion-radio-group ion-item')[0].textContent
		...
		for (int i = 0; i <= 200; i++) {
			try {
				...
				String toastMessage = javascriptHelper
						.executeScript(commonJSPaths.getElement("toast_container_message")).toString();
	...
	public void user_verify_total_finance_amount_request_field_should_be_mantatory_numeric() {
		userUtility.verifyGivenFieldIsMandatory(driver,
				applicationDetailsElements.getElement("total_amount_requested_Field"));
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						applicationDetailsElements.getElement("total_amount_requested_input")).click();
				javascriptHelper.executeScriptWithWebElement(
						applicationDetailsElements.getElement("total_amount_requested_input")).clear();
				javascriptHelper
						.executeScriptWithWebElement(
	...
	public void user_verify_declared_currrent_obligation_field_should_be_non_mandatory_editable_numeric() {
		...
		for (int j = 0; j < 2000; j++) {
			try {
				String Field = javascriptHelper.executeScript(
						"return document.querySelector('ion-label[ng-reflect-text=\"ApplicationDetails.DeclaredCur\"]').innerText")
						.toString();
		...
		// userUtility.verifyGivenFieldIsNotMandatory(driver,
		// applicationDetailsElements.getElement("declared_current_obligation_Field"));
		...
		for (int i = 0; i <= 300; i++) {
			try {
				...
				javascriptHelper.executeScriptWithWebElement(
						applicationDetailsElements.getElement("declared_current_obligation_input")).clear();
				javascriptHelper
						.executeScriptWithWebElement(
	...
	public void user_verify_special_promotional_campaign_field_should_be_non_mandatory_editable_dropdown() {
		userUtility.verifyGivenFieldIsNotMandatory(driver,
				applicationDetailsElements.getElement("special_promotion_Field"));
	...
	public void user_verify_sourcing_channel_field_should_be_mandatory_editable_dropdown() {
		userUtility.verifyGivenFieldIsMandatory(driver,
				applicationDetailsElements.getElement("sourcing_channel_Field"));
	...
	public void user_verify_business_center_code_field_should_be_mandatory_editable_dropdown() {
		userUtility.verifyGivenFieldIsMandatory(driver,
				applicationDetailsElements.getElement("business_center_code_Field"));
	...
	public void user_verify_servicing_branch_field_should_be_mandatory_editable_dropdown() {
		userUtility.verifyGivenFieldIsMandatory(driver,
				applicationDetailsElements.getElement("servicing_branch_Field"));
	...
	public void user_verify_spoke_location_field_should_be_non_mandatory_editable_dropdown() {
		userUtility.verifyGivenFieldIsNotMandatory(driver,
				applicationDetailsElements.getElement("spoke_location_Field"));
	...
	public void user_verify_closing_staff_or_servicing_staff_or_rm_field_should_be_mandatory_editable_dropdown() {
		userUtility.verifyGivenFieldIsNotMandatory(driver,
				applicationDetailsElements.getElement("closing_staff_of_servicing_staff_RM_Field"));
	...
	public void user_0482_verify_topup_application_should_be_non_mandatory_editable_textbox() {
		userUtility.verifyGivenFieldIsNotMandatory(driver,
				applicationDetailsElements.getElement("TopupApplication_Field"));
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper
						.executeScriptWithWebElement(applicationDetailsElements.getElement("TopupApplication_input"))
						.click();
				javascriptHelper
						.executeScriptWithWebElement(applicationDetailsElements.getElement("TopupApplication_input"))
						.clear();
	...
	public void user_verify_sourcing_staff_field_should_be_non_mandatory_editable_lookup() {
		...
		for (int i = 0; i < 2000; i++) {
			try {
				String Field = javascriptHelper
						.executeScript("return " + applicationDetailsElements.getElement("sourcing_staff_Field"))
						.toString();
				System.out.println(Field);
	...
	public void user_verify_reference_type_field_should_be_non_mandatory_editable_lookup() {
		userUtility.verifyGivenFieldIsNotMandatory(driver,
				applicationDetailsElements.getElement("reference_type_Field"));
	...
	public void user_verify_reference_entity_field_should_be_non_mandatory_editable_lookup() {
		userUtility.verifyGivenFieldIsNotMandatory(driver,
				applicationDetailsElements.getElement("reference_entity_Field"));
	...
	public void user_verify_reference_code_field_should_be_non_mandatory_editable_textbox() {
		userUtility.verifyGivenFieldIsNotMandatory(driver,
				applicationDetailsElements.getElement("reference_code_Field"));
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper
						.executeScriptWithWebElement(applicationDetailsElements.getElement("reference_code_input"))
