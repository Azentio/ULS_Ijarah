...
public class TawarruqAppDataEntryFollowupdetails {
	...
	JSPaths TWAppDataEntryFollowUpDetails = new JSPaths(excelPath, "TWAppDataEntryFollowUpDetails", "FieldName",
			"JSPath");
...
//	Map<String, String> TestData = new HashMap<>();
	...
	public void user_607_click_the_customer_follow_details_in_morabha() throws Throwable {
		...
		for (int i = 0; i < 200; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(TWAppDataEntryFollowUpDetails.getElement("nextBtn_610"))
						.click();
				javascriptHelper.executeScriptWithWebElement(TWAppDataEntryFollowUpDetails.getElement("nextBtn_610"))
						.click();
				javascriptHelper.executeScriptWithWebElement(TWAppDataEntryFollowUpDetails.getElement("nextBtn_610"))
...
//				.executeScriptWithWebElement(TWAppDataEntryFollowUpDetails.getElement("click_CustomerFollowUpDetailsTab_610")));
			...
			try {
				javascriptHelper
						.executeScriptWithWebElement(
								TWAppDataEntryFollowUpDetails.getElement("click_CustomerFollowUpDetailsTab_610"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 199) {
	...
	public void user_607_click_add_button_under_customer_follow_details() throws Throwable {
		...
		for (int i = 0; i < 300; i++) {
			try {
				javascriptHelper
						.executeScriptWithWebElement(
								TWAppDataEntryFollowUpDetails.getElement("click_AddButton_UnderFollowUpDetails_610"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 299) {
	...
	public void user_607_validate_customer_resbonce_field_enabled_or_not_under_customer_follow_details()
		...
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(
				TWAppDataEntryFollowUpDetails.getElement("click_customerResponce_UnderFollowUp_610")));
		if (!javascriptHelper
				.executeScriptWithWebElement(
						TWAppDataEntryFollowUpDetails.getElement("click_customerResponce_UnderFollowUp_610"))
				.isDisplayed()) {
...
//				.executeScriptWithWebElement(TWAppDataEntryFollowUpDetails.getElement("clickAddBtn_UnderDocumentDetails_610")));
		...
		for (int m = 0; m < 200; m++) {
			try {
				if (javascriptHelper
						.executeScriptWithWebElement(
								TWAppDataEntryFollowUpDetails.getElement("clickAddBtn_UnderDocumentDetails_610"))
						.isDisplayed()) {
	...
	public void user_607_validate_called_when_field_enabled_or_not_under_murabha_customer_follow_details()
			throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_607_validate_follow_up_data_field_enabled_or_not_under_murabha_customer_follow_details()
			throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
				.executeScriptWithWebElement(TWAppDataEntryFollowUpDetails.getElement("followUpDate_610")));

		if (javascriptHelper.executeScriptWithWebElement(TWAppDataEntryFollowUpDetails.getElement("followUpDate_610"))
				.isDisplayed()) {
			Assert.assertTrue(true);
			;
		}
	...
	public void user_607_validate_remark_category_field_enabled_or_not_under_customer_follow_details()
			throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(
				TWAppDataEntryFollowUpDetails.getElement("click_remark_UnderFollowUp_610")));
		if (!javascriptHelper
				.executeScriptWithWebElement(TWAppDataEntryFollowUpDetails.getElement("click_remark_UnderFollowUp_610"))
				.isDisplayed()) {
			Assert.fail();
		}
	}
	...
	public void user_607_validate_back_button_field_enabled_or_not_under_customer_follow_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(
				TWAppDataEntryFollowUpDetails.getElement("click_backButton_UnderFollowUp_610")));
		if (!javascriptHelper.executeScriptWithWebElement(
				TWAppDataEntryFollowUpDetails.getElement("click_backButton_UnderFollowUp_610")).isDisplayed()) {
			Assert.fail();
		}
	}

	@And("User_607 validate Save button field enabled or not under customer follow details")
	public void user_607_validate_save_button_field_enabled_or_not_under_customer_follow_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(
				TWAppDataEntryFollowUpDetails.getElement("click_SaveButton_UnderFollowUp_610")));
		if (!javascriptHelper.executeScriptWithWebElement(
				TWAppDataEntryFollowUpDetails.getElement("click_SaveButton_UnderFollowUp_610")).isDisplayed()) {
			Assert.fail();
		}
	}
	...
	public void user_607_to_verify_the_functionality_of_add_button_should_allow_create_new_record() throws Throwable {
		...
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(
						TWAppDataEntryFollowUpDetails.getElement("followUpDetailsScreen_610")).isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
			} catch (Exception e) {
		...
		for (int k = 0; k < 200; k++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						TWAppDataEntryFollowUpDetails.getElement("BackBtn_underFollowUpList_610")).click();
				break;
			} catch (Exception e) {
				// TODO: handle exception
			}
	...
	public void user_607_to_verify_the_functionality_of_edit_button_should_redirct_the_edit_page() throws Throwable {
		...
		for (int i = 0; i < 200; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						TWAppDataEntryFollowUpDetails.getElement("editBtn_UnderFollowUp_610")).click();
				;
				break;
			} catch (Exception e) {
				// TODO: handle exception
	...
	public void user_607_validate_single_status_field_enabled_or_not_under_customer_follow_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(
				TWAppDataEntryFollowUpDetails.getElement("click_signStatus_UnderFollowUp_610")));
		if (!javascriptHelper.executeScriptWithWebElement(
				TWAppDataEntryFollowUpDetails.getElement("click_signStatus_UnderFollowUp_610")).isDisplayed()) {
			Assert.fail();
		}
	}
	...
	public void user_607_validate_the_called_when_field_should_be_date_mandatory_and_editable_in_murabha()
			throws Throwable {
...
//		WebElement attribute = javascriptHelper.executeScriptWithWebElement(calledPath);
		...
		for (int b = 0; b < 300; b++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						TWAppDataEntryFollowUpDetails.getElement("selectTodayDateIn_FollowUPDate_UnderFollowUp_610"))
						.click();
				break;
			} catch (Exception e) {
				if (b == 299) {
	...
	public void user_607_validate_the_customer_responce_field_should_be_look_up_mandatory_and_editable_in_murabha()
			throws Throwable {
		...
		for (int b = 0; b < 300; b++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						TWAppDataEntryFollowUpDetails.getElement("click_customerResponceSelect_UnderFollowUp_610"))
						.click();
				break;
			} catch (Exception e) {
				if (b == 299) {
	...
	public void user_607_click_save_button_follow_up_details_screen() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						TWAppDataEntryFollowUpDetails.getElement("SaveButtonInFollowUpDetails")).click();
				break;
			} catch (Exception e) {
				if (i == 699) {
					Assert.fail(e.getMessage());
	...
	public void user_607_validate_the_save_button_under_customer_follow_details_in_murabha() {
		...
		for (int b = 0; b < 300; b++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						TWAppDataEntryFollowUpDetails.getElement("click_SaveButton_UnderFollowUp_610")).click();
				break;
			} catch (Exception e) {
				if (b == 299) {
					Assert.fail(e.getMessage());
		...
		for (int i = 0; i <= 500; i++) {
			try {
				if (javascriptHelper
						.executeScriptWithWebElement(TWAppDataEntryFollowUpDetails.getElement("successMsg_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
				}
				break;
	...
	public void user_607_click_insurance_info_screen() {
		...
		for (int b = 0; b < 300; b++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						TWAppDataEntryFollowUpDetails.getElement("insuranceInfo_Screen_610")).click();
				break;
			} catch (Exception e) {
				if (b == 299) {
					Assert.fail(e.getMessage());
	...
	public void user_607_click_view_button() {
		...
		for (int b = 0; b < 300; b++) {
			try {
				javascriptHelper.executeScriptWithWebElement(TWAppDataEntryFollowUpDetails.getElement("viewBtn_610"))
						.click();
				break;
			} catch (Exception e) {
				if (b == 299) {
	...
	public void user_607_verify_the_insurance_info_screen_get_open() {
		...
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper
						.executeScriptWithWebElement(
								TWAppDataEntryFollowUpDetails.getElement("BackBtn_underFollowUpList_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_607_verify_the_field_insurance_year() {
		...
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper
						.executeScriptWithWebElement(TWAppDataEntryFollowUpDetails.getElement("insuranceYear_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_607_verify_the_field_depreciation() {
		...
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper
						.executeScriptWithWebElement(TWAppDataEntryFollowUpDetails.getElement("depreciation_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_607_verify_the_field_assert_price() {
		...
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper
						.executeScriptWithWebElement(TWAppDataEntryFollowUpDetails.getElement("assertPrice_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_607_verify_the_rate_per_price() {
		...
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper
						.executeScriptWithWebElement(TWAppDataEntryFollowUpDetails.getElement("ratePerAssert_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_607_verify_the_minium_insurance_premium() {
		...
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(
						TWAppDataEntryFollowUpDetails.getElement("miniumInsurancePremium_610")).isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
			} catch (Exception e) {
	...
	public void user_607_verify_the_base_insurance_premium() {
		...
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(
						TWAppDataEntryFollowUpDetails.getElement("baseInsurancePremium_610")).isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
			} catch (Exception e) {
	...
	public void user_607_verify_the_vat_premium() {
		...
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper
						.executeScriptWithWebElement(TWAppDataEntryFollowUpDetails.getElement("VATPremium_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_607_verify_the_net_premium() {
		...
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper
						.executeScriptWithWebElement(TWAppDataEntryFollowUpDetails.getElement("NetPremium_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_607_verify_the_back_button() {
		...
		for (int j = 0; j < 200; j++) {
			try {
				if (javascriptHelper
						.executeScriptWithWebElement(TWAppDataEntryFollowUpDetails.getElement("viewBtn_610"))
						.isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
	...
	public void user_607_check_save_button_and_back_button_in_follow_up_details_screen() {
		for (int i = 0; i < 500; i++) {
			try {
				if (!(javascriptHelper
						.executeScriptWithWebElement(
								TWAppDataEntryFollowUpDetails.getElement("BackButtonInFollowUpDetails"))
						.isDisplayed())) {
					Assert.fail();
				}
				break;
		...
		for (int i = 0; i < 500; i++) {
			try {
				if (!(javascriptHelper
						.executeScriptWithWebElement(
								TWAppDataEntryFollowUpDetails.getElement("SaveButtonInFollowUpDetails"))
						.isDisplayed())) {
					Assert.fail();
				}
				break;
	...
	public void user_607_check_able_to_modify_the_record_in_follow_up_details_screen() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper
						.executeScriptWithWebElement(TWAppDataEntryFollowUpDetails.getElement("CustomerResponse"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 699) {
		...
		for (int j = 0; j <= premitiveDropdownLength; j++) {
			...
			if ((dropdownString.trim()).equalsIgnoreCase((" Call Later ").trim())) {
	...
	public void user_607_clear_the_value_in_called_when_field() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper
						.executeScriptWithWebElement(TWAppDataEntryFollowUpDetails.getElement("CalledWhenInputField"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 699) {
		...
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						TWAppDataEntryFollowUpDetails.getElement("ClearButtonInCalledWhenField")).click();
				break;
			} catch (Exception e) {
				if (i == 699) {
					Assert.fail(e.getMessage());
	...
	public void user_607_clicking_on_back_button_system_should_navigate_to_the_previous_screen() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						TWAppDataEntryFollowUpDetails.getElement("BackButtonInFollowUpDetails")).click();
				break;
			} catch (Exception e) {
				if (i == 699) {
					Assert.fail(e.getMessage());
