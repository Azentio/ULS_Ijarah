...
public class TawarahAppDataEntryIncomeDetailsList {
	...
	JSPaths TawaAppDataEntryIncomeDetails = new JSPaths(excelPath, "TawaAppDataEntryIncomeDetails", "FieldName",
			"JSPath");
	...
	ExcelData TawaAppDataEntryIncomeDetailsexelData = new ExcelData(excelTestDataPath, "TawaAppDataEntryIncomeDetails",
			"Data Set ID");
...
//	Map<String, String> TestData = new HashMap<>();
	...
	public void user_607_update_testdata_from_AT_TW_AD_INC_01() {
	...
	public void user_607_click_the_customer_financials_tab() throws Throwable {
		...
		WebElement customerFinancialsTab = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("customerFinancialsTab"));
...
//				customerFinancialsTab.click();
	...
	public void user_607_validate_save_button_available_under_income_details_screen() throws Throwable {
		...
		WebElement incomeSaveBtn = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("incomeSaveBtn"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_back_button_available_under_income_details_screen() throws Throwable {
		WebElement incomeBackBtn = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("incomeBackBtn"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_employment_type_field_available_under_income_details_screen() throws Throwable {
		WebElement employementTypeLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("employementTypeLabel"));
		...
		WebElement employementTypeInput = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("employementTypeInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_lumpsum_amount_field_available_under_income_details_screen() throws Throwable {
		WebElement lumpsumAmtLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("lumpsumAmtLabel"));
		...
		WebElement lumpsumAmtInput = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("lumpsumAmtInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_click_the_pencil_icon_under_customer_financials_tab() throws Throwable {
		Thread.sleep(1000);
		WebElement customerFinancialsPencilEditBtn = javascriptHelper.executeScriptWithWebElement(
				TawaAppDataEntryIncomeDetails.getElement("customerFinancialsPencilEditBtn"));
		for (int i = 0; i <= 2000; i++) {
			try {
				javascriptHelper.backgroundColor(customerFinancialsPencilEditBtn);
				javascriptHelper.executeScriptWithWebElement(
						TawaAppDataEntryIncomeDetails.getElement("customerFinancialsPencilEditBtn")).click();
				break;
			} catch (Exception e) {
				if (i == 2000) {
					Assert.fail(e.getMessage());
	...
	public void user_607_validate_income_field_available_under_income_details_screen() throws Throwable {
		WebElement incomeLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("incomeLabel"));
		...
		WebElement incomeDropdown = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("incomeDropdown"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_frequency_field_available_under_income_details_screen() throws Throwable {
		WebElement frequencyLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("frequencyLabel"));
		...
		WebElement frequencyDropdown = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("frequencyDropdown"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_amount_field_available_under_income_details_screen() throws Throwable {
		WebElement amountLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("amountLabel"));
		...
		WebElement amountInput = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("amountInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_defined_field_available_under_income_details_screen() throws Throwable {
		WebElement defined_Label = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("defined%_Label"));
		...
		WebElement defined_Input = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("defined%_Input"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_adjusted_field_available_under_income_details_screen() throws Throwable {
		WebElement adjusted_Label = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("adjusted%_Label"));
		...
		WebElement adjusted_Input = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("adjusted%_Input"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_amount_considered_field_available_under_income_details_screen() throws Throwable {
		WebElement amountConsideredLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("amountConsideredLabel"));
		...
		WebElement amountConsideredInput = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("amountConsideredInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_action_button_available_under_income_details_screen() throws Throwable {
		WebElement actionLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("actionLabel"));
		...
		WebElement actionAddBtn = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("actionAddBtn"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_total_income_field_available_under_income_details_screen() throws Throwable {
		WebElement totalIncomeLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("totalIncomeLabel"));
		...
		WebElement totalIncomeInput = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("totalIncomeInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_total_income_considered_field_available_under_income_details_screen()
			throws Throwable {
		WebElement totalIncomeConsideredLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("totalIncomeConsideredLabel"));
		...
		WebElement totalIncomeConsideredInput = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("totalIncomeConsideredInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_salary_credited_to_bank_field_available_under_income_details_screen()
			throws Throwable {
		WebElement salaryCreditedToBankLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("salaryCreditedToBankLabel"));
		...
		WebElement salaryCreditedToBankDropdown = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("salaryCreditedToBankDropdown"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_deduction_field_available_under_income_details_screen() throws Throwable {
		WebElement deductionLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionLabel"));
		...
		WebElement deductionDropdown = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionDropdown"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_deduction_frequency_field_available_under_income_details_screen() throws Throwable {
		WebElement deductionFrequencyLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionFrequencyLabel"));
		...
		WebElement deductionFrequencyDropdown = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionFrequencyDropdown"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_deduction_amount_field_available_under_income_details_screen() throws Throwable {
		WebElement deductionAmtLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionAmtLabel"));
		...
		WebElement deductionAmtInput = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionAmtInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_deduction_def_field_available_under_income_details_screen() throws Throwable {
		WebElement deductionDef_Label = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionDef%_Label"));
		...
		WebElement deductionDef_Input = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionDef%_Input"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_deduction_adj_field_available_under_income_details_screen() throws Throwable {
		WebElement deductionAdj_Label = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionAdj%_Label"));
		...
		WebElement deductionAdj_Input = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionAdj%_Input"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_deduction_considered_field_available_under_income_details_screen() throws Throwable {
		WebElement deductionConsideredLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionConsideredLabel"));
		...
		WebElement deductionConsideredInput = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionConsideredInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_deduction_action_button_field_available_under_income_details_screen()
			throws Throwable {
		WebElement deductionActionLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionActionLabel"));
		...
		WebElement deductionActionAddBtn = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionActionAddBtn"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_total_deduction_field_available_under_income_details_screen() throws Throwable {
		WebElement totalDeductionLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("totalDeductionLabel"));
		...
		WebElement totalDeductionInput = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("totalDeductionInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_total_deduction_considered_field_available_under_income_details_screen()
			throws Throwable {
		WebElement totalDeductionConsideredLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("totalDeductionConsideredLabel"));
		...
		WebElement totalDeductionConsideredInput = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("totalDeductionConsideredInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_currency_field_available_under_income_details_screen() throws Throwable {
		WebElement currencyLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("currencyLabel"));
		...
		WebElement currencyDropdown = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("currencyDropdown"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_the_confirmation_message_under_income_details_screen() throws Throwable {
		WebElement successToastMsg = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("successToastMsg"));
		for (int i = 0; i <= 5000; i++) {
			try {
		...
		WebElement successToastCloseBtn = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("successToastCloseBtn"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_click_module_name_in_home_screen() {
		for (int i = 0; i < 500; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("moduleName"))
						.click();
				break;
			} catch (Exception e) {
			}
	...
	public void user_607_select_los_in_the_module_name() {
		for (int i = 0; i < 500; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("selectLOS"))
						.click();
				break;
			} catch (Exception e) {
			}
	...
	public void user_607_click_inbox_in_the_home_page() {
		for (int i = 0; i < 500; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("inbox")).click();
				break;
			} catch (Exception e) {
			}
		}
	...
	public void user_607_Click_search_in_inbox() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper
						.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("clickSearchInInbox"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 699) {
	...
	public void user_607_search_in_the_search_box() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("searchInInbox"))
						.sendKeys("Gowtham", Keys.ENTER);
				break;
			} catch (Exception e) {
				if (i == 699) {
					Assert.fail(e.getMessage());
	...
	public void user_607_search_in_the_search_Field() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("searchInInbox"))
						.sendKeys(testData.get("Search Record"), Keys.ENTER);
				break;
			} catch (Exception e) {
				if (i == 699) {
					Assert.fail(e.getMessage());
	...
	public void user_607_select_record_after_search() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("selectRecord"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 699) {
	...
	public void user_607_click_customer_finacials_in_the_record() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper
						.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("CustomerFinacials"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 699) {
	...
	public void user_607_click_add_button_in_income() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper
						.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("AddButtonInIncome"))
						.click();
				break;
			} catch (Exception e) {
	...
	public void user_607_check_employment_type_field() throws Throwable {
		Thread.sleep(7000);
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Employment Type"))
				.isDisplayed()) {
	...
	public void user_607_check_save_button() {
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("saveButton"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_lumpsum_amount_field() {
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Lumpsum Amount"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_financial_year() {
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Financial Year"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_filing_date() {
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Filing Date"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_income_field() {
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Income"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_frequency_field() {
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Frequency"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_amount_field() {
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Amount"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_defined_field() {
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Defined"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_adjusted_field() {
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Adjusted"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_amount_considered_field() {
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Amount Considered"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_action_field() {
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Action"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_total_income_field() {
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Total Income"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_total_income_considered_field() {
		if (!javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Total Income Considered"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_salary_credited_to_bank_field() {
		if (!javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Salary Credited To Bank"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_deduction_field() {
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Deduction"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_deduction_amt_field() {
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Deduction Amt"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_deduction_def_field() {
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Deduction Def"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_deduction_adj_field() {
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Deduction Adj"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_deduction_considered_field() {
		if (!javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Deduction Considered"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_total_deduction_field() {
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Total Deduction"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_total_deduction_considered_field() {
		if (!javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Total Deduction Considered"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_check_currency_field() {
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Currency"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_select_days_in_frequency() {
		...
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("FrequencyInput"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 699) {
		...
		for (int j = 0; j <= premitiveDropdownLength; j++) {
			...
			if ((dropdownString.trim()).equalsIgnoreCase((testData.get("FrequencyInput")).trim())) {
	...
	public void user_607_click_save_button() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("saveButton"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 699) {
	...
	public void user_607_check_record_save_successfully() {
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("SucessSavePopup"))
				.isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_607_click_back_button() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Backbutton"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 699) {
	...
	public void user_607_check_go_to_previous_page() throws Throwable {
		Thread.sleep(5000);
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("AddButtonInIncome"))
				.isDisplayed()) {
			Assert.fail();
		}
	}
	...
	public void user_607_check_value_auto_populated() {
		String text = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("Employment Type")).getText();
	...
	public void user_607_check_clicking_on_back_button_system_should_navigate_to_the_previous_screen() {
		if (!javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("selectRecord"))
				.isDisplayed()) {
			Assert.fail();
		}
	}
...
//	@AT_MU_INC_01
	...
	public void user_607_validate_pension_amount_field_available_under_income_details_screen() throws Throwable {
		WebElement pensionAmtLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("pensionAmtLabel"));
		...
		WebElement pensionAmtInput = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("pensionAmtInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_select_the_salary_credited_to_bank_value_under_income_details_screen() throws Throwable {
		for (int i = 0; i <= 2000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						TawaAppDataEntryIncomeDetails.getElement("salaryCreditedToBankDropdown")).click();
				break;
			} catch (Exception e) {
				if (i == 2000) {
					Assert.fail(e.getMessage());
	...
	public void user_607_validate_bank_name_field_available_under_income_details_screen() throws Throwable {
		WebElement bankNameLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("bankNameLabel"));
		WebElement bankNameDropdown = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("bankNameDropdown"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_607_validate_branch_name_field_available_under_income_details_screen() throws Throwable {
		WebElement branchNameLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("branchNameLabel"));
		WebElement branchNameDropdown = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("branchNameDropdown"));
		for (int i = 0; i <= 2000; i++) {
			try {
...
//	AT_MU_INC_02
	...
	public void user_607_select_the_income_option_under_income_screen_in_customer_financials_tab() throws Throwable {
		for (int i = 0; i <= 2000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("incomeDropdown"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 2000) {
	...
	public void user_607_select_the_deduction_frequency_option_under_income_screen_in_customer_financials_tab()
			throws Throwable {
		for (int i = 0; i <= 2000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						TawaAppDataEntryIncomeDetails.getElement("deductionFrequencyDropdown")).click();
				break;
			} catch (Exception e) {
				if (i == 2000) {
					Assert.fail(e.getMessage());
	...
	public void user_607_enter_the_deduction_adjusted_under_income_screen_in_customer_financials_tab()
			throws Throwable {
		for (int i = 0; i < 1000; i++) {
			try {
				javascriptHelper
...
//	@AT_MU_INC_03
	...
	public void user_607_verify_income_field_should_be_mandatory_lov_and_allow_to_user_select_any_value_from_lov()
			throws Throwable {
		WebElement incomeLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("incomeLabel"));
		WebElement incomeDropdown = javascriptHelper
...
//		Select the LOV Value
	...
	public void user_607_verify_frequency_field_should_be_mandatory_lov_and_allow_to_user_select_any_value_from_lov()
			throws Throwable {
		WebElement frequencyLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("frequencyLabel"));
		WebElement frequencyDropdown = javascriptHelper
...
//		Select the LOV Value
	...
	public void user_607_verify_income_amount_field_should_be_mandatory_textbox_and_allow_to_user_enter_numeric_value_manualy()
			throws Throwable {
		WebElement amountLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("amountLabel"));
		WebElement amountInput = javascriptHelper
...
//	    Allow to user enter the numeric value
	...
	public void user_607_verify_defined_field_should_be_non_mandatory_textbox_and_allow_to_user_enter_numeric_value_manualy()
			throws Throwable {
		WebElement defined_Label = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("defined%_Label"));
		WebElement defined_Input = javascriptHelper
	...
	public void user_607_verify_adjusted_field_should_be_non_mandatory_textbox_and_allow_to_user_enter_numeric_value_manualy()
			throws Throwable {
		WebElement adjusted_Label = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("adjusted%_Label"));
		WebElement adjusted_Input = javascriptHelper
...
//	    Allow to user enter the numeric value
	...
	public void user_607_verify_amount_considered_field_should_be_auto_populated_in_post_entering_adjusted_value()
			throws Throwable {
		String incomeValue = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("amountInput"))
				.getAttribute("ng-reflect-model");
		String definedValue = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("defined%_Input"))
				.getAttribute("ng-reflect-model");
		String adjustedValue = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("adjusted%_Input"))
				.getAttribute("ng-reflect-model");
		String amountConsideredValue = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("amountConsideredInput"))
				.getAttribute("ng-reflect-model");
	...
	public void user_607_verify_total_income_value_should_get_auto_populated_post_entering_the_amount()
			throws Throwable {
		String incomeValue = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("amountInput"))
				.getAttribute("ng-reflect-model");
	...
	public void user_607_verify_total_income_considered_value_should_get_auto_populate_post_entering_the_value_in_adjusted_field()
			throws Throwable {
		String amountConsideredValue = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("amountConsideredInput"))
				.getAttribute("ng-reflect-model");
	...
	public void user_607_verify_salary_credited_to_bank_field_should_be_non_mandatory_and_dropdown() throws Throwable {
		...
		for (int i = 0; i <= 2000; i++) {
			try {
				...
				javascriptHelper.backgroundBorder(salaryCreditedToBankDropdown);
				Assert.assertTrue(
						salaryCreditedToBankDropdown.getAttribute("ng-reflect-placeholder").contains("Select"));
				break;
			} catch (Exception e) {
				if (i == 2000) {
					Assert.fail(e.getMessage());
	...
	public void user_607_verify_deduction_field_should_be_non_mandatory_lov_and_allow_to_user_select_any_value_from_lov()
			throws Throwable {
		WebElement deductionLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionLabel"));
		WebElement deductionDropdown = javascriptHelper
...
//		Select the LOV Value
	...
	public void user_607_verify_deduction_amount_field_should_be_non_mandatory_textbox_and_allow_to_user_enter_numeric_value_manualy()
			throws Throwable {
		WebElement deductionAmtLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionAmtLabel"));
		WebElement deductionAmtInput = javascriptHelper
...
//				e.printStackTrace();
	...
	public void user_607_verify_deduction_defined_field_should_be_non_mandatory_textbox_and_allow_to_user_enter_numeric_value_manualy()
			throws Throwable {
		WebElement defined_Label = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionDef%_Label"));
		WebElement defined_Input = javascriptHelper
	...
	public void user_607_verify_deduction_adjusted_field_should_be_non_mandatory_textbox_and_allow_to_user_enter_numeric_value_manualy()
			throws Throwable {
		WebElement adjusted_Label = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionAdj%_Label"));
		WebElement adjusted_Input = javascriptHelper
...
//	    Allow to user enter the numeric value
	...
	public void user_607_verify_deduction_considered_field_should_be_auto_populated_in_post_entering_deduction_adj_value()
			throws Throwable {
		String deductionAmt = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionAmtInput"))
				.getAttribute("ng-reflect-model");
		String definedValue = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionDef%_Input"))
	...
	public void user_607_verify_total_deduction_value_should_get_auto_populated_post_entering_the_deduction_amount()
			throws Throwable {
		String deductionAmt = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionAmtInput"))
				.getAttribute("ng-reflect-model");
		...
		WebElement totalDeduction = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("totalDeductionInput"));
	...
	public void user_607_verify_deduction_considered_value_should_get_auto_populate_post_entering_the_value_in_deduction_adj_field()
			throws Throwable {
		String deductionConsidered = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("deductionConsideredInput"))
				.getAttribute("ng-reflect-model");
		int a = Integer.parseInt(deductionConsidered) / 12;
		String sp = Integer.toString(a).split("\\.")[0];
		WebElement totalDeductionConsidered = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("totalDeductionConsideredInput"));
	...
	public void user_607_verify_bank_name_field_should_be_non_mandatory_lov_and_allow_to_user_select_any_value_from_lov()
			throws Throwable {
		WebElement bankNameLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("bankNameLabel"));
		WebElement bankNameDropdown = javascriptHelper
...
//		Select the LOV Value
	...
	public void user_607_verify_branch_name_field_should_be_non_mandatory_lov_and_allow_to_user_select_any_value_from_lov()
			throws Throwable {
		WebElement branchNameLabel = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("branchNameLabel"));
		WebElement branchNameDropdown = javascriptHelper
...
//		Select the LOV Value
	...
	public void user_607_click_add_row_button_system_should_add_a_row_under_income_screen() throws Throwable {
		for (int i = 0; i <= 1000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("actionAddBtn"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 1000) {
	...
	public void user_607_click_delete_row_button_system_should_delete_a_row_under_income_screen() throws Throwable {
		for (int i = 0; i <= 1000; i++) {
			try {
				javascriptHelper
						.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("actionDeleteBtn"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 1000) {
...
//	AT_MU_INC_04
	...
	public void user_607_click_the_save_button_with_mandatory_field_blank_under_income_details_screen()
			throws Throwable {
		WebElement incomeSaveBtn = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("incomeSaveBtn"));
		for (int i = 0; i <= 5000; i++) {
	...
	public void user_607_verify_validation_message_for_mandatory_field_as_blank_under_income_details_screen()
			throws Throwable {
		Thread.sleep(1000);
		WebElement successToastMsg = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("successToastMsg"));
...
//	AT_MU_INC_05
	...
	public void user_607_verify_system_allow_user_to_modify_lumpsum_amount_under_income_details_screen()
			throws Throwable {
		for (int i = 0; i < 1000; i++) {
			try {
				javascriptHelper
	...
	public void user_607_verify_system_allow_user_to_modify_pension_amount_under_income_details_screen()
			throws Throwable {
		for (int i = 0; i < 1000; i++) {
			try {
				javascriptHelper
	...
	public void user_607_verify_system_allow_user_to_modify_income_amount_under_income_details_screen()
			throws Throwable {
		for (int i = 0; i < 1000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("amountInput"))
	...
	public void user_607_verify_while_modification_system_allow_user_to_save_the_record_with_valid_data()
			throws Throwable {
		WebElement incomeSaveBtn = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("incomeSaveBtn"));
		for (int i = 0; i <= 5000; i++) {
	...
	public void user_607_post_clicking_on_save_button_system_should_display_the_confirmation_message_as_success()
			throws Throwable {
		Thread.sleep(1000);
		WebElement successToastMsg = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("successToastMsg"));
	...
	public void user_607_again_click_the_pencil_button_under_income_section_in_customer_financials_tab()
			throws Throwable {
		Thread.sleep(1000);
		String listOfAddButtonQuery = "document.querySelectorAll('ion-title[class=\"pl-2 pr-2 ion-color ion-color-dark md title-default hydrated\"]').length";
		String listOfAddButton = "";
	...
	public void user_607_verify_while_modification_when_user_keep_any_mandatory_field_blank_and_click_on_save_button()
			throws Throwable {
		for (int i = 0; i < 1000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("amountInput"))
						.sendKeys(Keys.chord(Keys.CONTROL, "a", Keys.DELETE));
				javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("incomeSaveBtn"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 1000) {
	...
	public void user_607_system_should_not_allow_user_to_do_a_modification_with_invalid_data_under_income_details_screen()
			throws Throwable {
		for (int i = 0; i < 1000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("incomeSaveBtn"))
...
//	AT_MU_INC_06
	...
	public void user_607_verify_the_back_button_available_in_income_list_view_under_customer_financials_tab()
			throws Throwable {
		WebElement backBtn = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("customerFinancialsTabBackBtn"));
		for (int i = 0; i <= 1000; i++) {
			try {
	...
	public void user_607_verify_add_button_available_under_income_section_list_view_in_customer_financials_tab()
			throws Throwable {
		String listOfAddButtonQuery = "document.querySelectorAll('ion-title[class=\"pl-2 pr-2 ion-color ion-color-dark md title-default hydrated\"]').length";
		String listOfAddButton = "";
		String addButtonScreenName = "";
	...
	public void user_607_verify_nature_of_employement_field_available_under_income_section_list_view_in_customer_financials_tab()
			throws Throwable {
		WebElement natureOfEmployment = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("listview_NatureOfEmployment"));
		for (int i = 0; i <= 1000; i++) {
			try {
	...
	public void user_607_verify_net_income_field_available_under_income_section_list_view_in_customer_financials_tab()
			throws Throwable {
		WebElement netIncome = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("listview_NetIncome"));
		for (int i = 0; i <= 1000; i++) {
			try {
	...
	public void user_607_verify_net_deduction_field_available_under_income_section_list_view_in_customer_financials_tab()
			throws Throwable {
		WebElement netDeduction = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("listview_NetDeduction"));
		for (int i = 0; i <= 1000; i++) {
			try {
	...
	public void user_607_verify_considered_income_field_available_under_income_section_list_view_in_customer_financials_tab()
			throws Throwable {
		WebElement consideredIncome = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("listview_ConsideredIncome"));
		for (int i = 0; i <= 1000; i++) {
			try {
	...
	public void user_607_verify_currency_field_available_under_income_section_list_view_in_customer_financials_tab()
			throws Throwable {
		WebElement currency = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("listview_Currency"));
		for (int i = 0; i <= 1000; i++) {
			try {
	...
	public void user_607_verify_status_field_available_under_income_section_list_view_in_customer_financials_tab()
			throws Throwable {
		WebElement status = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("listview_Status"));
		for (int i = 0; i <= 1000; i++) {
			try {
	...
	public void user_607_verify_on_clicks_of_list_view_record_details_should_be_populated_in_the_fields_under_income_screen()
			throws Throwable {
		String listOfAddButtonQuery = "document.querySelectorAll('ion-title[class=\"pl-2 pr-2 ion-color ion-color-dark md title-default hydrated\"]').length";
		String listOfAddButton = "";
		String addButtonScreenName = "";
				...
				try {
					...
					if (!(addButtonScreenName.isEmpty())) {
						...
						if ((addButtonScreenName.trim()).equalsIgnoreCase(("Income").trim())) {
							...
							javascriptHelper.backgroundColor(javascriptHelper.executeScriptWithWebElement(
									"document.querySelectorAll('button[icon=\"pi pi-plus\"]')[" + j
											+ "].parentElement.parentElement.parentElement.nextElementSibling.querySelector(\'table tbody tr td button[icon=\"pi pi-eye\"]')"));
							javascriptHelper.executeScriptWithWebElement(
									"document.querySelectorAll('button[icon=\"pi pi-plus\"]')[" + j
											+ "].parentElement.parentElement.parentElement.nextElementSibling.querySelector('table tbody tr td button[icon=\"pi pi-eye\"]')")
									.click();
	...
	public void user_607_verify_the_functionality_of_add_button_under_income_section_in_customer_financials_tab()
			throws Throwable {
		String listOfAddButtonQuery = "document.querySelectorAll('ion-title[class=\"pl-2 pr-2 ion-color ion-color-dark md title-default hydrated\"]').length";
		String listOfAddButton = "";
		String addButtonScreenName = "";
	...
	public void user_607_post_clicking_on_add_button_system_should_navigate_to_new_income_details_screen()
			throws Throwable {
		WebElement incomeScreenTitle = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("incomeScreenTitle"));
...
//	AT_MU_INC_07
	...
	public void user_607_verify_the_functionality_of_search_box_with_matching_data_in_income_section()
			throws Throwable {
		for (int i = 0; i <= 2000; i++) {
			try {
				javascriptHelper
						.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("incomeSectionSearchbox"))
	...
	public void user_607_verify_entering_any_matching_value_system_should_display_all_the_possible_matching_records_under_income_section()
			throws Throwable {
		WebElement searchResult = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("searchResult"));
		for (int i = 0; i <= 500; i++) {
			try {
	...
	public void user_607_verify_the_functionality_of_search_box_with_mismatch_data_in_income_section()
			throws Throwable {
	...
	public void user_607_verify_system_should_not_display_any_records_or_system_should_display_the_message_as_no_data_found_under_income_section()
			throws Throwable {
		Thread.sleep(1000);
		WebElement searchResult = javascriptHelper
				.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("searchResult"));
...
//	AT_MU_INC_08
						...
						if ((addButtonScreenName.trim()).equalsIgnoreCase(("Income").trim())) {
							...
							javascriptHelper.scrollIntoView(javascriptHelper.executeScriptWithWebElement(
									"document.querySelectorAll('ion-title[class=\"pl-2 pr-2 ion-color ion-color-dark md title-default hydrated\"]')["
											+ j + "]"));
							javascriptHelper.executeScriptWithWebElement(
									"document.querySelectorAll('p-dropdown[placeholder=\"Export\"]')[" + j + "]")
									.click();
							isAddButtonClicked = true;
							break;
						}
	...
	public void user_607_post_clicking_on_export_to_pdf_button_system_should_download_the_pdf_file_of_that_records()
			throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("exportPDF"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 300) {
...
//		IncomeFormDataFile
	...
	public void user_607_verify_the_functionality_of_export_to_excel_button() throws Throwable {
		...
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("exportXLS"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 300) {
	...
	public void user_607_post_clicking_on_export_to_excel_button_system_should_download_the_excel_file_of_that_records()
			throws Throwable {
		String homePath = System.getProperty("user.home");
		String filePath = homePath + "/Downloads";
		File file = new File(filePath);
	...
	public void user_607_to_verify_the_functionality_of_back_button_under_customer_financials_tab() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.scrollIntoView(javascriptHelper.executeScriptWithWebElement(
						TawaAppDataEntryIncomeDetails.getElement("customerFinancialsTabBackBtn")));
				javascriptHelper.executeScriptWithWebElement(
						TawaAppDataEntryIncomeDetails.getElement("customerFinancialsTabBackBtn")).click();
				break;
			} catch (Exception e) {
				if (i == 300) {
					Assert.fail(e.getMessage());
	...
	public void user_607_post_clicking_on_back_button_under_customer_inanacials_tab_system_should_navigate_to_the_previous_screen()
			throws Throwable {
		for (int i = 0; i <= 3000; i++) {
			try {
				javascriptHelper.backgroundBorder(javascriptHelper
						.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("customerInfoTitle")));
				javascriptHelper
						.executeScriptWithWebElement(TawaAppDataEntryIncomeDetails.getElement("customerInfoTitle"))
						.isDisplayed();
				break;
