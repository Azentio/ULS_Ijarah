...
public class PersonalLoan_Step {
	...
	JSPaths PL_NewApp_CustomerDetails = new JSPaths(excelPath, "PL_NewApp_CustomerDetails_610", "PL_NewApp_CustomerDetails_FieldName", "JSPath");
	...
	public void user_610_verify_the_customer_type_field()throws Throwable{
		...
		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("customerType")).isDisplayed()) {
	...
	public void user_610_verify_the_cif_id_field()throws Throwable{
		...
		for (int i = 0; i < 3000; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("CifID")).isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
			} catch (Exception e) {
		...
		for (int i = 0; i < 600; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.
						getElement("CifIDText")).sendKeys(testData.get("Cif Id"));
				break;
				} catch (Exception e) {
				if (i==599) {
					Assert.fail(e.getMessage());
	...
	public void user_610_to_select_customer_type_as_individual_type()throws Throwable{
		for (int i = 0; i < 600; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("customerTypeDropdown")).click();
				break;
				} catch (Exception e) {
				if (i==599) {
					Assert.fail(e.getMessage());
...
//					.equalsIgnoreCase(testData.get("Customer Type").trim())) {
	...
	public void user_610_verify_the_application_number_field()throws Throwable{
		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("ApplicationNumber")).isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
			} catch (Exception e) {
		...
		for (int i = 0; i < 600; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("ApplicationNumberTex")).
	...
	public void user_610_verify_the_customer_name_field()throws Throwable{
		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("CustomerNameDropdown")).isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
			} catch (Exception e) {
	...
	public void user_610_verify_the_id_type_field()throws Throwable{
		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("IDType")).isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
			} catch (Exception e) {
		...
		for (int i = 0; i < 600; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("IDTypeDropdown")).click();
				break;
				} catch (Exception e) {
				if (i==599) {
					Assert.fail(e.getMessage());
...
//					.equalsIgnoreCase(testData.get("Customer Type").trim())) {
	...
	public void user_610_verify_the_id_number_field()throws Throwable{
		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("IDNumber")).isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
			} catch (Exception e) {
	...
	public void user_610_verify_the_mobile_number_field()throws Throwable{
		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("MobileNumber")).isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
			} catch (Exception e) {
		...
		for (int i = 0; i < 600; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("MobileNumberTex")).
	...
	public void user_610_verify_the_date_of_birth_field()throws Throwable{
		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("DOB")).isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
			} catch (Exception e) {
	...
	public void user_610_verify_the_email_field()throws Throwable{
		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("EmailID")).isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
			} catch (Exception e) {
	...
	public void user_610_verify_the_search_field()throws Throwable{
		...
		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("search")).isDisplayed()) {
	...
	public void user_610_verify_the_clear_field()throws Throwable{
		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("clear")).isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
			} catch (Exception e) {
	...
	public void user_610_verify_the_create_new_reqest_field()throws Throwable{
		for (int i = 0; i < 300; i++) {
			try {
				if (javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("customerTypeDropdown")).isDisplayed()) {
					Assert.assertTrue(true);
					break;
				}
			} catch (Exception e) {
	...
	// -----------------select format 
		...
		String customertypeFormat = javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("customerTypeDropdown"))
	...
	public void user_610_verify_the_field_cif_id_editable_numberic_text() {
		// -----------------select format 
				...
				String CifIdFormat = javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("CifIDTextBox"))
						.getAttribute("type");
	...
	public void user_610_verify_the_field_id_type_select() {
		...
		// -----------------select format 
				...
				String IdTypeFormat = javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("IDTypeSelect"))
						.getAttribute("ng-reflect-placeholder");
	...
	public void user_610_verify_the_field_id_number_text_editable() {
		// -----------------text format 
				...
				String IdNumberFormat = javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("IDNumberText"))
						.getAttribute("type");
	...
	public void user_610_verify_the_field_customer_name_editable_text() {
		//---------field should be editable
				...
				String CustomerNameFormat = javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("CustomerNameDropdown"))
						.getAttribute("type");
	...
	public void user_610_verify_the_field_mobile_number_non_mandatory_text_editable() {
		//---------field should be editable
				...
				String MobileNumberTextFormat = javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("IDNumberText"))
						.getAttribute("type");
	...
	public void user_610_verify_the_field_data_of_birth_non_mandatory_date_editable() {
				...
				String DOBInputFormat = javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("DOBCalendar"))
						.getTagName();
	...
	public void user_610_verify_the_field_email_non_mandatory_editable() {
		//---------field should be editable
				...
				String EmailIDText = javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("EmailIDText"))
						.getAttribute("type");
	...
	public void user_610_verify_the_functionality_of_create_new_request_button() throws Throwable {
		Thread.sleep(500);
		WebElement createNewReq = javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("CreateNewRequest"));

		for (int i = 0; i < 2000; i++) {
			try {
			//	javascriptHelper.executeScriptWithWebElement(PL_NewApp_CustomerDetails.getElement("CreateNewRequest")).click();
