...
public class AutoLoan_Offering_CustomerDetails_Step {
	
	String excelPath = System.getProperty("user.dir") + "\\TestData\\IjaraJSPaths.xlsx";
	String excelTestDataPath = System.getProperty("user.dir") + "\\TestData\\ijaraTestData.xlsx";
	WebDriver driver = BaseClass.driver;
	JSPaths jsPaths = new JSPaths(excelPath, "Ijara_loginElements", "Ijara_LoginFieldName", "JSPath");
	//JSPaths customerdetailsJsPaths = new JSPaths(excelPath, "RepaymentMode_Elements", "RepaymentMode_FieldName", "JSPath");
	JSPaths underWriterJsPaths = new JSPaths(excelPath, "Underwriter_Elements", "Underwriter_FieldName", "JSPath");
	JSPaths customerdetailsJsPaths = new JSPaths(excelPath, "AutoLoan_CustomerDetails", "CustomerDetailsElements", "JSPath");
    ...
    public void get_the_test_data_for_test_case_AT_AL_OFF_CD_07() throws Throwable {
		testData = customerdetailsExcelData.getTestdata("AT_AL_OFF_CD_07_D1");
    }
    ...
    public void get_the_test_data_for_test_case_AT_AL_OFF_CD_08() throws Throwable {
		testData = customerdetailsExcelData.getTestdata("AT_AL_OFF_CD_08_D1");
    }
    ...
    public void get_the_test_data_for_test_case_AT_AL_OFF_CD_09() throws Throwable {
		testData = customerdetailsExcelData.getTestdata("AT_AL_OFF_CD_09_D1");
    }
    ...
    public void get_the_test_data_for_test_case_AT_AL_OFF_CD_10() throws Throwable {
		testData = customerdetailsExcelData.getTestdata("AT_AL_OFF_CD_10_D1");
    }
	...
	public void click_on_eye_icon_of_existing_record_in_auto_loan_offering_customer_details() {
		for (int i = 0; i <= 1000; i++) {
			try {
				javascriptHelper.JSEClick(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("EyeIconInViewlist")));
				break;
			} catch (Exception e) { 
				if (i == 1000) {
					Assert.fail(e.getMessage());
	...
	public void validate_that_relationship_field_is_present_in_customer_details() throws IOException {
		javascriptHelper.scrollIntoView(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("relationShip")));
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("relationShip")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("relationShip")).isDisplayed());
	...
	public void validate_that_existing_bank_relationship_field_is_present_in_customer_details() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("ExistingBankRelationship")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("ExistingBankRelationship")).isDisplayed());
	...
	public void validate_that_blacklisted_field_is_present_in_customer_details() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("blacklisted")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("blacklisted")).isDisplayed());
	...
	public void validate_that_politically_exposed_field_is_present_in_customer_details() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("politicallyExposed")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("politicallyExposed")).isDisplayed());
	...
	public void validate_that_remarks_field_is_present_in_customer_details() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("remarkData")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("remarkData")).isDisplayed());
	...
	public void validate_that_phone_number_field_is_present_in_customer_details() throws IOException {
		javascriptHelper.scrollIntoView(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("PhoneNumber")));
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("PhoneNumber")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("PhoneNumber")).isDisplayed());
	...
	public void validate_that_mobile_number_primary_field_is_present_in_customer_details() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("MobileNumberprimary")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("MobileNumberprimary")).isDisplayed());
	...
	public void validate_that_mobile_number_secondary_field_is_present_in_customer_details() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("MobileNumbersecondary")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("MobileNumbersecondary")).isDisplayed());
	...
	public void validate_that_email_field_is_present_in_customer_details() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("Email")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("Email")).isDisplayed());
	...
	public void validate_that_prefered_customer_method_field_is_present_in_customer_details() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("PreferedContactMethod")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("PreferedContactMethod")).isDisplayed());
	...
	public void validate_that_prefered_time_for_customer_field_is_present_in_customer_details() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("PreferedTimeForContact")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("PreferedTimeForContact")).isDisplayed());
	...
	public void validate_the_cif_id_field_is_present_in_customer_details_view_list() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("CIFID_ViewList")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("CIFID_ViewList")).isDisplayed());
	...
	public void validate_the_first_name_field_is_present_in_customer_details_view_list() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("FirstNameViewList")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("FirstNameViewList")).isDisplayed());
	...
	public void validate_the_middle_name_field_is_present_in_customer_details_view_list() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("MiddleNameViewList")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("MiddleNameViewList")).isDisplayed());
	...
	public void validate_the_last_name_field_is_present_in_customer_details_view_list() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("LastNameViewList")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("LastNameViewList")).isDisplayed());
	...
	public void validate_the_customer_type_field_is_present_in_customer_details_view_list() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("CustomerTypeViewList")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("CustomerTypeViewList")).isDisplayed());
	...
	public void validate_the_applicant_type_field_is_present_in_customer_details_view_list() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("ApplicantTypeViewList")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("ApplicantTypeViewList")).isDisplayed());
	...
	public void validate_the_customer_rating_field_is_present_in_customer_details_view_list() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("CustomerRatingViewList")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("CustomerRatingViewList")).isDisplayed());
	...
	public void validate_the_status_field_is_present_in_customer_details_view_list() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("StatusViewList")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("StatusViewList")).isDisplayed());
...
//				.sendKeys("USD");
	...
	public void validate_the_export_to_pdf_functionality_in_autoloan_offering_customer_details() throws IOException {
		...
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("ExportPDF")));
		for (int i = 0; i <= 300; i++) {
			try {
	...
	public void user_search_the_ref_id_under_inbox_for_auto_loan_offering_customer_details() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerdetailsJsPaths.getElement("inboxSearchInput")));
		for (int i = 0; i <= 500; i++) {
			try {
