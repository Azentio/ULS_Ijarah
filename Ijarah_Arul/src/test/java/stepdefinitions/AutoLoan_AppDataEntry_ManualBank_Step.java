...
public class AutoLoan_AppDataEntry_ManualBank_Step {
	...
	public void get_the_test_data_for_test_case_AT_AL_MB_01() throws Throwable {
		testData = manualbankExcelData.getTestdata("AT_AL_MB_01_D1");
	}
	...
	public void get_the_test_data_for_test_case_AT_AL_MB_02() throws Throwable {
		testData = manualbankExcelData.getTestdata("AT_AL_MB_02_D1");
	}
	...
	public void get_the_test_data_for_test_case_AT_AL_MB_03() throws Throwable {
		testData = manualbankExcelData.getTestdata("AT_AL_MB_03_D1");
	}
	...
	public void get_the_test_data_for_test_case_AT_AL_MB_04() throws Throwable {
		testData = manualbankExcelData.getTestdata("AT_AL_MB_04_D1");
	}
	...
	public void get_the_test_data_for_test_case_AT_AL_MB_05() throws Throwable {
		testData = manualbankExcelData.getTestdata("AT_AL_MB_05_D1");
	}
	...
	public void get_the_test_data_for_test_case_AT_AL_MB_06() throws Throwable {
		testData = manualbankExcelData.getTestdata("AT_AL_MB_06_D1");
	}
	...
	public void get_the_test_data_for_test_case_AT_AL_MB_07() throws Throwable {
		testData = manualbankExcelData.getTestdata("AT_AL_MB_07_D1");
	}
	...
	public void user_074_search_the_ref_id_under_inbox_for_autoloan_manual_bank() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(manualbankJsPaths.getElement("inboxSearchInput")));
		for (int i = 0; i <= 500; i++) {
			try {
	...
	public void navigate_to_manual_bank_tab_in_autoloan_manual_bank() {
		...
		for (int i = 0; i <= 1000; i++) {
			try {
				javascriptHelper.JSEClick(javascriptHelper.executeScriptWithWebElement(manualbankJsPaths.getElement("ManualBankTab")));
				break;
			} catch (Exception e) { 
				if (i == 1000) {
					Assert.fail(e.getMessage());
	...
	public void validate_that_customer_name_field_is_displayed_in_autoloan_manual_bank_view_list() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(manualbankJsPaths.getElement("CustomerName_ViewList")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(manualbankJsPaths.getElement("CustomerName_ViewList")).isDisplayed());
	...
	public void validate_that_account_number_field_is_displayed_in_autoloan_manual_bank_view_list() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(manualbankJsPaths.getElement("AccountNumber_ViewList")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(manualbankJsPaths.getElement("AccountNumber_ViewList")).isDisplayed());
	...
	public void validate_that_bank_code_field_is_displayed_in_autoloan_manual_bank_view_list() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(manualbankJsPaths.getElement("BankCode_ViewList")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(manualbankJsPaths.getElement("BankCode_ViewList")).isDisplayed());
	...
	public void validate_that_branch_code_field_is_displayed_in_autoloan_manual_bank_view_list() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(manualbankJsPaths.getElement("BranchCode_ViewList")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(manualbankJsPaths.getElement("BranchCode_ViewList")).isDisplayed());
...
//				.sendKeys("USD");
	...
	public void validate_the_export_to_pdf_functionality_in_auto_loan_manual_bank() throws IOException {
		...
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(manualbankJsPaths.getElement("ExportPDF")));
		for (int i = 0; i <= 300; i++) {
			try {
	...
	public void validate_field_is_required_popup_is_displayed_in_autoloan_manual_bank() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(manualbankJsPaths.getElement("requiredFieldError")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(manualbankJsPaths.getElement("requiredFieldError")).isDisplayed());
	...
	public void validate_alphanumeric_characters_allowed_popup_is_displayed_in_autoloan_manual_bank() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(manualbankJsPaths.getElement("specialCharError")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(manualbankJsPaths.getElement("specialCharError")).isDisplayed());
	...
	public void validate_view_summary_functionality_in_autoloan_manual_bank() throws IOException {
		...
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(manualbankJsPaths.getElement("TransactionSummaryPage")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(manualbankJsPaths.getElement("TransactionSummaryPage")).isDisplayed());
