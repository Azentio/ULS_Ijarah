...
public class Ijara_DocumentDetails_Step {
	...
	public void select_the_value_in_document_reference_number_field() {
		...
		for (int i = 0; i <= 500; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("toastMsgCloseBtn")).click();				
				break;
			} catch (Exception e) {
	...
	public void user_search_the_ref_id_under_inbox_for_document_details() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("inboxSearchInput")));
		for (int i = 0; i <= 500; i++) {
			try {
	...
	public void validate_that_existing_records_are_present_in_document_details_view_list() throws IOException {
		for (int i = 0; i <= 1000; i++) {
			try {
				waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("EditIcon")));
				Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("EditIcon")).isDisplayed());
				break;
			} catch (Exception e) { 
				if (i == 1000) {
					Assert.fail(e.getMessage());
	...
	public void validate_the_help_button_is_present_in_document_details_page() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("HelpButton")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("HelpButton")).isDisplayed());
	...
	public void click_on_back_icon_in_document_section_section() {
		for (int i = 0; i <= 1000; i++) {
			try {
				javascriptHelper.JSEClick(javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("BackButton")));
				//javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("SaveIcon")).click();
				break;
			} catch (Exception e) { 
				if (i == 1000) {
	...
	public void click_on_pencil_icon_of_existing_record() {
		for (int i = 0; i <= 1000; i++) {
			try {
				javascriptHelper.JSEClick(javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("EditIcon")));
				//javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("SaveIcon")).click();
				break;
			} catch (Exception e) { 
				if (i == 1000) {
	...
	public void validate_that_upload_button_is_displayed_in_document_details() throws IOException {
		javascriptHelper.scrollIntoView(javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("FileUploadButton")));
		for (int i = 0; i <= 1000; i++) {
			try {
				waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("FileUploadButton")));
				Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("FileUploadButton")).isDisplayed());
				break;
			} catch (Exception e) { 
				if (i == 1000) {
					Assert.fail(e.getMessage());
	...
	public void validate_that_view_document_button_is_present_in_document_details() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("ViewDocumentButton")));
		Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("ViewDocumentButton")).isDisplayed());
	...
	public void validate_the_fields_are_present_in_document_details_view_list() throws IOException {
		for (int i = 0; i <= 1000; i++) {
			try {
				waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("DocumentNameField")));
				Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("DocumentNameField")).isDisplayed());
				waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("RequiredAtStageField")));
				Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("RequiredAtStageField")).isDisplayed());
				waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("DocumentStatusField")));
				Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("DocumentStatusField")).isDisplayed());
				break;
			} catch (Exception e) { 
				if (i == 1000) {
					Assert.fail(e.getMessage());
...
//				.sendKeys("USD");
	...
	public void validate_the_export_to_excel_functionality_of_document_details() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(documentdetailsJsPaths.getElement("ExportXLS")));
		for (int i = 0; i <= 300; i++) {
			try {
