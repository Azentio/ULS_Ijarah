...
public class Ijarah_CustomerReference_Step {
	...
	JSPaths customerreferenceJsPaths = new JSPaths(excelPath, "CustomerReference", "CustomerReference_FieldName", "JSPath");
	...
	public void click_on_pencil_icon_in_customer_personal_information() {
		for (int i = 0; i <= 1000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(customerreferenceJsPaths.getElement("additionalCustInfoTabPencilIconBtn")).click();
				break;
			} catch (Exception e) { 
				if (i == 1000) {
	...
	public void update_status_to_inactive_in_customer_reference_page() {
		for (int i = 0; i <= 1000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(customerreferenceJsPaths.getElement("ActiveInactie")).click();
				break;
			} catch (Exception e) { 
				if (i == 1000) {
					Assert.fail(e.getMessage());
	...
	public void click_on_save_icon_and_validate_field_is_required_popup_in_customer_reference_page() {
		for (int i = 0; i <= 1000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(customerreferenceJsPaths.getElement("DocumentDetails_AddIcon")).click();
				break;
			} catch (Exception e) { 
				if (i == 1000) {
					Assert.fail(e.getMessage());
	...
	public void validate_salutation_field_is_present_in_reference_list_view_page() {
		for (int i = 0; i <= 1000; i++) {
			try {
				waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerreferenceJsPaths.getElement("FileUploadButton")));
				Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerreferenceJsPaths.getElement("FileUploadButton")).isDisplayed());
				break;
			} catch (Exception e) { 
				if (i == 1000) {
					Assert.fail(e.getMessage());
	...
	public void validate_name_field_is_present_in_reference_list_view_page() {
		for (int i = 0; i <= 1000; i++) {
			try {
				waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerreferenceJsPaths.getElement("ViewList_NameField")));
				Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerreferenceJsPaths.getElement("ViewList_NameField")).isDisplayed());
				break;
			} catch (Exception e) { 
				if (i == 1000) {
					Assert.fail(e.getMessage());
	...
	public void validate_mobile_number_field_is_present_in_reference_list_view_page() {
		for (int i = 0; i <= 1000; i++) {
			try {
				waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerreferenceJsPaths.getElement("ViewList_MobileNumberField")));
				Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerreferenceJsPaths.getElement("ViewList_MobileNumberField")).isDisplayed());
				break;
			} catch (Exception e) { 
				if (i == 1000) {
					Assert.fail(e.getMessage());
	...
	public void validate_years_known_field_is_present_in_reference_list_view_page() {
		for (int i = 0; i <= 1000; i++) {
			try {
				waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerreferenceJsPaths.getElement("ViewList_YearsKnownField")));
				Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerreferenceJsPaths.getElement("ViewList_YearsKnownField")).isDisplayed());
				break;
			} catch (Exception e) { 
				if (i == 1000) {
					Assert.fail(e.getMessage());
	...
	public void validate_status_field_is_present_in_reference_list_view_page() {
		for (int i = 0; i <= 1000; i++) {
			try {
				waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerreferenceJsPaths.getElement("ViewList_StatusField")));
				Assert.assertTrue(javascriptHelper.executeScriptWithWebElement(customerreferenceJsPaths.getElement("ViewList_StatusField")).isDisplayed());
				break;
			} catch (Exception e) { 
				if (i == 1000) {
					Assert.fail(e.getMessage());
	...
	public void search_the_customer_reference_record_with_valid_data() {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						customerreferenceJsPaths.getElement("list_view_search_input_box")).click();
				javascriptHelper
						.executeScriptWithWebElement(
								customerreferenceJsPaths.getElement("list_view_search_input_box"))
	...
	public void user_search_the_ref_id_under_inbox_for_customer_reference() throws IOException {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerreferenceJsPaths.getElement("inboxSearchInput")));
		for (int i = 0; i <= 500; i++) {
			try {
