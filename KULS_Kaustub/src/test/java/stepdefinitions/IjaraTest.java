...
public class IjaraTest extends BaseClass{
	...
	public void navigate_the_ijara_url2() throws Throwable {
		driver.get(configFileReader.getIjaraApplicationURL());	 
	}
	
	@Given("navigate the TAWARUQ URL")
	public void navigate_the_tawaruq_url() throws Throwable {
		driver.get(configFileReader.getIjaraApplicationURL());	 
	}
	...
	public void login_with_valid_credentials_for_tawaruq()throws Throwable {
		ijaraLogin.loginWithTawarqApplication();
	}
