Feature: to test the address details screen at new application details screen (Ijaraha)
@AT_IJ_NewApp_AD_01
Scenario: To test the address details screen at new app stage with valid input (Ijaraha)
...
@AT_IJ_NewApp_AD_02
Scenario: To test the address details screen at new app stage with in valid input
Given navigate the IJARA URL
And login with valid credentials for new application stage
And click on module dropdown in IJRARAH
And click on LOS option in module dropdown
...
@AT_IJ_NewApp_AD_03
Scenario: to verify user can able to update the list view record of address details in new app stage
Given navigate the IJARA URL
And login with valid credentials for new application stage
And click on module dropdown in IJRARAH
And click on LOS option in module dropdown
...
And user_076 invoke soft assert in address details screen at new appp stage
@AT_IJ_NewApp_AD_05
Scenario: to verify user can able to update the list view record status of address details in new app stage
Given navigate the IJARA URL
And login with valid credentials for new application stage
And click on module dropdown in IJRARAH
And click on LOS option in module dropdown
