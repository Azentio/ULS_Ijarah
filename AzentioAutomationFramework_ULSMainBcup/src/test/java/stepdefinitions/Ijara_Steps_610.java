...
public class Ijara_Steps_610 {
	...
	String murabahaExcelTestDataPath = configFileReader.getMurabahaTestDataFilePath();
	...
	ExcelData ad_CustomerFolllowUpDetails_610 = new ExcelData(excelTestDataPath,
			"AD_CustomerFolllowUpDetails_610", "DataSet ID");

	Map<String, String> testData;

	ExcelData morabha_AppDataEntry = new ExcelData(murabahaExcelTestDataPath, "Morabha_AppDataEntry", "DataSet ID");
	...
	public void login_with_valid_credentials02() throws Throwable {
		for (int i = 0; i < 200; i++) {
			try {
				ijarahLogin.loginWithIjaraApplication02();
				break;
			} catch (Exception e) {
				if (i == 199) {
	...
	public void login_with_valid_credentials07() throws Throwable {
		for (int i = 0; i < 200; i++) {
			try {
				ijarahLogin.loginWithIjaraApplication07();
				break;
			} catch (Exception e) {
				if (i == 199) {
					Assert.fail(e.getMessage());
...
//				.executeScriptWithWebElement(jsPaths2.getElement("clickAddBtn_UnderDocumentDetails_610")));
	...
	public void user_validate_required_at_stage_field_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_validate_document_status_field_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_validate_manitory_option_field_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_validate_document_category_field_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_validate_expected_recepited_date_field_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_validate_deferral_stage_field_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_validate_def_approvel_by_field_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_validate_document_quality_field_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_document_refercence_number_field_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_validate_document_received_by_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_validate_location_where_received_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_validate_date_of_expiry_field_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_validate_lodgement_amount_field_enabled_or_not_under_document_details() throws Throwable {
	...
	public void user_select_document_quality_field_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("documentQuality_UnderDocumentDetails_610")));
	...
	public void user_select_document_category_field_enabled_or_not_under_document_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
				.executeScriptWithWebElement(jsPaths2.getElement("documentCategory_UnderDocumentDetails_610")));
...
//		waitHelper.waitForElementwithFluentwait(driver,javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("click_nxtBtn_610")));
	...
	public void user_validate_add_button_field_enabled_or_not_under_customer_follow_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_validate_called_when_field_enabled_or_not_under_customer_follow_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_validate_customer_resbonce_field_enabled_or_not_under_customer_follow_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_validate_follow_up_data_field_enabled_or_not_under_customer_follow_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_validate_single_status_field_enabled_or_not_under_customer_follow_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_validate_remark_category_field_enabled_or_not_under_customer_follow_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
	...
	public void user_validate_back_button_field_enabled_or_not_under_customer_follow_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
	...
	public void user_validate_save_button_field_enabled_or_not_under_customer_follow_details() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper
...
//		String remarkFormat1 = (String) javascriptHelper.executeScript("return "+remarkFormat);
	...
	public void user_to_verify_the_functionality_of_search_box_with_matching_data_should_be_show_matching_data()
			throws Throwable {
	...
	public void user_to_verfiy_the_functionality_of_search_box_with_not_matching_data_should_not_be_show_no_data()
			throws Throwable {
...
//							}
	...
	public void user_verify_the_loan_tenure_field() {
		...
		for (int j = 0; j < 200; j++) {
			try {
				if (!javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("LoanTenure_610"))
						.isDisplayed()) {
					softAssert.fail();
					break;
				}
...
//		Assert.assertEquals(true,javascriptHelper.executeScriptWithWebElement(jsPaths2.getElement("FdAmountRequested_610")).isDisplayed());
	...
	public void user_verify_the_any_mandatory_field_blank_and_save_system_should_not_allow_user_to_save_the_record()
			throws Throwable {
...
//				.executeScriptWithWebElement(jsPaths2.getElement("clickAddBtn_UnderDocumentDetails_610")));
	...
	public void user_validate_called_when_field_enabled_or_not_under_murabha_customer_follow_details()
			throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
	...
	public void user_validate_follow_up_data_field_enabled_or_not_under_murabha_customer_follow_details()
			throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
	...
	public void user_validate_the_called_when_field_should_be_date_mandatory_and_editable_in_murabha()
			throws Throwable {
...
//		WebElement attribute = javascriptHelper.executeScriptWithWebElement(calledPath);
	...
	public void user_validate_the_customer_responce_field_should_be_look_up_mandatory_and_editable_in_murabha()
			throws Throwable {
	...
	public void user_to_verify_the_functionality_of_search_box_with_matching_data_should_be_show_matching_data_in_murabha()
			throws Throwable {
		Thread.sleep(1000);
...
//		}
	...
	public void user_to_verfiy_the_functionality_of_search_box_with_not_matching_data_should_not_be_show_no_data_in_murabha()
			throws Throwable {
