...
public class IjaraAddressDetailsSteps extends BaseClass {
	...
	ExcelData excelDataForAddressDetailsTestData = new ExcelData(jrahaTestDataPath, "ijarah_AddressDetailsTestData",
			"Dataset ID");
	ExcelData excelDataForAddressDetailsExecutionData = new ExcelData(jrahaTestDataPath,
			"IjarahAddressDetails_ExeTracker", "TestCase ID");
	...
	public void login_with_valid_credentials() throws Throwable {
		ijaraLogin.loginWithIjaraApplication("userTypeARL01");
	}
