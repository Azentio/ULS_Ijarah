...
public class Ijarah_NewAPP_customerDetailsSteps extends BaseClass {
	...
	JSPaths CommonJsElements = new JSPaths(jsPathExcelfile, "iJarah_CommonElements", "Ijarah_CommonFieldName",
			"JSPath");
	Robot robot;
	ExcelData excelDataForcustomerDetails = new ExcelData(jrahaTestDataPath, "customerdetails_NewApp", "Dataset ID");
	...
	ExcelData excelDataForMurabhaCustomerDetailsTestData = new ExcelData(murabahaTestDataPath, "newApp_M_CustDetailsTestData",
			"Dataset ID");
	ExcelData excelDataForTawruqqCustomerDetailsTestData = new ExcelData(tawruqqTestDataPath,
