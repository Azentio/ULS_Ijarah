...
public class Ijarah_NewAppContactDetailsSteps extends BaseClass {
	...
	ExcelData excelDataForContactDetails = new ExcelData(jrahaTestDataPath, "newApp_ContactDetailsTestData",
			"Dataset ID");
	...
	ExcelData excelDataForMurabahaContactDetails = new ExcelData(murabahaTestDataPath, "M_NewApp_CD_TestData",
			"Dataset ID");
	ExcelData excelDataForTawruqqContactDetails = new ExcelData(tawruqqTestDataPath, "TW_ContDetails_TestData",
			"Dataset ID");
