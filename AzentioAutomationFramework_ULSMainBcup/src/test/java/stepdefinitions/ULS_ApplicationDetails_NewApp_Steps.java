...
public class ULS_ApplicationDetails_NewApp_Steps extends BaseClass {
	...
	ExcelData excelDataForApplicationDetailsTestData = new ExcelData(jrahaTestDataPath, "ApplicationDetails_NewApp",
			"Dataset ID");

	ExcelData excelDataForApplicationDetailsTestDataForMurabha = new ExcelData(murabahaTestDataPath,
	...
	ExcelData excelDataForApplicationDetailsTestDataForTawrruq = new ExcelData(tawruqqTestDataPath,
