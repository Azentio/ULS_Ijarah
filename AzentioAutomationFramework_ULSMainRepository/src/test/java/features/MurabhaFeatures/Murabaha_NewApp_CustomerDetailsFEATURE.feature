Feature: To test the murabha customer details screen with murabha product
@NewApp_M_CustDetails_01
Scenario: To test the murabha customer details with valid input
...
@NewApp_M_CustDetails_02
Scenario: To test the customer details screen with invalid input murabha
Given navigate the IJARA URL
And  login with valid credentials for new application stage
And  click on module dropdown in IJRARAH
And  click on LOS option in module dropdown
