...
public class CustomerSearch {
	...
	public CustomerSearch(String excelFilePath, String sheetName, String columnName,String jsPathColumnName) {
	...
	public static void main(String args[]) {
		...
		CustomerSearch jsPaths = new CustomerSearch(path, "CustomerSearch", "Ijara_LoginFieldName","JSPath");
