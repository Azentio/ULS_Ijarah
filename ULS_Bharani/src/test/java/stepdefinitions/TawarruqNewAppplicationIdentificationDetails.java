...
public class TawarruqNewAppplicationIdentificationDetails {
	...
	@And("user_604 get the test data for test case id AT_IJ_NewApp_IDA_01")
	public void user_604_get_the_test_data_for_test_case_id_at_ij_new_app_ida_01() throws Throwable {
	...
	@And("user_604 get the test data for test case id AT_NewAPP_M_IDA_01")
	public void user_604_get_the_test_data_for_test_case_id_AT_NewAPP_M_IDA_01() throws Throwable {
	...
	@And("user_604 get the test data for test case id AT_NewAPP_M_IDA_02")
	public void user_604_get_the_test_data_for_test_case_id_AT_NewAPP_M_IDA_02() throws Throwable {
		customerIdentificationDetailsExecutionData = excelCustomerIdentificationMurabhaExecutionData
	...
	@And("user_604 get the test data for test case id AT_NewAPP_M_IDA_03")
	public void user_604_get_the_test_data_for_test_case_id_AT_NewAPP_M_IDA_03() throws Throwable {
		customerIdentificationDetailsExecutionData = excelCustomerIdentificationMurabhaExecutionData
	...
	@And("user_604 get the test data for test case id AT_NewAPP_M_IDA_04")
	public void user_604_get_the_test_data_for_test_case_id_AT_NewAPP_M_IDA_04() throws Throwable {
		customerIdentificationDetailsExecutionData = excelCustomerIdentificationMurabhaExecutionData
	...
	@And("user_604 get the test data for test case id AT_NewAPP_M_IDA_05")
	public void user_604_get_the_test_data_for_test_case_id_AT_NewAPP_M_IDA_05() throws Throwable {
		customerIdentificationDetailsExecutionData = excelCustomerIdentificationMurabhaExecutionData
	...
	@And("user_604 get the test data for test case id AT_NewAPP_M_IDA_06")
	public void user_604_get_the_test_data_for_test_case_id_AT_NewAPP_M_IDA_06() throws Throwable {
		customerIdentificationDetailsExecutionData = excelCustomerIdentificationMurabhaExecutionData
	...
	public void user_604_get_the_test_data_for_test_case_id_AT_NewAPP_M_IDA_07() throws Throwable {
		customerIdentificationDetailsExecutionData = excelCustomerIdentificationMurabhaExecutionData
	...
	@And("user_604 get the test data for test case id AT_IJ_NewApp_IDA_02")
	public void user_604_get_the_test_data_for_test_case_id_at_ij_new_app_ida_02() throws Throwable {
		customerIdentificationDetailsExecutionData = excelCustomerIdentificationExecutionData
	...
	@And("user_604 get the test data for test case id AT_IJ_NewApp_IDA_03")
	public void user_604_get_the_test_data_for_test_case_id_at_ij_new_app_ida_03() throws Throwable {
		customerIdentificationDetailsExecutionData = excelCustomerIdentificationExecutionData
	...
	@And("user_604 get the test data for test case id AT_IJ_NewApp_IDA_04")
	public void user_604_get_the_test_data_for_test_case_id_at_ij_new_app_ida_04() throws Throwable {
		customerIdentificationDetailsExecutionData = excelCustomerIdentificationExecutionData
	...
	@And("user_604 get the test data for test case id AT_IJ_NewApp_IDA_05")
	public void user_604_get_the_test_data_for_test_case_id_at_ij_new_app_ida_05() throws Throwable {
		customerIdentificationDetailsExecutionData = excelCustomerIdentificationExecutionData
	...
	@And("user_604 get the test data for test case id AT_IJ_NewApp_IDA_06")
	public void user_604_get_the_test_data_for_test_case_id_at_ij_new_app_ida_06() throws Throwable {
		customerIdentificationDetailsExecutionData = excelCustomerIdentificationExecutionData
	...
	public void user_click_the_entitle_button_under_inbox() throws Throwable {
		...
		for (int i = 0; i <= 1000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement("document.querySelector('[ng-reflect-text=\"Entitle\"]')").click();
				break;
			} catch (Exception e) {
				if (i == 1000) {
	...
	public void user_604_search_record_Tawarruq_New_Appplication_Identification_Details()
			throws Throwable {
	...
	public void user_604_search_record_Tawarruq_Commodity_Purchase_Maker_Customer_Details()
			throws Throwable {
		WebElement searchTextBox;
		for (int i = 0; i <= 300; i++) {
			try {
		...
		for (int j = 0; j < premitiveNumberOfRecordInMailBox; j++) {
			for (int k = 0; k <= 300; k++) {
				try {
					...
					if (recordRefNumber.equals("3858")) {
	...
	public void user_604_click_on_additional_customer_info_tab_in_new_application_stage() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper
	...
	public void user_604_click_on_edit_button_customer_personal_information_screen_at_new_app_stage() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@Then("user_604 verify system should change the identification record status active and in active at new app stage")
	public void user_604_verify_system_should_change_the_identification_record_status_active_and_in_active_at_new_app_stage()
			throws Throwable {
		String recordStatus = "";
	...
	@And("user_604 click on add button in customer identification screen")
	public void user_604_click_on_add_button_in_customer_identification_screen() throws Throwable {
	...
	@Then("user_604 verify customer identification screen should get open with save and back button in new app stage")
	public void user_604_verify_customer_identification_screen_should_get_open_with_save_and_back_button_in_new_app_stage()
			throws Throwable {
	...
	@Then("user_604 verify id type field should be editable mandatory dropdown")
	public void user_604_verify_id_type_field_should_be_editable_mandatory_dropdown() throws Throwable {
	...
	@Then("user_604 verify id number field should be editable mandatory numeric field")
	public void user_604_verify_id_number_field_should_be_editable_mandatory_numeric_field() throws Throwable {
	...
	@Then("user_604 verify id issue date field should be editable non mandatiry mandatory calendar field")
	public void user_604_verify_id_issue_date_field_should_be_editable_non_mandatiry_mandatory_calendar_field()
			throws Throwable {
		String mandatoryVerification = "";
		String fieldTypeVerification = "";
		for (int i = 0; i <= 300; i++) {
	...
	@Then("user_604 verify id expairy date field should be editable non mandatiry mandatory calendar field")
	public void user_604_verify_id_expairy_date_field_should_be_editable_non_mandatiry_mandatory_calendar_field()
			throws Throwable {
		String mandatoryVerification = "";
		String fieldTypeVerification = "";
		for (int i = 0; i <= 300; i++) {
	...
	@Then("user_604 verify issuing authority field should be editable non mandatory dropdown")
	public void user_604_verify_issuing_authority_field_should_be_editable_non_mandatory_dropdown() throws Throwable {
		String idTypeMandatoryAttribute = "";
		String fieldType = "";
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@Then("user_604 verify country of issue field should be editable non mandatory dropdown")
	public void user_604_verify_country_of_issue_field_should_be_editable_non_mandatory_dropdown() throws Throwable {
		String idTypeMandatoryAttribute = "";
		String fieldType = "";
	...
	@Then("user_604 verify primary ID flag field should be toggle buttton")
	public void user_604_verify_primary_id_flag_field_should_be_toggle_buttton() throws Throwable {
	...
	@And("user_604 click on save button in customer identification details of new app stage")
	public void user_604_click_on_save_button_in_customer_identification_details_of_new_app_stage() throws Throwable {
		robot = new Robot();
	...
	@Then("user_604 system should show the success pop up for identification details saved record in new app stage")
	public void user_604_system_should_show_the_success_pop_up_for_identification_details_saved_record_in_new_app_stage()
			throws Throwable {
	...
	@And("user_604 click on save button customer identification details screen without enter the mandatory details at new app stage")
	public void user_604_click_on_save_button_customer_identification_details_screen_without_enter_the_mandatory_details_at_new_app_stage()
			throws Throwable {
		robot = new Robot();
		for (int i = 0; i <= 200; i++) {
			try {
	...
	@Then("user_604 verify system should show the validation to fill the mandatory details in customer identification screen at new app stage")
	public void user_604_verify_system_should_show_the_validation_to_fill_the_mandatory_details_in_customer_identification_screen_at_new_app_stage()
			throws Throwable {
	...
	@And("user_604 enter the special character input in id number field")
	public void user_604_enter_the_special_character_input_in_id_number_field() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper
						.executeScriptWithWebElement(
	...
	@Then("user_604 verify system should show the validation for the id number field at new app stage")
	public void user_604_verify_system_should_show_the_validation_for_the_id_number_field_at_new_app_stage()
			throws Throwable {
	...
	@And("user_604 enter the character input in ID number field")
	public void user_604_enter_the_character_input_in_id_number_field() throws Throwable {
		for (int i = 0; i <= 5; i++) {
			try {
				javascriptHelper
						.executeScriptWithWebElement(
	...
	@Then("user_604 verify system wont allow user to enter the character input in ID number field at new app stage")
	public void user_604_verify_system_wont_allow_user_to_enter_the_character_input_in_id_number_field_at_new_app_stage()
			throws Throwable {
		String idNumberFieldValidation = "";
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@And("user_604 click on edit button of customer identification details list view record")
	public void user_604_click_on_edit_button_of_customer_identification_details_list_view_record() throws Throwable {
	...
	@And("user_604 click on edit button of the list view record of customer identification at new app stage")
	public void user_604_click_on_edit_button_of_the_list_view_record_of_customer_identification_at_new_app_stage()
			throws Throwable {
		for (int i = 0; i <= 600; i++) {
			try {
				System.out
	...
	@And("user_604 click on view summary button in identification new app stage record")
	public void user_604_click_on_view_summary_button_in_identification_new_app_stage_record() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
	...
	@Then("user_604 verify system should show the record summary of identification at new app stage")
	public void user_604_verify_system_should_show_the_record_summary_of_identification_at_new_app_stage()
			throws Throwable {
	...
	@And("user_604 update the id number field in identification detais record at new app stage")
	public void user_604_update_the_id_number_field_in_identification_detais_record_at_new_app_stage()
			throws Throwable {
		for (int i = 0; i <= 2; i++) {
			try {
				javascriptHelper
	...
	@Then("user_604 verify system should show the successful update pop up in identification details screen at new appp stage")
	public void user_604_verify_system_should_show_the_successful_update_pop_up_in_identification_details_screen_at_new_appp_stage()
			throws Throwable {
		String saveVaidation = "";
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@And("user_604 get the list view record of customer identification at new app stage")
	public void user_604_get_the_list_view_record_of_customer_identification_at_new_app_stage() throws Throwable {
		// document.querySelectorAll('ion-col[class="m-0 p-0 ng-star-inserted md
		// hydrated"]')[1].querySelectorAll('td span')[7].innerText
		listViewIDNumber = "";
		for (int i = 0; i <= 300; i++) {
	...
	@And("user_604 remove the mandatory details value from customer identification details of updated record at new app stage")
	public void user_604_remove_the_mandatory_details_value_from_customer_identification_details_of_updated_record_at_new_app_stage()
			throws Throwable {
		for (int i = 0; i <= 2; i++) {
			try {
				javascriptHelper
	...
	@Then("user_604 verify system should show the updated value in identification details at new app stage")
	public void user_604_verify_system_should_show_the_updated_value_in_identification_details_at_new_app_stage()
			throws Throwable {
	...
	@And("user_604 verify identification list view record should be read only not editable at new app stage")
	public void user_604_verify_identification_list_view_record_should_be_read_only_not_editable_at_new_app_stage()
			throws Throwable {
		String listViewQuery = "document.querySelectorAll('ion-col[class=\"m-0 p-0 ng-star-inserted md hydrated\"]').length";
		// document.querySelectorAll('ion-col[class="m-0 p-0 ng-star-inserted md
		// hydrated"]')[1].querySelector('button[icon="pi pi-pencil"')
	...
	@And("user_604 click on search button in customer identification details list view at new app stage")
	public void user_604_click_on_search_button_in_customer_identification_details_list_view_at_new_app_stage()
			throws Throwable {
		String listViewQuery = "document.querySelectorAll('ion-col[class=\"m-0 p-0 ng-star-inserted md hydrated\"]').length";
		// document.querySelectorAll('ion-col[class="m-0 p-0 ng-star-inserted md
		// hydrated"]')[1].querySelector('button[icon="pi pi-pencil"')
	...
	@And("user_604 search for valid search text in customer identification details list view at new app stage")
	public void user_604_search_for_valid_search_text_in_customer_identification_details_list_view_at_new_app_stage()
			throws Throwable {
	...
	@Then("user_604 system should show the search result in customer identification details list view at new app stage")
	public void user_604_system_should_show_the_search_result_in_customer_identification_details_list_view_at_new_app_stage()
			throws Throwable {
...
//Showing 0 to 0 of 0 entries
	...
	@And("user_604 search for in valid search text in customer identification details list view at new app stage")
	public void user_604_search_for_in_valid_search_text_in_customer_identification_details_list_view_at_new_app_stage()
			throws Throwable {
		for (int i = 0; i <= 10; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
	...
	@Then("user_604 system should not show the search result in customer identification details list view at new app stage")
	public void user_604_system_should_not_show_the_search_result_in_customer_identification_details_list_view_at_new_app_stage()
			throws Throwable {
		String searchResult = "";
	...
	@And("user_604 click on export button in customer identification details list view")
	public void user_604_click_on_export_button_in_customer_identification_details_list_view() throws Throwable {
//document.querySelectorAll('ion-col[class="m-0 p-0 ng-star-inserted md hydrated"]')[1].querySelector('div[aria-label="dropdown trigger"]')
	...
	@And("user_604 click on pdf export of customer identification details in new app stage")
	public void user_604_click_on_pdf_export_of_customer_identification_details_in_new_app_stage() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@Then("user_604 verify in new app stage system is downloading the customer identification pdf file")
	public void user_604_verify_in_new_app_stage_system_is_downloading_the_customer_identification_pdf_file()
			throws Throwable {
	...
	@And("user_604 click on xls export of customer identification details in new app stage")
	public void user_604_click_on_xls_export_of_customer_identification_details_in_new_app_stage() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@Then("user_604 verify in new app stage system is downloading the customer identification xls file")
	public void user_604_verify_in_new_app_stage_system_is_downloading_the_customer_identification_xls_file()
			throws Throwable {
		String homePath = System.getProperty("user.home");
		String filePath = homePath + "/Downloads";
		File file = new File(filePath);
	...
	@And("user_604 click on back button in customer identification details in new app stage")
	public void user_604_click_on_back_button_in_customer_identification_details_in_new_app_stage() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@Then("user_604 verify identififcation details screen got move backward to previos screen at new app stage")
	public void user_604_verify_identififcation_details_screen_got_move_backward_to_previos_screen_at_new_app_stage()
			throws Throwable {
	...
	public void user_604_get_the_location_of_identification_details_list_view_at_new_app_stage() throws Throwable {
		String listViewQuery = "document.querySelectorAll('ion-col[class=\"m-0 p-0 ng-star-inserted md hydrated\"]').length";
		// document.querySelectorAll('ion-col[class="m-0 p-0 ng-star-inserted md
		// hydrated"]')[1].querySelector('button[icon="pi pi-pencil"')
		boolean statusOfListViewRecord = false;
	...
	public void user_604_click_on_export_button_in_identification_details_list_view_at_new_app_stage()
			throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.scrollIntoView(javascriptHelper.executeScriptWithWebElement(
	...
	public void user_604_click_on_pdf_export_in_indetification_list_view_at_new_app_stage() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(commonJSElements.getElement("pdf_download")).click();
				break;
	...
	public void user_604_verify_system_should_download_the_pdf_file_of_identification_details_record_in_new_app_stage()
			throws Throwable {
		browserHelper.SwitchToWindow(1);
		browserHelper.switchToParentWithChildClose();
	...
	public void user_604_click_on_xlsx_export_in_indetification_list_view_at_new_app_stage() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(commonJSElements.getElement("xls_download")).click();
				break;
	...
	@And("user_604 verify system should download the xlsx file of identification details record in new app stage")
	public void user_604_verify_system_should_download_the_xlsx_file_of_identification_details_record_in_new_app_stage()
			throws Throwable {
		String homePath = System.getProperty("user.home");
		String filePath = homePath + "/Downloads";
		File file = new File(filePath);
	...
	public void user_604_invoke_soft_asset_in_customer_identification_details_screen_at_new_app_stage()
			throws Throwable {
	...
	public void click_on_module_dropdown_in_ijrarah() throws Throwable {
		...
		for (int i = 0; i <= 100; i++) {
			try {
				moduleName = javascriptHelper
						.executeScript("return " + commonJSElements.getElement("module_dropdown") + ".textContent")
						.toString();
		...
		for (int i = 0; i <= 100; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(commonJSElements.getElement("module_dropdown")).click();
				break;
			} catch (Exception e) {
				if (i == 100) {
					Assert.fail(e.getMessage());
...
//document.querySelectorAll('ion-radio-group ion-item')[0].textContent
	...
	public void click_on_mail_box() throws Throwable {
		for (int i = 0; i <= 100; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(commonJSElements.getElement("mail_box")).click();
				break;
			} catch (Exception e) {
				if (i == 100) {
					System.out.println(commonJSElements.getElement("mail_box"));
					Assert.fail(e.getMessage());
				}
			}
		}
	...
	public void click_on_search_box_upon_click_on_the_mail_box() throws Throwable {
		for (int i = 0; i <= 100; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(commonJSElements.getElement("mail_box_search_button"))
						.click();
				if (i > 50) {
					javascriptHelper.JSEClick(javascriptHelper
							.executeScriptWithWebElement(commonJSElements.getElement("mail_box_search_button")));
					break;
				}
				break;
	...
	public void click_on_search_text_box_upon_click_the_search_button() throws Throwable {
		for (int i = 0; i <= 100; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(commonJSElements.getElement("mail_box_search_text")).click();
				break;
			} catch (Exception e) {
				if (i == 100) {
					Assert.fail(e.getMessage());
