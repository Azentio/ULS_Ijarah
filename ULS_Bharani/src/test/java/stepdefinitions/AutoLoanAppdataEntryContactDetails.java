...
public class AutoLoanAppdataEntryContactDetails {
	...
	@And("user_604 get the test data for the test case ID AT_AL_APD_CD_01")
	public void user_604_get_the_test_data_for_the_test_case_id_AT_AL_APD_CD_01() throws Throwable {
		testData = ALoanAppdataEntryContactDetailsexelData.getTestdata("DS_AT_AL_APD_CD_01");
	}
	
	@And("user_604 get the test data for the test case ID AT_AL_APD_CD_02")
	public void user_604_get_the_test_data_for_the_test_case_id_AT_AL_APD_CD_02() throws Throwable {
	...
	public void user_604_get_the_test_data_for_the_test_case_id_AT_AL_APD_CD_03() throws Throwable {
	...
	public void user_604_get_the_test_data_for_the_test_case_id_AT_AL_APD_CD_04() throws Throwable {
	...
	public void user_604_get_the_test_data_for_the_test_case_id_AT_AL_APD_CD_05() throws Throwable {
	...
	@And("user_604 select the new application stage record for contact details screen")
	public void user_604_select_the_new_application_stage_record_for_contact_details_screen() throws Throwable {
	...
	public void user_604_verify_contact_details_list_view_record_should_be_read_only_not_editable_at_new_app_stage()
			throws Throwable {
	...
	public void user_604_click_on_edit_button_in_list_view_record_of_contact_details_in_new_app_stage()
			throws Throwable {
	...
	public void user_604_make_phone_number_field_as_blank_in_contact_details_at_new_app_stage() throws Throwable {
		for (int i = 0; i <= 10; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(ALoanAppdataEntryContactDetails.getElement("phone_number_input"))
						.click();
	...
	@And("user_604 click on add butto in contact details screen in new app stage")
	public void user_604_click_on_add_butto_in_contact_details_screen_in_new_app_stage() throws Throwable {
	...
	@And("user_604 phone type field should be editable dropdown in contact details screen at new app stage")
	public void user_604_phone_type_field_should_be_editable_dropdown_in_contact_details_screen_at_new_app_stage()
			throws Throwable {
	...
	@And("user_604 phone number field should be editable number field in contact details screen at new app stage")
	public void user_604_phone_number_field_should_be_editable_number_field_in_contact_details_screen_at_new_app_stage()
			throws Throwable {
	...
	@And("user_604 consent for phone contact should be editable dropdown in contact details screen at new app stage")
	public void user_604_consent_for_phone_contact_should_be_editable_dropdown_in_contact_details_screen_at_new_app_stage()
			throws Throwable {
		String fieldLevelVerification = "";
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@And("user_604 prefered phone contact type field should be ditable dropdown in contact details screen at new app stage")
	public void user_604_prefered_phone_contact_type_field_should_be_ditable_dropdown_in_contact_details_screen_at_new_app_stage()
			throws Throwable {
		String fieldLevelVerification = "";
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@And("user_604 prefered time for contact field shoule be editable field type should be HH MM type in contact details screen at new app stage")
	public void user_604_prefered_time_for_contact_field_shoule_be_editable_field_type_should_be_hh_mm_type_in_contact_details_screen_at_new_app_stage()
			throws Throwable {
	...
	@And("user_604 email type field should be editable dropdown in contact details screen at new app stage")
	public void user_604_email_type_field_should_be_editable_dropdown_in_contact_details_screen_at_new_app_stage()
			throws Throwable {
		String fieldLevelVerification = "";
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@And("user_604 email ID field should be editable emial iD field in contact details screen at new app stage")
	public void user_604_email_id_field_should_be_editable_emial_i_d_field_in_contact_details_screen_at_new_app_stage()
			throws Throwable {
		String preferedTimeForContact = "";
		for (int i = 0; i <= 200; i++) {
			try {
	...
	public void user_604_click_on_save_button_without_enter_the_details_in_contact_details_screen_in_new_app_stage()
			throws Throwable {
		robot = new Robot();
	...
	public void user_604_verify_contact_details_should_show_the_mandatory_field_validation_in_new_app_stage()
			throws Throwable {
	...
	public void user_604_enter_the_character_input_in_phone_numver_field_in_contact_details_screen_in_new_app_stage()
			throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(ALoanAppdataEntryContactDetails.getElement("phone_number_input"))
	...
	public void user_604_verify_phone_number_field_should_show_the_validation_for_character_input_in_new_app_stage()
			throws Throwable {
		String fieldValidation = "";
	...
	public void user_604_enter_the_negative_input_in_phone_number_field_in_contact_details_screen_in_new_app_stage()
			throws Throwable {
		for (int i = 0; i <= 10; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(ALoanAppdataEntryContactDetails.getElement("phone_number_input"))
	...
	public void user_604_verify_phone_number_field_should_show_the_validation_for_negative_input_in_new_app_stage()
			throws Throwable {
		String fieldValidation = "";
		for (int i = 0; i <= 300; i++) {
			try {
	...
	public void user_604_enter_the_special_character_input_in_phone_numver_field_in_contact_details_screen_in_new_app_stage()
			throws Throwable {
		for (int i = 0; i <= 10; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(ALoanAppdataEntryContactDetails.getElement("phone_number_input"))
	...
	public void user_604_verify_phone_number_field_should_show_the_validation_for_special_character_input_in_new_app_stage()
			throws Throwable {
		String fieldValidation = "";
		for (int i = 0; i <= 300; i++) {
			try {
	...
	public void user_604_enter_the_invaid_mail_id_input_inemail_id_field_in_contact_details_screen_in_new_app_stage()
			throws Throwable {
	...
	public void user_604_verify_email_id_field_should_show_the_validation_for_invalid_mail_id_input_in_new_app_stage()
			throws Throwable {
	...
	@Then("user_604 verify contact details screen should get open with save buttton and back button")
	public void user_604_verify_contact_details_screen_should_get_open_with_save_buttton_and_back_button()
			throws Throwable {
	...
	@Then("user_604 verify phone type field should be editable numeric field at new app stage")
	public void user_604_verify_phone_type_field_should_be_editable_numeric_field_at_new_app_stage() throws Throwable {
		String fieldLevelVerification = "";
		System.out.println("Phone type dropdown " + ALoanAppdataEntryContactDetails.getElement("phone_type_dropdown"));
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@Then("user_604 verify phone number field should be editable numeric field at new app stage")
	public void user_604_verify_phone_number_field_should_be_editable_numeric_field_at_new_app_stage()
			throws Throwable {
		String fieldValidation = "";
		for (int i = 0; i <= 1000; i++) {
			try {
	...
	@Then("user_604 verify Consent for Phone Contact should be editable numeric at new app stage")
	public void user_604_verify_consent_for_phone_contact_should_be_editable_numeric_at_new_app_stage()
			throws Throwable {
		String fieldLevelVerification = "";
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@Then("user_604 verify prefered phone contact type field should be editable email format at new app stage")
	public void user_604_verify_prefered_phone_contact_type_field_should_be_editable_email_format_at_new_app_stage()
			throws Throwable {
		String fieldLevelVerification = "";
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@Then("user_604 verify prefered time for contact field should be editable number format at new app stage")
	public void user_604_verify_prefered_time_for_contact_field_should_be_editable_number_format_at_new_app_stage()
			throws Throwable {
		String preferedTimeForContact = "";
		for (int i = 0; i <= 200; i++) {
			try {
	...
	@Then("user_604 verify email type field should be editable dropdown at new app stage")
	public void user_604_verify_email_type_field_should_be_editable_dropdown_at_new_app_stage() throws Throwable {
		String fieldLevelVerification = "";
		for (int i = 0; i <= 300; i++) {
			try {
				fieldLevelVerification = javascriptHelper
	...
	@Then("user_604 verify email ID field should be number editable at new app stage")
	public void user_604_verify_email_id_field_should_be_number_editable_at_new_app_stage() throws Throwable {
		String preferedTimeForContact = "";
		for (int i = 0; i <= 200; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(ALoanAppdataEntryContactDetails.getElement("email_input_input"))
	...
	@And("user_604 click on save button in contact details screen at new app stage")
	...
	@Then("user_604 show the save successful pop up for contact details screen at new app stage")
	...
	@And("user_604 click on export button in contact details list view at new app stage")
	public void user_604_click_on_export_button_in_contact_details_list_view_at_new_app_stage() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				if (i < 250) {
	...
	@And("user_604 click on pdf options in contact details export option at new app stage")
	public void user_604_click_on_pdf_options_in_contact_details_export_option_at_new_app_stage() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@Then("user_604 verify contact details pdf file should download in new app stage")
	public void user_604_verify_contact_details_pdf_file_should_download_in_new_app_stage() throws Throwable {
	...
	@And("user_604 click on xlsx options in contact details export option at new app stage")
	public void user_604_click_on_xlsx_options_in_contact_details_export_option_at_new_app_stage() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@Then("user_604 verify contact details xlsx file should download in new app stage")
	public void user_604_verify_contact_details_xlsx_file_should_download_in_new_app_stage() throws Throwable {
		String homePath = System.getProperty("user.home");
		String filePath = homePath + "/Downloads";
		File file = new File(filePath);
		File[] listFiles = file.listFiles();
	...
	@And("user_604 click on contact details list view search button at new app stage")
	public void user_604_click_on_contact_details_list_view_search_button_at_new_app_stage() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						"document.querySelectorAll('ion-col[class=\"m-0 p-0 ng-star-inserted md hydrated\"]')["
	...
	@Then("user_604 verify contact details list view should show the unmatched results at new app stage")
	public void user_604_verify_contact_details_list_view_should_show_the_unmatched_results_at_new_app_stage()
			throws Throwable {
		String searchResult = "";
	...
	@And("user_604 click on back button in contact details screen at new app stage")
	public void user_604_click_on_back_button_in_contact_details_screen_at_new_app_stage() throws Throwable {
	...
	@Then("user_604 verify contact details screen should get moved to backward at new app stage")
	public void user_604_verify_contact_details_screen_should_get_moved_to_backward_at_new_app_stage()
			throws Throwable {
		String labelLength = "document.querySelectorAll('ion-title[class=\"pl-2 pr-2 ion-color ion-color-dark md title-default hydrated\"]').length";
		String lengthOfTheLabel = "";
		boolean isAddButttonClicked = false;
	...
	public void user_604_invoke_soft_assert_in_contac_details_new_new_app_stage() throws Throwable {
