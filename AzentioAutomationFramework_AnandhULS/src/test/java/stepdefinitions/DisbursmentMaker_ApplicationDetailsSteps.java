...
public class DisbursmentMaker_ApplicationDetailsSteps extends BaseClass {
	...
	ExcelData userIDExcelData = new ExcelData(configFileReader.getTestDataFilePath(), "ijara_LoginCredentials",
			"UserType");
	...
	public void user_076_retive_the_disbursment_checker_user_id_and_store_it_in_excel_database() throws Throwable {
		...
		userIDExcelData.updateTestData("userType16", "UserName", disbursmentCheckerUserID);
...
//userType14
		userIDExcelData.updateTestData("userType14", "UserName", returnDataEntryUserID);
	}
