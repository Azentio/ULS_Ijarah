Feature: Application_Detail_Customer_Search
  ...
  Scenario: to test the functionality of customer search with valid data
    ...
    And User_607 Update testdata from AT_MUCS_01
    ...
    And User_607 click the menu icon in after login screen
		...
		And logout from the ULS Application

		@AT_MU_CS_02
		Scenario: to test the functionality of customer search with valid data
		Given navigate the MURABHA URL
    And login with valid credentials for new application stage
    And User_607 Update testdata from AT_MUCS_02
    And User_607 Select LOS in module name
    And User_607 click the menu icon in after login screen
		And User_607 navigate to the Transactions flag
		And User_607 navigate to the Application manager flag
    ...
    Scenario: to test the functionality of customer search with valid data
		Given navigate the MURABHA URL
    And login with valid credentials for new application stage
    And User_607 Update testdata from AT_MUCS_03
    And User_607 Select LOS in module name
    And User_607 click the menu icon in after login screen
		And User_607 navigate to the Transactions flag
		And User_607 navigate to the Application manager flag
		...
		Given navigate the MURABHA URL
    And login with valid credentials for new application stage
    And User_607 Update testdata from AT_MUCS_04
    And User_607 Select LOS in module name
    And User_607 click the menu icon in after login screen
		And User_607 navigate to the Transactions flag
		And User_607 navigate to the Application manager flag
