...
public class New_Application {
	...
	ExcelData excelDataForExecutionData = new ExcelData(excelTestDataPath,
			"Murabha_ExecutionTracker", "TestCase ID");
...
//		}
	...
	@Given("User_607 Update testdata from AT_MUCS_01")
	public void user_update_testdata_from_at_mucs() {
		executionData  = excelDataForExecutionData.getTestdata("AT_MUCS_01");
		testData = Customer_Search.getTestdata(executionData.get("dataSet_ID"));
	}
	

	@Given("User_607 Update testdata from AT_MUCS_02")
	public void user_update_testdata_from_AT_MUCS_02() {
		executionData  = excelDataForExecutionData.getTestdata("AT_MUCS_02");
		testData = Customer_Search.getTestdata(executionData.get("dataSet_ID"));
	}

	@Given("User_607 Update testdata from AT_MUCS_03")
	public void user_update_testdata_from_AT_MUCS_03() {
		executionData  = excelDataForExecutionData.getTestdata("AT_MUCS_03");
		testData = Customer_Search.getTestdata(executionData.get("dataSet_ID"));
	}

	@Given("User_607 Update testdata from AT_MUCS_04")
	public void user_update_testdata_from_AT_MUCS_04() {
		executionData  = excelDataForExecutionData.getTestdata("AT_MUCS_04");
		testData = Customer_Search.getTestdata(executionData.get("dataSet_ID"));
	}
