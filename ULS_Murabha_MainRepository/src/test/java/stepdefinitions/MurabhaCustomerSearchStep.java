...
public class MurabhaCustomerSearchStep extends BaseClass {
	...
	JSPaths CustomerSearchPaths = new JSPaths(excelPath, "CustomerSearch", "FieldName", "Jspath");
	...
	public void user_navigate_to_the_application_manager_flag() {
		for (int i = 0; i < 500; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(CustomerSearchPaths.getElement("ApplicationManager")).click();
				break;
			} catch (Exception e) {
				if (i==499) {
					Assert.fail(e.getMessage());
	...
	public void user_click_the_application_details_flag() {
		for (int i = 0; i < 500; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(CustomerSearchPaths.getElement("ApplicationDetails")).click();
				break;
			} catch (Exception e) {
				if (i==499) {
					Assert.fail(e.getMessage());
	...
	public void check_the_customer_type_field_is_available_or_not() {
		if (!javascriptHelper.executeScriptWithWebElement(CustomerSearchPaths.getElement("CustomerType")).isDisplayed()) {
	...
	public void check_the_application_numbers_field_is_available_or_not() {
		if (!javascriptHelper.executeScriptWithWebElement(CustomerSearchPaths.getElement("ApplicationNumber")).isDisplayed()) {
	...
	public void check_the_customer_name_field_is_available_or_not() {
		if (!javascriptHelper.executeScriptWithWebElement(CustomerSearchPaths.getElement("CustomerName")).isDisplayed()) {
	...
	public void check_the_mobile_number_field_is_available_or_not() {
		if (!javascriptHelper.executeScriptWithWebElement(CustomerSearchPaths.getElement("MobileNumber")).isDisplayed()) {
	...
	public void check_the_date_of_birth_field_is_available_or_not() {
		if (!javascriptHelper.executeScriptWithWebElement(CustomerSearchPaths.getElement("DateofBirth")).isDisplayed()) {
	...
	public void enter_the_mandetory_fields() {
		...
		String jqueryForDropdownLength = "document.querySelectorAll('ion-radio-group ion-radio').length";
			...
			for (int i = 0; i < 300; i++) {
				try {
					javascriptHelper.executeScriptWithWebElement(CustomerSearchPaths.getElement("IDNumber")).sendKeys("9095443283");
					break;
				} catch (Exception e) {
					if (i==299) {
						Assert.fail(e.getMessage());
			...
			for (int i = 0; i <300; i++) {
				try {
					javascriptHelper.executeScriptWithWebElement(CustomerSearchPaths.getElement("DateofBirth")).sendKeys("01-Jan-2000");
					break;
				} catch (Exception e) {
					if (i==299) {
						Assert.fail(e.getMessage());			
			...
			for (int i = 0; i < 300; i++) {
				try {
					javascriptHelper.executeScriptWithWebElement(CustomerSearchPaths.getElement("DateofBirthSelect")).click();
					break;
				} catch (Exception e) {
					if (i==299) {
						Assert.fail(e.getMessage());
	...
	public void check_the_create_new_request_fiels_is_available_or_not() {
		if (!javascriptHelper.executeScriptWithWebElement(CustomerSearchPaths.getElement("CreateNewRequest")).isDisplayed()) {
