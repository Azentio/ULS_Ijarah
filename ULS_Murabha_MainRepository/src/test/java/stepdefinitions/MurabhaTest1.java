...
public class MurabhaTest1 extends BaseClass {
	...
	@And("user_6047 navigate the IJARA URL")
	public void user_6047_navigate_the_ijara_url() throws Throwable {
		driver.get(configFileReader.getIjaraApplicationURL());

	}

	
	@Then("user_6047 logout from the ijaraApplication")
	public void user_6047_logout_from_the_ijara_application() throws Throwable {
		ijaraLogin.logoutFromMurabha();
	}

	@And("user_6047 click on module dropdown in IJRARAH")
	public void user_6047_click_on_module_dropdown_in_ijrarah() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@And("user_6047 click on LOS option in module dropdown")
	public void user_6047_click_on_los_option_in_module_dropdown() throws Throwable {
...
//document.querySelectorAll('ion-radio-group ion-item')[0].textContent
	...
	@And("user_6047 click on mail box")
	public void user_6047_click_on_mail_box() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@And("user_6047 click on search box upon click on the mail box")
	public void user_6047_click_on_search_box_upon_click_on_the_mail_box() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@And("user_6047 click on search text box upon click the search button")
	public void user_6047_click_on_search_text_box_upon_click_the_search_button() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@And("user_6047 search the record reference number in search text box")
	public void user_6047_search_the_record_reference_number_in_search_text_box() throws Throwable {
	...
	@And("user_6047 select the record form mail box")
	public void user_6047_select_the_record_form_mail_box() throws Throwable {
	...
	public void user_6047_click_on_additional_customer_info_tab() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper
	...
	@And("user_6047 click edit button of customer personal information record")
	public void user_6047_click_edit_button_of_customer_personal_information_record() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@And("user_6047 get the test data for test case ID AT_AD_001")
	public void user_6047_get_the_test_data_for_test_case_id_at_AT_AD_001() throws Throwable {
		addressDetailsTestData = excelDataForAddressDetailsTestData.getTestdata("DS01_AT_AD_001");

	}

	@And("user_6047 get the test data for test case ID AT_AD_002")
	public void user_6047_get_the_test_data_for_test_case_id_at_AT_AD_002() throws Throwable {
		addressDetailsTestData = excelDataForAddressDetailsTestData.getTestdata("DS01_AT_AD_002");

	}

	@And("user_6047 get the test data for test case ID AT_AD_003")
	public void user_6047_get_the_test_data_for_test_case_id_at_AT_AD_003() throws Throwable {
		addressDetailsTestData = excelDataForAddressDetailsTestData.getTestdata("DS01_AT_AD_003");

	}

	@And("user_6047 get the test data for test case ID AT_AD_005")
	public void user_6047_get_the_test_data_for_test_case_id_at_AT_AD_005() throws Throwable {
		addressDetailsTestData = excelDataForAddressDetailsTestData.getTestdata("DS01_AT_AD_005");

	}

	@And("user_6047 get the test data for test case ID AT_AD_006")
	public void user_6047_get_the_test_data_for_test_case_id_at_AT_AD_007() throws Throwable {
		addressDetailsTestData = excelDataForAddressDetailsTestData.getTestdata("DS01_AT_AD_006");

	}

	@Then("user_6047 verify save buttton and back button should visible in address details screen")
	public void user_6047_verify_save_buttton_and_back_button_should_visible_in_address_details_screen() throws Throwable {
	...
	public void user_6047_verify_address_type_field_should_be_mandatory_and_dropdown_and_editable() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@Then("user_6047 verify address status field should be mandatory and dropdown and editable")
	public void user_6047_verify_address_status_field_should_be_mandatory_and_dropdown_and_editable() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@Then("user_6047 verify residential or occupancy status field should should be dropdown and editable")
	public void user_6047_verify_residential_or_occupancy_status_field_should_should_be_dropdown_and_editable() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper
	...
	@Then("user_6047 verify communication address should be non mandatory and editable")
	public void user_6047_verify_communication_address_should_be_non_mandatory_and_editable() throws Throwable {

	}

	@Then("user_6047 verify location address should be mandatory and editable lookup")
	public void user_6047_verify_location_address_should_be_mandatory_and_editable_lookup() throws Throwable {

	}

	@Then("user_6047 verify location category should be mandatory and editable lookup")
	public void user_6047_verify_location_category_should_be_mandatory_and_editable_lookup() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@Then("user_6047 verify address line 1 should be mandatory editable text box")
	public void user_6047_verify_address_line_1_should_be_mandatory_editable_text_box() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@Then("user_6047 verify address line 2 should be mandatory editable text box")
	public void user_6047_verify_address_line_2_should_be_mandatory_editable_text_box() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.scrollIntoView(javascriptHelper
	...
	@Then("user_6047 verify country should be editable mandatory text box")
	public void user_6047_verify_country_should_be_editable_mandatory_text_box() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@Then("user_6047 verify provience ID field should be mandatory editable text box")
	public void user_6047_verify_provience_id_field_should_be_mandatory_editable_text_box() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@Then("user_6047 verify Neighbourhood\\/District name field should be mandatory editable text box")
	public void user_6047_verify_neighbourhood_district_name_field_should_be_mandatory_editable_text_box() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.scrollIntoView(javascriptHelper
	...
	@Then("user_6047 verify city field should be editable mandatory text box")
	public void user_6047_verify_city_field_should_be_editable_mandatory_text_box() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@Then("user_6047 verify zipcode field should be editable mandatory textbox")
	public void user_6047_verify_zipcode_field_should_be_editable_mandatory_textbox() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.scrollIntoView(
	...
	@Then("user_6047 verify po box number field should be editable non mandatory text box")
	public void user_6047_verify_po_box_number_field_should_be_editable_non_mandatory_text_box() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.scrollIntoView(javascriptHelper
	...
	@Then("user_6047 verify duration of stay should be non mandatory editable text numeric field")
	public void user_6047_verify_duration_of_stay_should_be_non_mandatory_editable_text_numeric_field() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.scrollIntoView(javascriptHelper
	...
	@Then("user_6047 verify latitude details should be non mandatory editable text box")
	public void user_6047_verify_latitude_details_should_be_non_mandatory_editable_text_box() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@Then("user_6047 verify longitude details should be non mandatory editable text box")
	public void user_6047_verify_longitude_details_should_be_non_mandatory_editable_text_box() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.scrollIntoView(javascriptHelper.executeScriptWithWebElement(
	...
	@Then("user_6047 verify landmark details should be non mandatory editable text box")
	public void user_6047_verify_landmark_details_should_be_non_mandatory_editable_text_box() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.scrollIntoView(
	...
	@Then("user_6047 verify Occupancy date should be non mandatory editable calendar")
	public void user_6047_verify_occupancy_date_should_be_non_mandatory_editable_calendar() throws Throwable {
	...
	@Then("user_6047 verify land lord name should be non mandatory editable text box")
	public void user_6047_verify_land_lord_name_should_be_non_mandatory_editable_text_box() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.scrollIntoView(javascriptHelper
	...
	@Then("user_6047 verify land lord mobile number should be non mandatory editable numeric")
	public void user_6047_verify_land_lord_mobile_number_should_be_non_mandatory_editable_numeric() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.scrollIntoView(javascriptHelper
	...
	@Then("user_6047 verify rent amount should be non mandatory editable numeric")
	public void user_6047_verify_rent_amount_should_be_non_mandatory_editable_numeric() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.scrollIntoView(
	...
	@Then("user_6047 verify frequency rent should be non mandatory editable dropdown")
	public void user_6047_verify_frequency_rent_should_be_non_mandatory_editable_dropdown() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.scrollIntoView(javascriptHelper
	...
	@And("user_6047 click on save button in address details screen")
	public void user_6047_click_on_save_button_in_address_details_screen() throws Throwable {
...
//		}
	...
	@And("user_6047 click on save button without enter mandatory data")
	public void user_6047_click_on_save_without_enter_mandatory_data() throws Throwable {
	...
	@Then("user_6047 verify system should show the validation for mandatory field")
	public void user_6047_verify_system_should_show_the_validation_for_mandatory_field() throws Throwable {
		String toastContent = "";
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@And("user_6047 enter the special character input in any of the field")
	public void user_6047_enter_the_special_character_input_in_any_of_the_field() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(addressDetailsJSPaths.getElement("address_line1")).click();
				javascriptHelper.executeScriptWithWebElement(addressDetailsJSPaths.getElement("address_line1"))
	...
	@Then("user_6047 verify system should show the validation for special character input")
	public void user_6047_verify_system_should_show_the_validation_for_special_character_input() throws Throwable {
	...
	@And("user_6047 enter the character inputs in numeric field")
	public void user_6047_enter_the_character_inputs_in_numeric_field() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.scrollIntoView(javascriptHelper
						.executeScriptWithWebElement(addressDetailsJSPaths.getElement("po_box_number")));
	...
	@Then("user_6047 verify system should not accept the character input in numeric field")
	public void user_6047_verify_system_should_not_accept_the_character_input_in_numeric_field() throws Throwable {
		String poBoxNumber = "";
		for (int i = 0; i <= 50; i++) {
			try {
	...
	@And("user_6047 click on edit button on created record of address details")
	...
	@And("user_6047 update the any of the field in address details record")
	public void user_6047_update_the_any_of_the_field_in_address_details_record() throws Throwable {
	...
	@Then("user_6047 verify record got approved with the updated record")
	public void user_6047_verify_record_got_approved_with_the_updated_record() {
		String addressDetailsLength = "";
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@And("user_6047 make the mandatiry field blank in address details screen")
	public void user_6047_make_the_mandatiry_field_blank_in_address_details_screen() {
		String addressDetailsLength = "";
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@Then("user_6047 verify the functionality of the back button in updated record screen")
	public void user_6047_verify_the_functionality_of_the_back_button_in_updated_record_screen() {
		for (int i = 0; i <= 300; i++) {
			try {
	...
	@And("user_6047 change the status active to inactive for address details record")
	public void user_6047_change_the_status_active_to_inactive_for_address_details_record() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.scrollIntoView(javascriptHelper
	...
	@Then("user_6047 verify system should show the record status as inactive")
	public void user_6047_verify_system_should_show_the_record_status_as_inactive() throws Throwable {
		String status = "";
		String query = "document.querySelectorAll('ion-title[class=\"pl-2 pr-2 ion-color ion-color-dark md title-default hydrated\"]')[2].innerText";
		int screenLocation;
		String sectionLength = "";
	...
	@And("user_6047 change the status inactive to active for address details record")
	public void user_6047_change_the_status_inactive_to_active_for_address_details_record() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.scrollIntoView(javascriptHelper
						.executeScriptWithWebElement(addressDetailsJSPaths.getElement("addressdetails_status_toggle")));
	...
	@Then("user_6047 verify system should show the record status as active")
	public void user_6047_verify_system_should_show_the_record_status_as_active() throws Throwable {
		String status = "";
		String query = "document.querySelectorAll('ion-title[class=\"pl-2 pr-2 ion-color ion-color-dark md title-default hydrated\"]')[2].innerText";
		int screenLocation;
		String sectionLength = "";
	...
	public void user_6047_verify_list_view_fields_are_shown_in_address_details_list_view() throws Throwable {
		String fieldName = "";
		String query = "document.querySelectorAll('ion-title[class=\"pl-2 pr-2 ion-color ion-color-dark md title-default hydrated\"]')[2].innerText";
		int screenLocation;
		String sectionLength = "";
	...
	@And("user_6047 get the test data for test case ID AT_NADC_01")
	public void user_6047_get_the_test_data_for_test_case_id_at_AT_NADC_01() throws Throwable {
		addressDetailsTestData = excelDataForAddressDetailsTestData.getTestdata("DS01_AT_NADC_001");
}

		@And("user_6047 click on action button below the Address details")
		public void user_6047_click_on_action_button_below_the_address_details() {
			for (int i = 0; i < 700; i++) {
				try {
		...
		public void user_6047_verify_address_status_should_visible_in_address_details_screen() {
		...
		public void user_6047_verify_latitude_details_of_the_address_should_visible_in_address_details_screen() {
		...
		@Then("user_6047 verify Address type should be mandatory")
		public void user_6047_verify_address_type_should_be_mandatory() {
		...
		@Then("user_6047 verify Address type should be display only")
		public void user_6047_verify_address_type_should_be_display_only() {
		...
		@Then("user_6047 verify Address type should be dropdown")
		public void user_6047_verify_address_type_should_be_dropdown() {
		...
		@Then("user_6047 verify Address Status should be mandatory")
		public void user_6047_verify_address_status_should_be_mandatory() {
		...
		@Then("user_6047 verify Address Status should be display only")
		public void user_6047_verify_address_status_should_be_display_only() {
		...
		@Then("user_6047 verify Address Status should be dropdown")
		public void user_6047_verify_address_status_should_be_dropdown() {
		...
		@Then("user_6047 verify Residential or occupancy status should be mandatory")
		public void user_6047_verify_residential_or_occupancy_status_should_be_mandatory() {
		...
		@Then("user_6047 verify Residential or occupancy status should be display only")
		public void user_6047_verify_residential_or_occupancy_status_should_be_display_only() {
		...
		@Then("user_6047 verify Residential or occupancy status should be dropdown")
		public void user_6047_verify_residential_or_occupancy_status_should_be_dropdown() {
		...
		@Then("user_6047 verify Communication address should be a toggle button")
		public void user_6047_verify_communication_address_should_be_a_toggle_button() {
		...
		@Then("user_6047 verify Communication address should be display only")
		public void user_6047_verify_communication_address_should_be_display_only() {
		...
		@Then("user_6047 verify Location Category should be display only")
		public void user_6047_verify_location_category_should_be_display_only() {
		...
		@Then("user_6047 verify Location Category should be dropdown")
		public void user_6047_verify_location_category_should_be_dropdown() {
		...
		@Then("user_6047 verify Address line1 should be mandatory")
		public void user_6047_verify_address_line1_should_be_mandatory() {
		...
		@Then("user_6047 verify Address line1 should be display only")
		public void user_6047_verify_address_line1_should_be_display_only() {
		...
		@Then("user_6047 verify Address line1 should be text box")
		public void user_6047_verify_address_line1_should_be_text_box() {
		...
		@Then("user_6047 verify Address line2 should be mandatory")
		public void user_6047_verify_address_line2_should_be_mandatory() {
		...
		@Then("user_6047 verify Address line2 should be display only")
		public void user_6047_verify_address_line2_should_be_display_only() {
		...
		@Then("user_6047 verify Address line2 should be text box")
		public void user_6047_verify_address_line2_should_be_text_box() {
		...
		@Then("user_6047 verify Country should be mandatory")
		public void user_6047_verify_country_should_be_mandatory() {
		...
		@Then("user_6047 verify Country should be display only")
		public void user_6047_verify_country_should_be_display_only() {
		...
		@Then("user_6047 verify Country should be text box")
		public void user_6047_verify_country_should_be_text_box() {
		...
		@Then("user_6047 verify Province Id should be mandatory")
		public void user_6047_verify_province_id_should_be_mandatory() {
		...
		@Then("user_6047 verify Province Id should be display only")
		public void user_6047_verify_province_id_should_be_display_only() {
		...
		@Then("user_6047 verify Province Id should be text box")
		public void user_6047_verify_province_id_should_be_text_box() {
		...
		@Then("user_6047 verify Neighbourhood District Name should be mandatory")
		public void user_6047_verify_neighbourhood_district_name_should_be_mandatory() {
		...
		@Then("user_6047 verify Neighbourhood District Name should be display only")
		public void user_6047_verify_neighbourhood_district_name_should_be_display_only() {
		...
		@Then("user_6047 verify Neighbourhood District Name should be text box")
		public void user_6047_verify_neighbourhood_district_name_should_be_text_box() {
		...
		@Then("user_6047 verify City should be mandatory")
		public void user_6047_verify_city_should_be_mandatory() {
		...
		@Then("user_6047 verify City should be display only")
		public void user_6047_verify_city_should_be_display_only() {
		...
		@Then("user_6047 verify City should be text box")
		public void user_6047_verify_city_should_be_text_box() {
		...
		@Then("user_6047 verify Zip code should be mandatory")
		public void user_6047_verify_zip_code_should_be_mandatory() {
		...
		@Then("user_6047 verify Zip code should be display only")
		public void user_6047_verify_zip_code_should_be_display_only() {
		...
		@Then("user_6047 verify Zip code should be text box")
		public void user_6047_verify_zip_code_should_be_text_box() {
		...
		@Then("user_6047 verify PO Box Number should be display only")
		public void user_6047_verify_po_box_number_should_be_display_only() {
		...
		@Then("user_6047 verify PO Box Number should be text box")
		public void user_6047_verify_po_box_number_should_be_text_box() {
		...
		@Then("user_6047 verify Mobile number should be display only")
		public void user_6047_verify_mobile_number_should_be_display_only() {
		...
		@Then("user_6047 verify Mobile number should be text box")
		public void user_6047_verify_mobile_number_should_be_text_box() {
		...
		@Then("user_6047 verify  Duration Of Stay should be display only")
		public void user_6047_verify_duration_of_stay_should_be_display_only() {
		...
		@Then("user_6047 verify  Duration Of Stay should be text box")
		public void user_6047_verify_duration_of_stay_should_be_text_box() {
		...
		@Then("user_6047 verify Latitude Details Of The Address should be display only")
		public void user_6047_verify_latitude_details_of_the_address_should_be_display_only() {
		...
		@Then("user_6047 verify Latitude Details Of The Address should be text box")
		public void user_6047_verify_latitude_details_of_the_address_should_be_text_box() {
		...
		@Then("user_6047 verify Longitude Details Of The Address should be display only")
		public void user_6047_verify_longitude_details_of_the_address_should_be_display_only() {
		...
		@Then("user_6047 verify Longitude Details Of The Address should be text box")
		public void user_6047_verify_longitude_details_of_the_address_should_be_text_box() {
		...
		@Then("user_6047 verify Land Mark should be display only")
		public void user_6047_verify_land_mark_should_be_display_only() {
		...
		@Then("user_6047 verify Land Mark should be text box")
		public void user_6047_verify_land_mark_should_be_text_box() {
		...
		@Then("user_6047 verify Occupancy Date should be mandatory")
		public void user_6047_verify_occupancy_date_should_be_mandatory() {
		...
		@Then("user_6047 verify Occupancy Date should be display only")
		public void user_6047_verify_occupancy_date_should_be_display_only() {
		...
		@Then("user_6047 verify Occupancy Date should be Date")
		public void user_6047_verify_occupancy_date_should_be_date() {
		...
		@Then("user_6047 verify Landlord Name should be display only")
		public void user_6047_verify_landlord_name_should_be_display_only() {
		...
		@Then("user_6047 verify Landlord Name should be text box")
		public void user_6047_verify_landlord_name_should_be_text_box() {
		...
		@Then("user_6047 verify Landlord Mobile Number should be display only")
		public void user_6047_verify_landlord_mobile_number_should_be_display_only() {
		...
		@Then("user_6047 verify Landlord Mobile Number should be text box")
		public void user_6047_verify_landlord_mobile_number_should_be_text_box() {
		...
		@And("user_6047 Select record after search")
		public void user_6047_select_record_after_search() {
			for (int i = 0; i < 700; i++) {
				try {
		...
		@Then("user_6047 verify Rent Amount should be display only")
		public void user_6047_verify_rent_amount_should_be_display_only() {
		...
		@Then("user_6047 verify Rent Amount should be text box")
		public void user_6047_verify_rent_amount_should_be_text_box() {
		...
		@Then("user_6047 verify Frequency Of Rent should be display only")
		public void user_6047_verify_frequency_of_rent_should_be_display_only() {
		...
		@Then("user_6047 verify Frequency Of Rent should be text box")
		public void user_6047_verify_frequency_of_rent_should_be_text_box() {
		...
		@Then("user_6047 verify field Status should be display only")
		public void user_6047_verify_field_status_should_be_display_only() {
		...
		@Then("user_6047 verify field Status should be toggle status")
		public void user_6047_verify_field_status_should_be_toggle_status() {
		...
		@Then("user_6047 clicking on back button system should navigate to the previous screen")
		public void user_6047_clicking_on_back_button_system_should_navigate_to_the_previous_screen() {
		...
		@And("^user_6047 get the test data for test case AT_EDC_04")
	    public void user_6047_get_the_test_data_for_test_case_AT_DC_CD_001() throws Throwable {
...
//			waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerDebtJsPaths.getElement("customerFinancialsTab")));
		...
		@And("user_6047 click On the Action button below Customer Financials")
		public void user_6047_click_on_the_action_button_below_customer_financials() {
			for (int i = 0; i <= 1000; i++) {
				try {
		...
		@And("user_6047 click On the Action button below Financial Commitments")
		public void user_6047_click_on_the_action_button_below_financial_commitments() {
			String listOfAddButtonQuery = "document.querySelectorAll('ion-title[class=\"pl-2 pr-2 ion-color ion-color-dark md title-default hydrated\"]').length";
			String listOfAddButton = "";
			String addButtonScreenName = "";
			boolean isAddButtonClicked = false;
...
//										.click();
		...
		@And("user_6047 verify the account number field below the Customber debt details")
		public void user_6047_verify_the_account_number_field_below_the_customber_debt_details() {
		...
		@And("user_6047 verify the  Closed Date field below the Customber debt details")
		public void user_6047_verify_the_closed_date_field_below_the_customber_debt_details() {
		...
		@And("user_6047 verify the Status field below the Customber debt details")
		public void user_6047_verify_the_status_field_below_the_customber_debt_details() {
		...
		@And("user_6047 verify the Frequency field below the Customber debt details")
		public void user_6047_verify_the_frequency_field_below_the_customber_debt_details() {
		...
		@And("user_6047 verify the Installment Amount field below the Customber debt details")
		public void user_6047_verify_the_installment_amount_field_below_the_customber_debt_details() {
		...
		@And("user_6047 verify the Last Payment Date field below the Customber debt details")
		public void user_6047_verify_the_last_payment_date_field_below_the_customber_debt_details() {
		...
		@And("user_6047 verify the Next Due Date field below the Customber debt details")
		public void user_6047_verify_the_next_due_date_field_below_the_customber_debt_details() {
		...
		@And("user_6047 verify the Last Cycle field below the Customber debt details")
		public void user_6047_verify_the_last_cycle_field_below_the_customber_debt_details() {
		...
		@And("user_6047 verify the Include in Eligibility field below the Customber debt details")
		public void user_6047_verify_the_include_in_eligibility_field_below_the_customber_debt_details() {
		...
		@And("user_6047 click the Back button in Customer Debt screen navigate to the previous screen")
		public void user_6047_click_the_back_button_in_customer_debt_screen_navigate_to_the_previous_screen() throws Throwable {
		...
		@And("user_6047 verify Closed Date field below the Customber debt should be display only")
		public void user_6047_verify_closed_date_field_below_the_customber_debt_should_be_display_only() {
		...
		@And("user_6047 verify Status field below the Customber debt should be display only")
		public void user_6047_verify_status_field_below_the_customber_debt_should_be_display_only() {
...
//			}
		...
		public void user_6047_verify_the_employer_name_if_others_in_salarised_below_the_employment_details() {
			if (javascriptHelper.executeScriptWithWebElement(EmpDetailElements.getElement("EmployerNameIf")).isDisplayed()) {
				SoftAssert.fail("Check Employer Name If Field");
			}
		}
...
//tdw
		...
		public void user_6047_to_check_the_employer_name_field_should_be_display_only() {
...
//tdw
		...
		public void user_6047_to_check_the_employer_name_if_field_should_be_mandatory() {
