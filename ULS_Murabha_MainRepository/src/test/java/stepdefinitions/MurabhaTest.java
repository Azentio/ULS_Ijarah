...
public class MurabhaTest extends BaseClass {
...
//					javascriptHelper.scrollIntoView(addButton);
	...
	@Given("user_626 click eye icon of customer personal information")
...
//					javascriptHelper.scrollIntoView(addButton);
	...
	@Given("user_626 click eye icon of address details")
...
//		}
	...
	public void user_626_get_the_test_data_for_test_case_id_at_AT_NADC_01() throws Throwable {
		...
		public void user_626_select_record_after_search() throws InterruptedException {
			for (int i = 0; i < 700; i++) {
				try {
