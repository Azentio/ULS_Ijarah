...
public class Murabha_NewApp_CustomerIdentificationDetailsSteps extends BaseClass {
	...
	JSPaths commonJSElements = new JSPaths(excelJSPath, "Murabha_CommonElements", "Murabha_CommonFieldName", "JSPath");
