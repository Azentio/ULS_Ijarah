...
//	}
	...
	public void user_click_the_customer_financials_tab() throws Throwable {
		Thread.sleep(1000);
		WebElement customerFinancialsTab = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("customerFinancialsTab"));
...
//				customerFinancialsTab.click();
	...
	public void user_validate_save_button_available_under_income_details_screen() throws Throwable {
		Thread.sleep(100);
		WebElement incomeSaveBtn = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("incomeSaveBtn"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_back_button_available_under_income_details_screen() throws Throwable {
		WebElement incomeBackBtn = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("incomeBackBtn"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_employment_type_field_available_under_income_details_screen() throws Throwable {
		WebElement employementTypeLabel = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("employementTypeLabel"));
		...
		WebElement employementTypeInput = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("employementTypeInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_lumpsum_amount_field_available_under_income_details_screen() throws Throwable {
		WebElement lumpsumAmtLabel = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("lumpsumAmtLabel"));
		...
		WebElement lumpsumAmtInput = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("lumpsumAmtInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_click_the_pencil_icon_under_customer_financials_tab() throws Throwable {
		Thread.sleep(100);
		WebElement customerFinancialsPencilEditBtn = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("customerFinancialsPencilEditBtn"));
		for (int i = 0; i <= 2000; i++) {
			try {
				javascriptHelper.backgroundColor(customerFinancialsPencilEditBtn);
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("customerFinancialsPencilEditBtn")).click();
				break;
			} catch (Exception e) {
				if (i == 2000) {
					Assert.fail(e.getMessage());
	...
	public void user_validate_income_field_available_under_income_details_screen() throws Throwable {
		WebElement incomeLabel = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("incomeLabel"));
		...
		WebElement incomeDropdown = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("incomeDropdown"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_frequency_field_available_under_income_details_screen() throws Throwable {
		WebElement frequencyLabel = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("frequencyLabel"));
		...
		WebElement frequencyDropdown = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("frequencyDropdown"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_amount_field_available_under_income_details_screen() throws Throwable {
		WebElement amountLabel = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("amountLabel"));
		...
		WebElement amountInput = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("amountInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_defined_field_available_under_income_details_screen() throws Throwable {
		WebElement defined_Label = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("defined%_Label"));
		...
		WebElement defined_Input = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("defined%_Input"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_adjusted_field_available_under_income_details_screen() throws Throwable {
		WebElement adjusted_Label = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("adjusted%_Label"));
		...
		WebElement adjusted_Input = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("adjusted%_Input"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_amount_considered_field_available_under_income_details_screen() throws Throwable {
		WebElement amountConsideredLabel = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("amountConsideredLabel"));
		...
		WebElement amountConsideredInput = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("amountConsideredInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_action_button_available_under_income_details_screen() throws Throwable {
		WebElement actionLabel = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("actionLabel"));
		...
		WebElement actionAddBtn = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("actionAddBtn"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_total_income_field_available_under_income_details_screen() throws Throwable {
		WebElement totalIncomeLabel = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("totalIncomeLabel"));
		...
		WebElement totalIncomeInput = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("totalIncomeInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_total_income_considered_field_available_under_income_details_screen() throws Throwable {
		WebElement totalIncomeConsideredLabel = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("totalIncomeConsideredLabel"));
		...
		WebElement totalIncomeConsideredInput = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("totalIncomeConsideredInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_salary_credited_to_bank_field_available_under_income_details_screen() throws Throwable {
		WebElement salaryCreditedToBankLabel = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("salaryCreditedToBankLabel"));
		...
		WebElement salaryCreditedToBankDropdown = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("salaryCreditedToBankDropdown"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_deduction_field_available_under_income_details_screen() throws Throwable {
		WebElement deductionLabel = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionLabel"));
		...
		WebElement deductionDropdown = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionDropdown"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_deduction_frequency_field_available_under_income_details_screen() throws Throwable {
		WebElement deductionFrequencyLabel = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionFrequencyLabel"));
		...
		WebElement deductionFrequencyDropdown = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionFrequencyDropdown"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_deduction_amount_field_available_under_income_details_screen() throws Throwable {
		WebElement deductionAmtLabel = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionAmtLabel"));
		...
		WebElement deductionAmtInput = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionAmtInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_deduction_def_field_available_under_income_details_screen() throws Throwable {
		WebElement deductionDef_Label = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionDef%_Label"));
		...
		WebElement deductionDef_Input = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionDef%_Input"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_deduction_adj_field_available_under_income_details_screen() throws Throwable {
		WebElement deductionAdj_Label = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionAdj%_Label"));
		...
		WebElement deductionAdj_Input = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionAdj%_Input"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_deduction_considered_field_available_under_income_details_screen() throws Throwable {
		WebElement deductionConsideredLabel = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionConsideredLabel"));
		...
		WebElement deductionConsideredInput = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionConsideredInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_deduction_action_button_field_available_under_income_details_screen() throws Throwable {
		WebElement deductionActionLabel = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionActionLabel"));
		...
		WebElement deductionActionAddBtn = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionActionAddBtn"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_total_deduction_field_available_under_income_details_screen() throws Throwable {
		WebElement totalDeductionLabel = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("totalDeductionLabel"));
		...
		WebElement totalDeductionInput = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("totalDeductionInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_total_deduction_considered_field_available_under_income_details_screen() throws Throwable {
		WebElement totalDeductionConsideredLabel = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("totalDeductionConsideredLabel"));
		...
		WebElement totalDeductionConsideredInput = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("totalDeductionConsideredInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_currency_field_available_under_income_details_screen() throws Throwable {
		WebElement currencyLabel = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("currencyLabel"));
		...
		WebElement currencyDropdown = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("currencyDropdown"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_the_confirmation_message_under_income_details_screen() throws Throwable {
		WebElement successToastMsg = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("successToastMsg"));
		for (int i = 0; i <= 5000; i++) {
			try {
		...
		WebElement successToastCloseBtn = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("successToastCloseBtn"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_click_module_name_in_home_screen() {
		for (int i = 0; i < 500; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("moduleName")).click();
				break;
			} catch (Exception e) {
			}
	...
	public void user_select_los_in_the_module_name() {
		for (int i = 0; i < 500; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("selectLOS")).click();
				break;
			} catch (Exception e) {
			}
		}
	...
	public void user_click_inbox_in_the_home_page() {
		for (int i = 0; i < 500; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("inbox"))
						.click();
				break;
			} catch (Exception e) {
			}
	...
	public void user_Click_search_in_inbox() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("clickSearchInInbox")).click();
				break;
			} catch (Exception e) {
				if (i==699) {
					Assert.fail(e.getMessage());
	...
	public void user_search_in_the_search_box() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("searchInInbox")).sendKeys("Gowtham",Keys.ENTER);
				break;
			} catch (Exception e) {
				if (i==699) {
					Assert.fail(e.getMessage());
	...
	public void user_search_in_the_search_field_tawarah_app_data_entry_income_details_list() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("searchInInbox")).sendKeys("3357",Keys.ENTER);
				break;
			} catch (Exception e) {
				if (i==699) {
					Assert.fail(e.getMessage());
	...
	public void user_search_in_the_search_field_Ijara_app_data_entry_income_details_list() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("searchInInbox")).sendKeys(testData.get("Ref No"));
				break;
			} catch (Exception e) {
				if (i==699) {
					Assert.fail(e.getMessage());
	...
	public void user_search_in_the_search_Field() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("searchInInbox")).sendKeys(testData.get("Search Record"),Keys.ENTER);
				break;
			} catch (Exception e) {
				if (i==699) {
					Assert.fail(e.getMessage());
	...
	public void user_select_record_after_search() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("selectRecord")).click();
				break;
			} catch (Exception e) {
				if (i==699) {
					Assert.fail(e.getMessage());
	...
	public void user_click_customer_finacials_in_the_record() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("CustomerFinacials")).click();
				break;
			} catch (Exception e) {
				if (i==699) {
					Assert.fail(e.getMessage());
	...
	public void user_click_edit_button_customer_personal_information() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("edit")).click();
				break;
			} catch (Exception e) {
				if (i==699) {
					Assert.fail(e.getMessage());
	...
	public void user_click_add_button_in_income() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("AddButtonInIncome")).click();
				break;
			} catch (Exception e) {
	...
	public void user_check_employment_type_field() throws Throwable {
		Thread.sleep(7000);
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Employment Type")).isDisplayed()) {
	...
	public void user_check_save_button() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("saveButton")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_check_lumpsum_amount_field() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Lumpsum Amount")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_check_financial_year() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Financial Year")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_check_filing_date() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Filing Date")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_check_income_field() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Income")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_check_frequency_field() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Frequency")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_check_amount_field() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Amount")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_check_defined_field() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Defined")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_check_adjusted_field() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Adjusted")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_check_amount_considered_field() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Amount Considered")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_check_action_field() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Action")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_check_total_income_field() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Total Income")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_check_total_income_considered_field() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Total Income Considered")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_check_salary_credited_to_bank_field() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Salary Credited To Bank")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_check_deduction_field() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Deduction")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_check_deduction_amt_field() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Deduction Amt")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_check_deduction_def_field() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Deduction Def")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_check_deduction_adj_field() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Deduction Adj")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_check_deduction_considered_field() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Deduction Considered")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_check_total_deduction_field() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Total Deduction")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_check_total_deduction_considered_field() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Total Deduction Considered")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_check_currency_field() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Currency")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_select_days_in_frequency() {
		...
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("FrequencyInput")).click();
				break;
			} catch (Exception e) {
				if (i==699) {
					Assert.fail(e.getMessage());
	...
	public void user_enter_amount_in_amount_field() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("FrequencyInput")).click();
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("FrequencyInput")).sendKeys("10000");
				break;
			} catch (Exception e) {
				if (i==699) {
					Assert.fail(e.getMessage());
	...
	public void user_click_save_button() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("saveButton")).click();
				break;
			} catch (Exception e) {
				if (i==699) {
					Assert.fail(e.getMessage());
	...
	public void user_check_record_save_successfully() {
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("SucessSavePopup")).isDisplayed()) {
			Assert.fail();
		}
	...
	public void user_click_back_button() {
		for (int i = 0; i < 700; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("Backbutton")).click();
				break;
			} catch (Exception e) {
				if (i==699) {
					Assert.fail(e.getMessage());
	...
	public void user_check_go_to_previous_page() throws Throwable {
		Thread.sleep(5000);
		if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("AddButtonInIncome")).isDisplayed()) {
			Assert.fail();
		}
	}
	...
	public void user_check_clicking_on_back_button_system_should_navigate_to_the_previous_screen() {
	    if (!javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("selectRecord")).isDisplayed()) {
	    	Assert.fail();
		}
	}
...
//	Murabaha -- App Data Entry -- Income Details screen
    ...
    public void get_the_test_data_for_test_case_AT_TW_AD_INC_07() throws Throwable {
		testData = IjarahAppDataEntryIncomeDetailsexelData.getTestdata("DS_AT_TW_AD_INC_07");
    }
    ...
    public void get_the_test_data_for_test_case_AT_TW_AD_INC_08() throws Throwable {
		testData = IjarahAppDataEntryIncomeDetailsexelData.getTestdata("DS_AT_TW_AD_INC_08");
    }
...
//	@AT_MU_INC_01
	...
	public void user_validate_pension_amount_field_available_under_income_details_screen() throws Throwable {
		WebElement pensionAmtLabel = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("pensionAmtLabel"));
		...
		WebElement pensionAmtInput = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("pensionAmtInput"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_select_the_salary_credited_to_bank_value_under_income_details_screen() throws Throwable {
		for (int i = 0; i <= 2000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("salaryCreditedToBankDropdown")).click();
				break;
			} catch (Exception e) {
				if (i == 2000) {
					Assert.fail(e.getMessage());
	...
	public void user_validate_bank_name_field_available_under_income_details_screen() throws Throwable {
		WebElement bankNameLabel = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("bankNameLabel"));
		WebElement bankNameDropdown = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("bankNameDropdown"));
		for (int i = 0; i <= 2000; i++) {
			try {
	...
	public void user_validate_branch_name_field_available_under_income_details_screen() throws Throwable {
		WebElement branchNameLabel = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("branchNameLabel"));
		WebElement branchNameDropdown = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("branchNameDropdown"));
		for (int i = 0; i <= 2000; i++) {
			try {
...
//	AT_MU_INC_02
	...
	public void user_enter_the_lumpsum_amount_under_income_screen_in_customer_financials_tab()throws Throwable {
	    for (int i = 0; i < 1000; i++) {
	    	try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("lumpsumAmtInput"))
	...
	public void user_enter_the_pension_amount_under_income_screen_in_customer_financials_tab()throws Throwable {
	    for (int i = 0; i < 1000; i++) {
	    	try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("pensionAmtInput"))
	...
	public void user_select_the_income_option_under_income_screen_in_customer_financials_tab() throws Throwable {
		for (int i = 0; i <= 2000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("incomeDropdown")).click();
				break;
			} catch (Exception e) {
				if (i == 2000) {
					Assert.fail(e.getMessage());
	...
	public void user_select_the_frequency_option_under_income_screen_in_customer_financials_tab() throws Throwable {
		for (int i = 0; i <= 2000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("frequencyDropdown")).click();
				break;
			} catch (Exception e) {
				if (i == 2000) {
					Assert.fail(e.getMessage());
	...
	public void user_enter_the_income_amount_under_income_screen_in_customer_financials_tab() throws Throwable {
		for (int i = 0; i < 1000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("amountInput"))
	...
	public void user_enter_the_adjusted_under_income_screen_in_customer_financials_tab() throws Throwable {
		for (int i = 0; i < 1000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("adjusted%_Input"))
	...
	public void user_select_the_bank_name_under_income_screen_in_customer_financials_tab() throws Throwable {
		for (int i = 0; i <= 2000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("bankNameDropdown")).click();
				break;
			} catch (Exception e) {
				if (i == 2000) {
					Assert.fail(e.getMessage());
	...
	public void user_select_the_branch_name_under_income_screen_in_customer_financials_tab() throws Throwable {
		for (int i = 0; i <= 2000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("branchNameDropdown")).click();
				break;
			} catch (Exception e) {
				if (i == 2000) {
					Assert.fail(e.getMessage());
	...
	public void user_select_the_deduction_option_under_income_screen_in_customer_financials_tab() throws Throwable {
		for (int i = 0; i <= 2000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionDropdown")).click();
				break;
			} catch (Exception e) {
				if (i == 2000) {
					Assert.fail(e.getMessage());
	...
	public void user_select_the_deduction_frequency_option_under_income_screen_in_customer_financials_tab() throws Throwable {
		for (int i = 0; i <= 2000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionFrequencyDropdown")).click();
				break;
			} catch (Exception e) {
				if (i == 2000) {
					Assert.fail(e.getMessage());
	...
	public void user_enter_the_deduction_amount_under_income_screen_in_customer_financials_tab() throws Throwable {
		for (int i = 0; i < 1000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionAmtInput")).click();
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionAmtInput"))
	...
	public void user_enter_the_deduction_adjusted_under_income_screen_in_customer_financials_tab() throws Throwable {
		for (int i = 0; i < 1000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionAdj%_Input")).click();
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionAdj%_Input"))
	...
	public void user_select_the_currency_under_income_screen_in_customer_financials_tab() throws Throwable {
		for (int i = 0; i <= 2000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("currencyDropdown")).click();
				break;
			} catch (Exception e) {
				if (i == 2000) {
					Assert.fail(e.getMessage());
...
//	    Allow to user enter the numeric value
		for (int i = 0; i < 200; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("adjusted_Input"))
				.sendKeys(Keys.chord(Keys.CONTROL,"a", Keys.DELETE));
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("adjusted_Input"))
				.sendKeys(testData.get("Adjusted %"));
				break;
	...
	public void user_verify_amount_considered_field_should_be_auto_populated_in_post_entering_adjusted_value() throws Throwable {
		String incomeValue = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("amountInput")).getAttribute("ng-reflect-model");
		String definedValue = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("defined%_Input")).getAttribute("ng-reflect-model");
		String adjustedValue = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("adjusted%_Input")).getAttribute("ng-reflect-model");
		String amountConsideredValue = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("amountConsideredInput")).getAttribute("ng-reflect-model");
...
//				e.printStackTrace();
	...
	public void user_verify_deduction_defined_field_should_be_non_mandatory_textbox_and_allow_to_user_enter_numeric_value_manualy() throws Throwable {
		WebElement defined_Label = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionDef%_Label"));
		WebElement defined_Input = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionDef%_Input"));
		for (int i = 0; i <= 2000; i++) {
			try {
				javascriptHelper.backgroundColor(defined_Label);
				Assert.assertTrue(!(defined_Label.getText().contains("*")));
	...
	public void user_verify_deduction_adjusted_field_should_be_non_mandatory_textbox_and_allow_to_user_enter_numeric_value_manualy() throws Throwable {
		WebElement adjusted_Label = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionAdj%_Label"));
		WebElement adjusted_Input = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionAdj%_Input"));
		for (int i = 0; i <= 2000; i++) {
			try {
				javascriptHelper.backgroundColor(adjusted_Label);
				Assert.assertTrue(!(adjusted_Label.getText().contains("*")));
...
//	    Allow to user enter the numeric value
	...
	public void user_verify_deduction_considered_field_should_be_auto_populated_in_post_entering_deduction_adj_value() throws Throwable {
		String deductionAmt = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionAmtInput")).getAttribute("ng-reflect-model");
		String definedValue = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionDef%_Input")).getAttribute("ng-reflect-model");
		String adjustedValue = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionAdj%_Input")).getAttribute("ng-reflect-model");
		String amountConsideredValue = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionConsideredInput")).getAttribute("ng-reflect-model");
	...
	public void user_verify_total_deduction_value_should_get_auto_populated_post_entering_the_deduction_amount() throws Throwable {
		...
		WebElement totalDeduction = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("totalDeductionInput"));
	...
	public void user_verify_deduction_considered_value_should_get_auto_populate_post_entering_the_value_in_deduction_adj_field() throws Throwable {
		String deductionConsidered = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("deductionConsideredInput")).getAttribute("ng-reflect-model");
		int a = Integer.parseInt(deductionConsidered)/12;
		String sp = Integer.toString(a).split("\\.")[0];
		WebElement totalDeductionConsidered = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("totalDeductionConsideredInput"));
...
//		Select the LOV Value
	...
	public void user_click_add_row_button_system_should_add_a_row_under_income_screen() throws Throwable {
		for (int i = 0; i <= 1000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("actionAddBtn")).click();
				break;
			} catch (Exception e) {
				if (i == 1000) {
					Assert.fail(e.getMessage());
	...
	public void user_click_delete_row_button_system_should_delete_a_row_under_income_screen() throws Throwable {
		for (int i = 0; i <= 1000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("actionDeleteBtn")).click();
				break;
			} catch (Exception e) {
				if (i == 1000) {
					Assert.fail(e.getMessage());
	...
	public void user_verify_validation_message_for_mandatory_field_as_blank_under_income_details_screen() throws Throwable {
		...
		for (int i = 0; i <= 50000; i++) {
			try {
				...
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("successToastCloseBtn")).click();				
				break;
			} catch (Exception e) {
				if (i == 50000) {
					Assert.fail(e.getMessage());
	...
	public void user_verify_while_modification_when_user_keep_any_mandatory_field_blank_and_click_on_save_button() throws Throwable {
		for (int i = 0; i < 1000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("amountInput"))
				.sendKeys(Keys.chord(Keys.CONTROL,"a", Keys.DELETE));
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("incomeSaveBtn")).click();
				break;
			} catch (Exception e) {
				if (i == 1000) {
					Assert.fail(e.getMessage());
...
//	AT_MU_INC_06
	...
	public void user_verify_the_back_button_available_in_income_list_view_under_customer_financials_tab() throws Throwable {
		WebElement backBtn = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("customerFinancialsTabBackBtn"));
		for (int i = 0; i <= 1000; i++) {
			try {
	...
	public void user_verify_nature_of_employement_field_available_under_income_section_list_view_in_customer_financials_tab() throws Throwable {
		WebElement natureOfEmployment = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("listview_NatureOfEmployment"));
		for (int i = 0; i <= 1000; i++) {
			try {
	...
	public void user_verify_net_income_field_available_under_income_section_list_view_in_customer_financials_tab() throws Throwable {
		WebElement netIncome = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("listview_NetIncome"));
		for (int i = 0; i <= 1000; i++) {
			try {
	...
	public void user_verify_net_deduction_field_available_under_income_section_list_view_in_customer_financials_tab() throws Throwable {
		WebElement netDeduction = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("listview_NetDeduction"));
		for (int i = 0; i <= 1000; i++) {
			try {
	...
	public void user_verify_considered_income_field_available_under_income_section_list_view_in_customer_financials_tab() throws Throwable {
		WebElement consideredIncome = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("listview_ConsideredIncome"));
		for (int i = 0; i <= 1000; i++) {
			try {
	...
	public void user_verify_currency_field_available_under_income_section_list_view_in_customer_financials_tab() throws Throwable {
		WebElement currency = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("listview_Currency"));
		for (int i = 0; i <= 1000; i++) {
			try {
	...
	public void user_verify_status_field_available_under_income_section_list_view_in_customer_financials_tab() throws Throwable {
		WebElement status = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("listview_Status"));
		for (int i = 0; i <= 1000; i++) {
			try {
	...
	public void user_post_clicking_on_add_button_system_should_navigate_to_new_income_details_screen() throws Throwable {
		WebElement incomeScreenTitle = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("incomeScreenTitle"));
...
//	AT_MU_INC_07
	...
	public void user_verify_the_functionality_of_search_box_with_matching_data_in_income_section() throws Throwable {
		for (int i = 0; i <= 2000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("incomeSectionSearchbox"))
	...
	public void user_verify_entering_any_matching_value_system_should_display_all_the_possible_matching_records_under_income_section() throws Throwable {
		WebElement searchResult = javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("searchResult"));
		for (int i = 0; i <= 500; i++) {
			try {
	...
	public void user_verify_the_functionality_of_search_box_with_mismatch_data_in_income_section() throws Throwable {
		javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("incomeSectionSearchbox")).sendKeys(Keys.chord(Keys.CONTROL,"a", Keys.DELETE));
		for (int i = 0; i <= 500; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("incomeSectionSearchbox"))
...
//	AT_MU_INC_08
	...
	public void user_post_clicking_on_export_to_pdf_button_system_should_download_the_pdf_file_of_that_records() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("exportPDF")).click();
				break;
			} catch (Exception e) {
				if (i == 300) {
					Assert.fail(e.getMessage());
...
//		IncomeFormDataFile
	...
	public void user_verify_the_functionality_of_export_to_excel_button() throws Throwable {
		...
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("exportXLS")).click();
				break;
			} catch (Exception e) {
				if (i == 300) {
					Assert.fail(e.getMessage());
	...
	public void user_to_verify_the_functionality_of_back_button_under_customer_financials_tab() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				javascriptHelper.scrollIntoView(javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("customerFinancialsTabBackBtn")));
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("customerFinancialsTabBackBtn")).click();
				break;
			} catch (Exception e) {
				if (i == 300) {
					Assert.fail(e.getMessage());
	...
	public void user_post_clicking_on_back_button_under_customer_inanacials_tab_system_should_navigate_to_the_previous_screen() throws Throwable {
		for (int i = 0; i <= 3000; i++) {
			try {
				javascriptHelper.backgroundBorder(javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("customerInfoTitle")));
				javascriptHelper.executeScriptWithWebElement(IjarahAppDataEntryIncomeDetails.getElement("customerInfoTitle")).isDisplayed();
				break;
			} catch (Exception e) {
				if (i == 3000) {
					Assert.fail(e.getMessage());
