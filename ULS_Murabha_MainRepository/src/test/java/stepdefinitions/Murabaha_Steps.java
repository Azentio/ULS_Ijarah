...
public class Murabaha_Steps {	
	...
	ExcelData testExecution = new ExcelData(excelTestDataPath, "Murabha_ExecutionTracker", "TestCase ID");
		...
		for (int i = 0; i <= 150; i++) {
			try {
				String text = javascriptHelper.executeScriptWithWebElement(
						customerDebtJsPaths.getElement("successMsg")).getText();
...
//	AT_MCUD_08
	...
	public void user_search_matching_value_system_should_display_all_the_possible_matching_records_under_financial_commitments_section()
			throws Throwable {
		for (int i = 0; i <= 500; i++) {
			try {
				javascriptHelper
		...
		for (int i = 0; i <= 500; i++) {
			try {
				WebElement searchResult = javascriptHelper.executeScriptWithWebElement(
						customerDebtJsPaths.getElement("searchResult"));
	...
	public void user_search_mismatch_value_system_should_not_display_any_records_under_financial_commitments_section()
			throws Throwable {
		...
		for (int i = 0; i < 150; i++) {
			try {
				...
				softAssert.assertTrue(sourcingType.contains("*"),
						"Classification field should be Mandatory in Application details screen");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//			Verify field as Dropdown
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(classificationDropdown.getAttribute("ng-reflect-placeholder").contains("Select"),
						"Classification field should be Dropdown in Application details screen");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
		...
		for (int i = 0; i <= 150; i++) {
			try {
				softAssert.assertTrue(read.contains("true"),
						"Classification field should Non-editable in Application details screen");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Mandatory
		for (int i = 0; i <150; i++) {
          try {
        	  ...
        	  javascriptHelper.backgroundColor(element);
              softAssert.assertTrue(field.contains("*"),
            		  "Product field should be Mandatory");
              break;
          } catch (Exception e) {
              if (i==150) {
                  Assert.fail(e.getMessage());
...
//		Verify field as Dropdown
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(productDropdown.getAttribute("ng-reflect-placeholder").contains("Select"),
...
//		Verify field as Non-editable
		...
		for (int i = 0; i <= 150; i++) {
			try {
				softAssert.assertTrue(read.contains("true"),
						"Product field should be Non-editable");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Mandatory
		...
		for (int i = 0; i <150; i++) {
          try {
              ...
              softAssert.assertTrue(field.contains("*"),
            		  "Total Finance Amount Requested field should be Mandatory");
              break;
          } catch (Exception e) {
              if (i==150) {
                  Assert.fail(e.getMessage());
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(totalFinanceAmtInput.getAttribute("inputmode").contains("decimal"),
						"Total Finance Amount Requested field should be Numeric");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Non-editable
		...
		for (int i = 0; i <= 150; i++) {
			try {
				softAssert.assertTrue(read.contains("true"),
						"Total Finance Amount Requested field should be Non-editable");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Mandatory
		...
		for (int i = 0; i <150; i++) {
          try {
              ...
              softAssert.assertTrue(sourcingType.contains("*"),
            		  "Declared Net Monthly Income field should be Mandatory");
              break;
          } catch (Exception e) {
              if (i==150) {
                  Assert.fail(e.getMessage());
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(declaredMonthlyIncomeInput.getAttribute("inputmode").contains("decimal"),
						"Declared Net Monthly Income field should be Numeric");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Non-editable
		...
		for (int i = 0; i <= 150; i++) {
			try {
				softAssert.assertTrue(read.contains("true"),
						"Declared Net Monthly Income field should be Non-editable");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Mandatory
		...
		for (int i = 0; i <150; i++) {
          try {
              ...
              softAssert.assertTrue(!(field.contains("*")),
            		  "Declared Current Obligations field should be Non-mandatory");
              break;
          } catch (Exception e) {
              if (i==150) {
                  Assert.fail(e.getMessage());
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(declaredCurrentObligationsInput.getAttribute("mode").contains("decimal"),
						"Declared Current Obligations field should be Numeric");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Non-editable
		...
		for (int i = 0; i <= 150; i++) {
			try {
				softAssert.assertTrue(read.contains("true"),
						"Declared Current Obligations field should be Non-editable");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
		...
		for (int i = 0; i <150; i++) {
          try {
              ...
              softAssert.assertTrue(!(label.contains("*")),
            		  "Special Promotion field should be Non-mandatory");
              break;
          } catch (Exception e) {
              if (i==150) {
                  Assert.fail(e.getMessage());
...
//		Verify field as Dropdown
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(specialPromotionDropdown.getAttribute("ng-reflect-placeholder").contains("Select"),
...
//		Verify field as Non-editable
		...
		for (int i = 0; i <= 150; i++) {
			try {
				softAssert.assertTrue(read.contains("true"),
						"Special Promotion field should be Non-editable");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Mandatory		
		for (int i = 0; i <150; i++) {
          try {
        	  ...
        	  javascriptHelper.backgroundColor(element);
              softAssert.assertTrue(sourcingChannelLabel.contains("*"),
            		  "Sourcing Channel field should be Mandatory");
              break;
          } catch (Exception e) {
              if (i==150) {
                  Assert.fail(e.getMessage());
...
//		Verify field as Dropdown
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(sourcingChannelDropdown.getAttribute("ng-reflect-placeholder")
						.contains("Select"), "Sourcing Channel field should be Dropdown");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Non-editable
		...
		for (int i = 0; i <= 150; i++) {
			try {
				softAssert.assertTrue(read.contains("true"), "Sourcing Channel field should be Non-editable");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Mandatory
		for (int i = 0; i <150; i++) {
          try {
              ...
              softAssert.assertTrue(businessCenterCode.contains("*"),
            		  "Business Center Code field should be Mandatory");
              break;
          } catch (Exception e) {
              if (i==150) {
                  Assert.fail(e.getMessage());
...
//		Verify field as Dropdown
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(businessCenterCodeDropdown.getAttribute("ng-reflect-placeholder")
						.contains("Select"), "Business Center Code field should be Dropdown");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Non-editable
		...
		for (int i = 0; i <= 150; i++) {
			try {
				softAssert.assertTrue(read.contains("true"),
						"Business Center Code field should be Non-editable");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Mandatory
		...
		for (int i = 0; i <150; i++) {
          try {
              ...
              softAssert.assertTrue(servicingTypeLabel.contains("*"),
            		  "Servicing Type field should be Mandatory");
              break;
          } catch (Exception e) {
              if (i==150) {
                  Assert.fail(e.getMessage());
...
//		Verify field as Dropdown
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(servicingTypeDropdown.getAttribute("ng-reflect-placeholder")
						.contains("Select"), "Servicing Type field should be Dropdown");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Non-editable
		...
		for (int i = 0; i <= 150; i++) {
			try {
				softAssert.assertTrue(read.contains("true"),
						"Servicing Type field should be Non-editable");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Mandatory
		...
		for (int i = 0; i <150; i++) {
          try {
              ...
              softAssert.assertTrue(regionLabel.contains("*"),
            		  "Region field should be Mandatory");
              break;
          } catch (Exception e) {
              if (i==150) {
                  Assert.fail(e.getMessage());
...
//		Verify field as Dropdown
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(regionDropdown.getAttribute("ng-reflect-placeholder").contains("Select"),
...
//		Verify field as Non-editable
		...
		for (int i = 0; i <= 150; i++) {
			try {
				softAssert.assertTrue(read.contains("true"), "Region field should be Non-editable");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Mandatory
		...
		for (int i = 0; i <150; i++) {
          try {
              ...
              softAssert.assertTrue(servicingBrachLabel.contains("*"),
            		  "Servicing Branch field should be Mandatory");
              break;
          } catch (Exception e) {
              if (i==150) {
                  Assert.fail(e.getMessage());
...
//		Verify field as Dropdown
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(servicingBrachDropdown.getAttribute("ng-reflect-placeholder")
						.contains("Select"), "Servicing Branch field should be Dropdown");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Non-editable
		...
		for (int i = 0; i <= 150; i++) {
			try {
				softAssert.assertTrue(read.contains("true"), "Servicing Branch field should be Non-editable");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Non-Mandatory
		...
		for (int i = 0; i <150; i++) {
          try {
              ...
              softAssert.assertTrue(!(spokeLocationLabel.contains("*")),
            		  "Spoke Location field should Non-mandatory");
              break;
          } catch (Exception e) {
              if (i==150) {
                  Assert.fail(e.getMessage());
...
//		Verify field as Dropdown
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(spokeLocationDropdown.getAttribute("ng-reflect-placeholder")
						.contains("Select"), "Spoke Location field should Dropdown");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Non-editable
		...
		for (int i = 0; i <= 150; i++) {
			try {
				softAssert.assertTrue(read.contains("true"), "Spoke Location field should Non-editable");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Mandatory
		...
		for (int i = 0; i <150; i++) {
          try {
              ...
              softAssert.assertTrue(closingStaffLabel.contains("*"),
            		  "Closing Staff or Servicing Staff or RM field should be Mandatory");
              break;
          } catch (Exception e) {
              if (i==150) {
                  Assert.fail(e.getMessage());
...
//		Verify field as Dropdown
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(closingStaffDropdown.getAttribute("ng-reflect-placeholder")
						.contains("Select"), "Closing Staff or Servicing Staff or RM field should be Dropdown");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Non-editable
		...
		for (int i = 0; i <= 150; i++) {
			try {
				softAssert.assertTrue(read.contains("true"),
						"Closing Staff or Servicing Staff or RM field should be Non-editable");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Non-Mandatory
		...
		for (int i = 0; i <150; i++) {
          try {
              ...
              softAssert.assertTrue(!(topupTypeLabel.contains("*")),
            		  "Topup Type field should be Non-mandatory");
              break;
          } catch (Exception e) {
              if (i==150) {
                  Assert.fail(e.getMessage());
...
//		Verify field as Dropdown
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(topupTypeDropdown.getAttribute("ng-reflect-placeholder")
						.contains("Select"), "Topup Type field should be Dropdown");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Non-editable
		...
		for (int i = 0; i <= 150; i++) {
			try {
				softAssert.assertTrue(read.contains("true"), "Topup Type field should be Non-editable");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Non-Mandatory
		...
		for (int i = 0; i <150; i++) {
          try {
              ...
              softAssert.assertTrue(!(topupAppNoLabel.contains("*")),
            		  "Topup Application No field as Non-mandatory");
              break;
          } catch (Exception e) {
              if (i==150) {
                  Assert.fail(e.getMessage());
...
//		Verify field as Dropdown
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(topupAppNoInput.getAttribute("type")
						.contains("number"), "Topup Application No field as Dropdown");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Verify field as Non-editable
		...
		for (int i = 0; i <= 150; i++) {
			try {
				softAssert.assertTrue(read.contains("true"), "Topup Application No field as Non-editable");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Validate Mandatory		
		for (int i = 0; i <150; i++) {
          try {
        	  ...
        	  javascriptHelper.backgroundColor(element);
              softAssert.assertTrue(sourcingType.contains("*"),
            		  "Sourcing Type field should be Mandatory");
              break;
          } catch (Exception e) {
              if (i==150) {
                  Assert.fail(e.getMessage());
...
//		Verify field as non-editable
		...
		for (int i = 0; i <= 150; i++) {
			try {
				softAssert.assertTrue(sourcingTypeField.getAttribute("ng-reflect-readonly")
						.contains("true"), "Sourcing Type field should be non-editable");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Validate the field should be lookup value[Dropdown]
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(sourcingTypeDropdown.getAttribute("ng-reflect-placeholder")
						.contains("Select"), "Sourcing Type field should be Dropdown");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
		...
		for (int i = 0; i <150; i++) {
          try {
              ...
              softAssert.assertTrue(sourcingOffice.contains("*"),
            		  "Sourcing Office field should be Mandatory");
              break;
          } catch (Exception e) {
              if (i==150) {
                  Assert.fail(e.getMessage());
...
//		Verify field as non-editable
		...
		for (int i = 0; i <= 150; i++) {
			try {
				softAssert.assertTrue(sourcingOfficeField.getAttribute("ng-reflect-readonly")
						.contains("true"), "Sourcing Office field should be non-editable");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Validate the field should be lookup value[Dropdown]
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(sourcingOfficeDropdown.getAttribute("ng-reflect-placeholder")
						.contains("Select"), "Sourcing Office field should be Dropdown");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
		...
		for (int i = 0; i <150; i++) {
          try {
              ...
              softAssert.assertTrue(sourcingEntity.contains("*"),
            		  "Sourcing Entity field should be Mandatory");
              break;
          } catch (Exception e) {
              if (i==150) {
                  Assert.fail(e.getMessage());
...
//		Verify field as non-editable
		...
		for (int i = 0; i <= 150; i++) {
			try {
				softAssert.assertTrue(sourcingEntityField.getAttribute("ng-reflect-readonly")
						.contains("true"), "Sourcing Entity field should be non-editable");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Validate the field should be lookup value[Dropdown]
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(sourcingEntityDropdown.getAttribute("ng-reflect-placeholder")
						.contains("Select"), "Sourcing Entity field should be Dropdown");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
		...
		for (int i = 0; i <150; i++) {
          try {
              ...
              softAssert.assertTrue(sourcingStaff.contains("*"), 
            		  "Sourcing Staff field as Mandatory");
              break;
          } catch (Exception e) {
              if (i==150) {
                  Assert.fail(e.getMessage());
...
//		Verify field as non-editable
		...
		for (int i = 0; i <= 150; i++) {
			try {
				softAssert.assertTrue(sourcingStaffField.getAttribute("ng-reflect-readonly")
						.contains("true"), "Sourcing Staff field as Non-editable");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Validate the field should be lookup value[Dropdown]
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(sourcingStaffDropdown.getAttribute("ng-reflect-placeholder")
						.contains("Select"), "Sourcing Staff field as Dropdown");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
		...
		for (int i = 0; i <150; i++) {
          try {
              ...
              softAssert.assertTrue(!(referenceType.contains("*")),
            		  "Reference Type field should be Non-mandatory");
              break;
          } catch (Exception e) {
              if (i==150) {
                  Assert.fail(e.getMessage());
...
//		Verify field as non-editable
		...
		for (int i = 0; i <= 150; i++) {
			try {
				softAssert.assertTrue(referenceTypeField.getAttribute("ng-reflect-readonly")
						.contains("true"), "Reference Type field should be Non-editable");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Validate the field should be lookup value[Dropdown]
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(referenceTypeDropdown.getAttribute("ng-reflect-placeholder")
						.contains("Select"), "Reference Type field should be Dropdown");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
		...
		for (int i = 0; i <150; i++) {
          try {
              ...
              softAssert.assertTrue(!(referenceEntity.contains("*")), 
            		  "Reference Entity field should be Non-mandatory");
              break;
          } catch (Exception e) {
              if (i==150) {
                  Assert.fail(e.getMessage());
...
//		Verify field as non-editable
		...
		for (int i = 0; i <= 150; i++) {
			try {
				softAssert.assertTrue(referenceEntityField.getAttribute("ng-reflect-readonly")
						.contains("true"), "Reference Entity field should be Non-editable");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//		Validate the field should be lookup value[Dropdown]
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(referenceEntityDropdown.getAttribute("ng-reflect-placeholder")
						.contains("Select"), "Reference Entity field should be Dropdown");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
		...
		for (int i = 0; i <150; i++) {
          try {
              ...
              softAssert.assertTrue(!(referenceCode.contains("*")),
            		  "Reference Code field should be Non-mandatory");
              break;
          } catch (Exception e) {
              if (i==150) {
                  Assert.fail(e.getMessage());
...
//		Verify field as non-editable
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(referenceCodeInput.getAttribute("ng-reflect-readonly")
						.contains("true"), "Reference Code field should be Non-editable");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
	...
	public void user_validate_bank_name_field_available_under_income_details_screen() throws Throwable {
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(bankNameLabel.isDisplayed(),
						"Bank Name field available under Income details screen");
				javascriptHelper.backgroundBorder(bankNameDropdown);
				softAssert.assertTrue(bankNameDropdown.isDisplayed(),
						"Bank Name field available under Income details screen");
				break;
			} catch (Exception e) {
				if (i == 150) {
	...
	public void user_validate_branch_name_field_available_under_income_details_screen() throws Throwable {
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(branchNameLabel.isDisplayed(),
						"Branch Name field available under Income details screen");
				javascriptHelper.backgroundBorder(branchNameDropdown);
				softAssert.assertTrue(branchNameDropdown.isDisplayed(),
						"Branch Name field available under Income details screen");
				break;
			} catch (Exception e) {
				if (i == 150) {
					...
					if (!(addButtonScreenName.isBlank())) {
						...
						if ((addButtonScreenName.trim()).equalsIgnoreCase(("Income").trim())) {
							...
							softAssert.assertTrue(element.isDisplayed(),
									"System should navigate to the previous screen in Customer Financials tab");		
							break;
						}
					}
				} catch (Exception e) {
...
//	AT_MU_INC_02
	...
	public void user_validate_the_confirmation_message_as_success_under_income_details_screen() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				WebElement successToastMsg = javascriptHelper.executeScriptWithWebElement(
						appData_IncomeJsPaths.getElement("successToastMsg"));
				softAssert.assertTrue(successToastMsg.getText().contains("Saved successfully"),
						"validate the confirmation message as success under Income details screen");				
				break;
			} catch (Exception e) {
				if (i == 300) {
					Assert.fail(e.getMessage());
...
//	AT_MU_INC_04
	...
	public void user_click_the_save_button_with_mandatory_field_blank_under_income_details_screen() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				WebElement incomeSaveBtn = javascriptHelper.executeScriptWithWebElement(
						appData_IncomeJsPaths.getElement("incomeSaveBtn"));
	...
	public void user_verify_validation_message_for_mandatory_field_as_blank_under_income_details_screen() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				...
				softAssert.assertTrue(successToastMsg.getText().contains("Fill Mandatory fields"),
						"Validation message for mandatory field as blank under Income details screen");
...
//	AT_MU_INC_05
		...
		for (int i = 0; i <= 300; i++) {
			try {
				WebElement successToastMsg = javascriptHelper.executeScriptWithWebElement(
						appData_IncomeJsPaths.getElement("successToastMsg"));
				softAssert.assertTrue(successToastMsg.getText().contains("Saved successfully"),
						"Post clicking on save button system should display the confirmation message as Success");
				javascriptHelper.executeScriptWithWebElement(
						appData_IncomeJsPaths.getElement("successToastCloseBtn")).click();
				break;
			} catch (Exception e) {
				if (i == 300) {
					Assert.fail(e.getMessage());
	...
	public void user_system_should_not_allow_user_to_do_a_modification_with_invalid_data_under_income_details_screen() throws Throwable {
		for (int i = 0; i < 300; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(
						appData_IncomeJsPaths.getElement("incomeSaveBtn")).click();
				break;
			} catch (Exception e) {
				if (i == 300) {
					Assert.fail(e.getMessage());
		...
		for (int i = 0; i <= 300; i++) {
			try {
				WebElement successToastMsg = javascriptHelper.executeScriptWithWebElement(
						appData_IncomeJsPaths.getElement("successToastMsg"));
				softAssert.assertTrue(successToastMsg.getText().contains("Fill Mandatory fields"),
						"System should not allow user to do a modification with invalid data under Income details screen");	
				javascriptHelper.executeScriptWithWebElement(
						appData_IncomeJsPaths.getElement("successToastCloseBtn")).click();
				break;
			} catch (Exception e) {
...
//	AT_MU_INC_06
	...
	public void user_verify_the_back_button_available_in_income_list_view_under_customer_financials_tab() throws Throwable {
		for (int i = 0; i <= 150; i++) {
			try {
				...
				clicksAndActionsHelper.scrollIntoView(backBtn);
				javascriptHelper.backgroundBorder(backBtn);
				softAssert.assertTrue(backBtn.isDisplayed(),
						"Back button available in Income list view under Customer Financials tab");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
				...
				try {
					...
					if (!(addButtonScreenName.isBlank())) {
						...
						if ((addButtonScreenName.trim()).equalsIgnoreCase(("Income").trim())) {
							...
							WebElement element = javascriptHelper.executeScriptWithWebElement(
									"document.querySelectorAll('ion-title[class=\"pl-2 pr-2 ion-color ion-color-dark md title-default hydrated\"]')[" + j + "]");
							clicksAndActionsHelper.scrollIntoView(element);
							javascriptHelper.backgroundBorder(element);							
							softAssert.assertTrue(element.isDisplayed(),
									"Add button available under Income section list view");
							break;
						}
					}
				} catch (Exception e) {
	...
	public void user_608_verify_nature_of_employement_field_available_under_income_section_list_view_in_customer_financials_tab() throws Throwable {
		for (int i = 0; i <= 150; i++) {
			try {
				WebElement natureOfEmployment = javascriptHelper.executeScriptWithWebElement(
						appData_IncomeJsPaths.getElement("listview_NatureOfEmployment"));
				clicksAndActionsHelper.scrollIntoView(natureOfEmployment);
				javascriptHelper.backgroundColor(natureOfEmployment);
				softAssert.assertTrue(natureOfEmployment.isDisplayed(),
						"Nature of Employement field available under Income section list view");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
	...
	public void user_608_verify_net_income_field_available_under_income_section_list_view_in_customer_financials_tab() throws Throwable {		
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(netIncome.isDisplayed(),
						"Income field available under Income section list view");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
	...
	public void user_608_verify_net_deduction_field_available_under_income_section_list_view_in_customer_financials_tab() throws Throwable {
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(netDeduction.isDisplayed(),
						"Net Deduction field available under Income section list view");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
	...
	public void user_608_verify_considered_income_field_available_under_income_section_list_view_in_customer_financials_tab() throws Throwable {
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(consideredIncome.isDisplayed(),
						"Considered Income field available under Income section list view");
				break;
			} catch (Exception e) {
				if (i == 1000) {
					Assert.fail(e.getMessage());
		...
		for (int i = 0; i <= 150; i++) {
			try {
				...
				softAssert.assertTrue(status.isDisplayed(), 
						"Status field available under Income section list view");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
	...
	public void user_post_clicking_on_add_button_system_should_navigate_to_new_income_details_screen() throws Throwable {		
		for (int i = 0; i <= 150; i++) {
			try {
				WebElement incomeScreenTitle = javascriptHelper.executeScriptWithWebElement(
						appData_IncomeJsPaths.getElement("incomeScreenTitle"));
				javascriptHelper.backgroundBorder(incomeScreenTitle);
				softAssert.assertTrue(incomeScreenTitle.isDisplayed(),
						"Post clicking on Add button system should navigate to new Income details screen");
				break;
			} catch (Exception e) {
				if (i == 150) {
					Assert.fail(e.getMessage());
...
//	AT_MU_INC_07
	...
	public void user_verify_entering_any_matching_value_system_should_display_all_the_possible_matching_records_under_income_section() throws Throwable {
		...
		for (int i = 0; i <= 500; i++) {
			try {
				WebElement searchResult = javascriptHelper.executeScriptWithWebElement(
						appData_IncomeJsPaths.getElement("searchResult"));
				javascriptHelper.backgroundColor(searchResult);
				String text = searchResult.getText().substring(13, 14);
				System.out.println("Result value: "+text);
				softAssert.assertTrue(Integer.parseInt(text)>0, 
						"Entering any matching value system should display all the possible matching records under Income section");
				break;
			} catch (Exception e) {
				if (i == 500) {
					Assert.fail(e.getMessage());
	...
	public void user_verify_system_should_not_display_any_records_or_system_should_display_the_message_as_no_data_found_under_income_section() throws Throwable {
		for (int i = 0; i <= 500; i++) {
			try {
				...
				System.out.println("Result value: "+text);
				softAssert.assertTrue(Integer.parseInt(text)==0,
						"system should not display any records or system should display the message as No data found under Income section");
				break;
			} catch (Exception e) {
				if (i == 500) {
					Assert.fail(e.getMessage());
...
//		IncomeFormDataFile
	...
	public void user_post_clicking_on_back_button_under_customer_inanacials_tab_system_should_navigate_to_the_previous_screen() throws Throwable {
		for (int i = 0; i <= 300; i++) {
			try {
				WebElement element = javascriptHelper.executeScriptWithWebElement(
						appData_IncomeJsPaths.getElement("customerInfoTitle"));
				javascriptHelper.backgroundBorder(element);
				softAssert.assertTrue(element.isDisplayed(),
						"Post clicking on Back button system should navigate to the previous screen under Customer Finanacials tab");
				break;
			} catch (Exception e) {
				if (i == 300) {
					Assert.fail(e.getMessage());
