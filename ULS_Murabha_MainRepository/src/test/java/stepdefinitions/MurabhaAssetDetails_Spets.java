...
public class MurabhaAssetDetails_Spets extends BaseClass {
	...
	ExcelData excelDataForAssetDetailsTestData = new ExcelData(excelTestDataPath, "Ijarah_AssetDetailsTestData",
			"Dataset ID");
	ExcelData excelDataForAssetDetailsExecution = new ExcelData(excelTestDataPath, "Ijarah_ExecutionTracker",
			"TestCase ID");
